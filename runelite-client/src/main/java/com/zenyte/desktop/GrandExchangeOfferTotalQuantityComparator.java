...
final class GrandExchangeOfferTotalQuantityComparator implements Comparator, RSGrandExchangeOfferTotalQuantityComparator {
	...
	public static void method169(Buffer var0, int var1) {
		...
		var2.size = var0.method5547();
		var2.id = var0.method5552();
		...
		for (int var3 = 0; var3 < var2.size; ++var3) {
			try {
				...
				if (var4 != 0 && var4 != 1 && var4 != 2) {
					if (var4 == 3 || var4 == 4) {
						var5 = var0.method5667();
						var6 = var0.method5667();
						var7 = var0.method5547();
						String[] var8 = new String[var7];

						for (int var9 = 0; var9 < var7; ++var9) {
							var8[var9] = var0.method5667();
						}

						String var20 = var0.method5667();
						byte[][] var10 = new byte[var7][];
						int var12;
						if (var4 == 3) {
							for (int var11 = 0; var11 < var7; ++var11) {
								var12 = var0.method5552();
								var10[var11] = new byte[var12];
								var0.method5620(var10[var11], 0, var12);
							}
						}
					...
					var2.fields[var3] = class2.method24(var5).getDeclaredField(var6);
				}
		...
		class105.reflectionChecks.method4858(var2);
	}
	...
	static Widget method181(Widget var0) {
		...
		if (var1 == 0) {
			...
			for (int var2 = 0; var2 < var1; ++var2) {
				var0 = MusicPatchNode.method3898(var0.parentId);
				if (var0 == null) {
					return null;
				}
			}
