...
public class WorldMapLabel implements RSWorldMapLabel {
	...
	static int method517(int var0, class101 var1, boolean var2) {
		int var3;
		int var4;
		if (var0 == 100) {
			...
			if (var4 == 0) {
				...
				Widget var6 = MusicPatchNode.method3898(var3);
			...
			if (var0 == 101) {
				...
				Widget var10 = MusicPatchNode.method3898(var9.id);
				var10.children[var9.childIndex] = null;
				ItemContainer.method1273(var10);
				return 1;
			} else if (var0 == 102) {
				var9 = MusicPatchNode.method3898(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
				var9.children = null;
