...
public class WorldMapLabelSize implements RSWorldMapLabelSize {
	...
	static final void method288(Widget var0, int var1, int var2) {
		if (var0.buttonType == 1) {
			IgnoreList.method5111(var0.buttonText, "", 24, 0, 0, var0.id);
		}

		String var3;
		if (var0.buttonType == 2 && !Client.isSpellSelected) {
			var3 = PrivateChatMode.method5931(var0);
			if (var3 != null) {
				IgnoreList.method5111(var3, class297.method5314(65280) + var0.spellName, 25, 0, -1, var0.id);
			}
		}

		if (var0.buttonType == 3) {
			IgnoreList.method5111("Close", "", 26, 0, 0, var0.id);
		}

		if (var0.buttonType == 4) {
			IgnoreList.method5111(var0.buttonText, "", 28, 0, 0, var0.id);
		}

		if (var0.buttonType == 5) {
			IgnoreList.method5111(var0.buttonText, "", 29, 0, 0, var0.id);
		}

		if (var0.buttonType == 6 && Client.meslayerContinueWidget == null) {
			IgnoreList.method5111(var0.buttonText, "", 30, 0, -1, var0.id);
		}
						...
						if (var0.itemIds[var19] > 0) {
							label336: {
								...
								if (Client.isItemSelected == 1) {
									...
									if (var9) {
										if (var0.id != WorldMapSection2.selectedItemWidget || var19 != Client.selectedItemSlot) {
											IgnoreList.method5111("Use", Client.selectedItemName + " " + "->" + " " + class297.method5314(16748608) + var8.name, 31, var8.id, var19, var0.id);
										}
										break label336;
									}
								}
								...
								if (Client.isSpellSelected) {
									...
									if (var9) {
										if ((AbstractWorldMapIcon.selectedSpellFlags & 16) == 16) {
											IgnoreList.method5111(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + class297.method5314(16748608) + var8.name, 32, var8.id, var19, var0.id);
										}
										break label336;
									}
								}
								...
								if (Client.shiftClickDrop) {
									...
									if (var11) {
										var10 = var8.method4717(782275365);
									}
								}
								...
								if (var23) {
									IgnoreList.method5111("Use", class297.method5314(16748608) + var8.name, 38, var8.id, var19, var0.id);
								}
								...
								if (var20 != null) {
									for (var17 = 4; var17 >= 0; --var17) {
										if (var20[var17] != null) {
											...
											IgnoreList.method5111(var20[var17], class297.method5314(16748608) + var8.name, var18, var8.id, var19, var0.id);
										}
									}
								}

								IgnoreList.method5111("Examine", class297.method5314(16748608) + var8.name, 1005, var8.id, var19, var0.id);
							}
						}
					}
		...
		if (var0.isIf3) {
			if (Client.isSpellSelected) {
				if (class194.method3676(ScriptEvent.method1283(var0)) && (AbstractWorldMapIcon.selectedSpellFlags & 32) == 32) {
					IgnoreList.method5111(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + var0.dataText, 58, 0, var0.childIndex, var0.id);
				}
			} else {
				for (var19 = 9; var19 >= 5; --var19) {
					String var21 = class217.method4015(var0, var19);
					if (var21 != null) {
						IgnoreList.method5111(var21, var0.dataText, 1007, var19 + 1, var0.childIndex, var0.id);
					}
				}

				var3 = PrivateChatMode.method5931(var0);
				if (var3 != null) {
					IgnoreList.method5111(var3, var0.dataText, 25, 0, var0.childIndex, var0.id);
				}

				for (var4 = 4; var4 >= 0; --var4) {
					String var22 = class217.method4015(var0, var4);
					if (var22 != null) {
						ScriptFrame.method1244(var22, var0.dataText, 57, var4 + 1, var0.childIndex, var0.id, var0.field2658);
					}
				}

				if (LoginScreenAnimation.method1925(ScriptEvent.method1283(var0))) {
					IgnoreList.method5111("Continue", "", 30, 0, var0.childIndex, var0.id);
				}
			}
		}
