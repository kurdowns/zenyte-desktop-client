...
public class GrandExchangeEvent implements RSGrandExchangeEvent {
	...
	GrandExchangeEvent(Buffer var1, byte var2, int var3) {
		this.offerName = var1.method5667();
		this.previousOfferName = var1.method5667();
		this.world = var1.method5549();
		this.age = var1.method5553();
		int var4 = var1.method5552();
	...
	static final void method161() {
		...
		for (var1 = 0; var1 < WorldMapData_0.regionLandArchives.length; ++var1) {
			if (KeyHandler.regionMapArchiveIds[var1] != -1 && WorldMapData_0.regionLandArchives[var1] == null) {
				WorldMapData_0.regionLandArchives[var1] = WorldMapIcon_0.archive5.method4224(KeyHandler.regionMapArchiveIds[var1], 0, (byte)-86);
			...
			if (WorldMapArea.regionLandArchiveIds[var1] != -1 && class23.regionMapArchives[var1] == null) {
				class23.regionMapArchives[var1] = WorldMapIcon_0.archive5.method4263(WorldMapArea.regionLandArchiveIds[var1], 0, UrlRequester.xteaKeys[var1]);
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < WorldMapData_0.regionLandArchives.length; ++var1) {
				...
				if (var2 != null) {
					var3 = (StructDefinition.regions[var1] >> 8) * 64 - class69.baseX * 731242929;
					var4 = (StructDefinition.regions[var1] & 255) * 64 - class89.baseY * 1825982697;
			...
			if (!var0) {
				...
				if (Client.field899 != 0) {
					AbstractByteArrayCopier.method4004("Loading - please wait." + "<br>" + " (" + 100 + "%" + ")", true);
				}

				ChatChannel.method2342();
				GrandExchangeOfferWorldComparator.scene.method3194();

				for (var1 = 0; var1 < 4; ++var1) {
					Client.collisionMaps[var1].method3618();
				}
				...
				ChatChannel.method2342();
				UserComparator9.method3484();
				var1 = WorldMapData_0.regionLandArchives.length;
				TriBool.method5225();
				class303.method5370(true);
				int var5;
				int var20;
				int var21;
				int var40;
				...
				if (!Client.isInInstance) {
					...
					for (var35 = 0; var35 < var1; ++var35) {
						var3 = (StructDefinition.regions[var35] >> 8) * 64 - class69.baseX * 731242929;
						var4 = (StructDefinition.regions[var35] & 255) * 64 - class89.baseY * 1825982697;
					...
					for (var35 = 0; var35 < var1; ++var35) {
						...
						if (var41 != null) {
							var4 = (StructDefinition.regions[var35] >> 8) * 64 - class69.baseX * 731242929;
							var5 = (StructDefinition.regions[var35] & 255) * 64 - class89.baseY * 1825982697;
							ChatChannel.method2342();
							...
							while (true) {
								...
								while (true) {
									...
									if (var40 > 0 && var20 > 0 && var40 < 103 && var20 < 103) {
										...
										PacketBuffer.method5527(var15, var40, var20, var9, var18, var17, var42, var47);
									}
								}
							}
						}
					...
					for (var35 = 0; var35 < 4; ++var35) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
												...
												for (var21 = 0; var21 < 64; ++var21) {
													for (var22 = 0; var22 < 64; ++var22) {
														if (var50 == var20 && var21 >= var16 && var21 < var16 + 8 && var22 >= var17 && var22 < var17 + 8) {
															...
															MusicPatchNode2.method3753(var52, var35, var25, var27 + var15, 0, 0, var37);
														} else {
															MusicPatchNode2.method3753(var52, 0, -1, -1, 0, 0, 0);
														}
													}
												}
											}
								...
								if (!var49) {
									FontName.method5358(var35, var3 * 8, var4 * 8);
								}
							}
						}
					}
												...
												while (true) {
													...
													if (var6 == var26 && var25 >= var15 && var25 < var15 + 8 && var24 >= var16 && var24 < var16 + 8) {
														...
														if (var31 > 0 && var32 > 0 && var31 < 103 && var32 < 103) {
															...
															PacketBuffer.method5527(var35, var31, var32, var20, var29 + var50 & 3, var28, var45, var34);
														}
													}
												}
											}
				...
				if (Client.isLowDetail) {
					GrandExchangeOfferWorldComparator.scene.method3164(Tiles.Tiles_minPlane);
				} else {
					GrandExchangeOfferWorldComparator.scene.method3164(0);
				}
				...
				if (WorldMapSection1.client.method1040()) {
					var53 = FaceNormal.method3363(ClientPacket.field2215, Client.packetWriter.isaacCipher);
					var53.packetBuffer.method5689(1057001181);
					Client.packetWriter.method2361(var53);
				}
					...
					for (var50 = var3 - 1; var50 <= var4 + 1; ++var50) {
						for (var37 = var5 - 1; var37 <= var6 + 1; ++var37) {
							if (var50 < var3 || var50 > var4 || var37 < var5 || var37 > var6) {
								WorldMapIcon_0.archive5.method4260("m" + var50 + "_" + var37);
								WorldMapIcon_0.archive5.method4260("l" + var50 + "_" + var37);
							}
						}
					}
				}
				...
				var53 = FaceNormal.method3363(ClientPacket.field2241, Client.packetWriter.isaacCipher);
				Client.packetWriter.method2361(var53);
	...
	static final void method156(String var0) {
		if (!var0.equals("")) {
			PacketBufferNode var1 = FaceNormal.method3363(ClientPacket.field2236, Client.packetWriter.isaacCipher);
