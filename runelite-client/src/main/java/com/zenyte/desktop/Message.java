...
public class Message extends DualNode implements RSMessage {
	...
	void method1298() {
		this.isFromFriend0 = Projectile.friendSystem.friendsList.method5117(this.senderUsername) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
	...
	void method1296() {
		this.isFromIgnored0 = Projectile.friendSystem.ignoreList.method5117(this.senderUsername) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
	...
	final void method1302() {
		if (this.sender != null) {
			this.senderUsername = new Username(Occluder.method3386(this.sender), WorldMapIcon_0.loginType);
		} else {
	...
	public static void method1319(AbstractArchive var0, AbstractArchive var1) {
		...
		KitDefinition.KitDefinition_fileCount = KitDefinition.KitDefinition_archive.method4246(3);
	}
	...
	static void method1300(int var0, int var1, int var2, int var3) {
		for (ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.method4931(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.method4949()) {
				...
				if (var5 - 64 <= var4.field1106 && Client.areaSoundEffectVolume != 0 && var0 == var4.plane) {
					...
					if (var4.stream1 == null) {
						if (var4.soundEffectId >= 0) {
							SoundEffect var7 = SoundEffect.method2455(FontName.archive4, var4.soundEffectId, 0);
							if (var7 != null) {
								RawSound var8 = var7.method2452().method2494(class25.decimator);
								RawPcmStream var9 = RawPcmStream.method2640(var8, 100, var6);
								var9.method2675(-1);
								Tiles.pcmStreamMixer.method2385(var9);
								var4.stream1 = var9;
							}
						}
					} else {
						var4.stream1.method2645(var6);
					}

					if (var4.stream2 == null) {
						if (var4.soundEffectIds != null && (var4.field1107 -= var3) <= 0) {
							int var11 = (int)(Math.random() * (double)var4.soundEffectIds.length);
							SoundEffect var12 = SoundEffect.method2455(FontName.archive4, var4.soundEffectIds[var11], 0);
							if (var12 != null) {
								RawSound var13 = var12.method2452().method2494(class25.decimator);
								RawPcmStream var10 = RawPcmStream.method2640(var13, 100, var6);
								var10.method2675(0);
								Tiles.pcmStreamMixer.method2385(var10);
								var4.stream2 = var10;
								var4.field1107 = var4.field1104 + (int)(Math.random() * (double)(var4.field1105 - var4.field1104));
							}
						}
					} else {
						var4.stream2.method2645(var6);
						if (!var4.stream2.method3658()) {
							var4.stream2 = null;
						}
					}
				} else {
					if (var4.stream1 != null) {
						Tiles.pcmStreamMixer.method2386(var4.stream1);
						var4.stream1 = null;
					}

					if (var4.stream2 != null) {
						Tiles.pcmStreamMixer.method2386(var4.stream2);
						var4.stream2 = null;
					}
				}
			}
	...
	static int method1318(int var0, class101 var1, boolean var2) {
