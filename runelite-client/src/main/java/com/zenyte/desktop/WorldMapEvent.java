...
public class WorldMapEvent implements RSWorldMapEvent {
		...
		if (Login.Login_username.length() == 0) {
			...
			if (0L == var1) {
				...
				for (var11 = 0; var11 < 4; ++var11) {
					var26.method5689(var34.nextInt());
				}

				var26.method5689(var10[0]);
				var26.method5689(var10[1]);
				var26.method5529(var1);
				var26.method5529(0L);
				...
				var26.method5570(class89.field1158, class89.field1155, -1664689414);
				var9.method5531(10);

				for (var11 = 0; var11 < 3; ++var11) {
					var9.method5689(var34.nextInt());
				}

				var9.method5529(var34.nextLong());
				var9.method5535(var34.nextLong());
				if (Client.randomDatData != null) {
					var9.method5596(Client.randomDatData, 0, Client.randomDatData.length);
				} else {
					byte[] var27 = GraphicsObject.method2106();
					var9.method5596(var27, 0, var27.length);
				}

				var9.method5529(var34.nextLong());
				var9.method5570(class89.field1158, class89.field1155, -1753308599);
				var11 = class234.method4198(var33);
				if (var11 % 8 != 0) {
					var11 += 8 - var11 % 8;
				}

				Buffer var12 = new Buffer(var11);
				var12.method5627(var33);
				var12.offset = var11;
				var12.method5536(var10);
				Buffer var13 = new Buffer(var12.offset + var26.offset + var9.offset + 5);
				var13.method5531(2);
				var13.method5531(var26.offset);
				var13.method5596(var26.array, 0, var26.offset);
				var13.method5531(var9.offset);
				var13.method5596(var9.array, 0, var9.offset);
				var13.method5532(var12.offset);
				var13.method5596(var12.array, 0, var12.offset);
				String var14 = StudioGame.method4218(var13.array);
			...
			switch(var0) {
			case 2:
				HealthBarUpdate.method1852(Strings.field3026, Strings.field2898, Strings.field2807);
				Login.loginIndex = 6;
				break;
			case 3:
				HealthBarUpdate.method1852("", "Error connecting to server.", "");
				break;
			case 4:
				HealthBarUpdate.method1852("The part of the website you are trying", "to connect to is offline at the moment.", "Please try again later.");
				break;
			case 5:
				HealthBarUpdate.method1852("Sorry, there was an error trying to", "log you in to this part of the website.", "Please try again later.");
				break;
			case 6:
				HealthBarUpdate.method1852("", "Error connecting to server.", "");
				break;
			case 7:
				HealthBarUpdate.method1852("You must enter a valid login to proceed. For accounts", "created after 24th November 2010, please use your", "email address. Otherwise please use your username.");
			}
	...
	static int method866(int var0, class101 var1, boolean var2) {
		Widget var3;
		if (var0 >= 2000) {
			var0 -= 1000;
	...
	static int method865(int var0, class101 var1, boolean var2) {
		if (var0 == 5306) {
