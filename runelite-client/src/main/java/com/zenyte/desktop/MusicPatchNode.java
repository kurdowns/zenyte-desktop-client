...
import net.runelite.rs.api.RSMusicPatchNode;

@ObfuscatedName("hz")
public class MusicPatchNode extends Node implements RSMusicPatchNode {
	@ObfuscatedName("dl")
	@ObfuscatedSignature(
		signature = "Llt;"
	)
	...
	public static String method3900(CharSequence[] var0, int var1, int var2) {
		if (var2 == 0) {
			return "";
		} else if (var2 == 1) {
	...
	public static class332[] method3899() {
	...
	static void method3901(int var0, int var1) {
		int var2 = TaskHandler.fontBold12.method5384("Choose Option");
