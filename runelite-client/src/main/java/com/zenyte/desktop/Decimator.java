...
public class Decimator implements RSDecimator {
	...
	public Decimator(int var1, int var2) {
		if (var2 != var1) {
			int var3 = ModeWhere.method3742(var1, var2);
			var1 /= var3;
			var2 /= var3;
			this.inputRate = var1;
	...
	public static boolean method2621(long var0) {
		return var0 != 0L && !WorldMapDecorationType.method4188(var0);
	}
	...
	static int method2635(int var0, class101 var1, boolean var2) {
		boolean var3 = true;
		Widget var4;
		if (var0 >= 2000) {
			var0 -= 1000;
			var4 = MusicPatchNode.method3898(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
			var3 = false;
		} else {
		...
		if (var0 == 1300) {
			...
			if (var11 >= 0 && var11 <= 9) {
				var4.method4145(var11, Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]);
				return 1;
			} else {
			...
			if (var0 == 1301) {
				...
				if (var0 != 1350) {
					...
					if (var0 == 1351) {
						...
						FontName.method5356(var4, var5, var9, var10);
						return 1;
					} else if (var0 == 1352) {
						...
						var11 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] - 1;
						if (var11 >= 0 && var11 <= 9) {
							class195.method3679(var4, var11);
							return 1;
						} else {
							throw new RuntimeException();
						}
					...
					if (var7 >= 0 && var7 <= 9) {
						FontName.method5356(var4, var7, var8, var9);
						return 1;
					} else {
						throw new RuntimeException();
					}
	...
	public static String method2622(String var0) {
		...
		for (int var4 = 0; var4 < var1; ++var4) {
			...
			if (var3 == 0) {
				...
				var5 = StructDefinition.method4565(var5);
			}
