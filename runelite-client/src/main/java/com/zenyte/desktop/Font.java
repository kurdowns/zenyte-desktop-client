...
public final class Font extends AbstractFont implements RSFont {
	...
	final void vmethod5439(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
		int var7 = var3 * Rasterizer2D_width + var2;
		...
		if (var4 > 0 && var5 > 0) {
			method5406(Rasterizer2D_pixels, var1, var6, var10, var7, var4, var5, var8, var9);
		}
	}

	@ObfuscatedName("m")
	final void vmethod5477(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		int var8 = var3 * Rasterizer2D_width + var2;
		...
		if (var4 > 0 && var5 > 0) {
			method5408(Rasterizer2D_pixels, var1, var6, var11, var8, var4, var5, var9, var10, var7);
		}
	}
}
