...
public class RawSound extends AbstractSound implements RSRawSound {
	...
	public RawSound method2494(Decimator var1) {
		this.samples = var1.method2628(this.samples);
		this.sampleRate = var1.method2623(this.sampleRate);
		if (this.start == this.end) {
			this.start = this.end = var1.method2634(this.start);
		} else {
			this.start = var1.method2634(this.start);
			this.end = var1.method2634(this.end);
			if (this.start == this.end) {
				--this.start;
			}
		}
	...
	public RSRawSound applyResampler(RSDecimator var1) {
		return this.method2494((Decimator)var1);
	}
}
