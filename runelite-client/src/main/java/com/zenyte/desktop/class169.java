...
public enum class169 implements Enumerated {
	...
	static int method3531(int var0, int var1) {
		FloorOverlayDefinition var2 = UserComparator9.method3477(var0);
		if (var2 == null) {
			return var1;
			...
			int var5;
			if (var2.texture >= 0) {
				var4 = Rasterizer3D.Rasterizer3D_textureLoader.vmethod3372(var2.texture);
				byte var11 = 96;
				int var3;
				if (var4 == -2) {
					var3 = 12345678;
