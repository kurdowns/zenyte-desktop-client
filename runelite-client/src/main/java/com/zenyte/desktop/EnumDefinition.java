...
public class EnumDefinition extends DualNode implements RSEnumDefinition {
	...
	void method4599(Buffer var1, int var2) {
		if (var2 == 1) {
			this.inputType = (char)var1.method5547();
		} else if (var2 == 2) {
			this.outputType = (char)var1.method5547();
		} else if (var2 == 3) {
			this.defaultStr = var1.method5667();
		} else if (var2 == 4) {
			this.defaultInt = var1.method5552();
		} else {
			int var3;
			if (var2 == 5) {
				this.outputCount = var1.method5549();
				this.keys = new int[this.outputCount];
				this.strVals = new String[this.outputCount];

				for (var3 = 0; var3 < this.outputCount; ++var3) {
					this.keys[var3] = var1.method5552();
					this.strVals[var3] = var1.method5667();
				}
			} else if (var2 == 6) {
				this.outputCount = var1.method5549();
				this.keys = new int[this.outputCount];
				...
				for (var3 = 0; var3 < this.outputCount; ++var3) {
					this.keys[var3] = var1.method5552();
					this.intVals[var3] = var1.method5552();
				}
			}
		}
	...
	public static void method4590(int var0) {
		if (var0 != -1) {
			if (Widget.Widget_loadedInterfaces[var0]) {
				Widget.Widget_archive.method4237(var0);
