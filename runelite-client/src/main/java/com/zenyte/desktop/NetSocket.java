...
public final class NetSocket extends AbstractSocket implements Runnable, RSNetSocket {
	...
	void method3592(byte[] var1, int var2, int var3) throws IOException {
		if (!this.isClosed) {
			if (this.exceptionWriting) {
				...
				synchronized(this) {
					...
					if (this.task == null) {
						this.task = this.taskHandler.method3551(this, 3);
					}
	...
	public void vmethod5878(byte[] var1, int var2, int var3) throws IOException {
		this.method3592(var1, var2, var3);
	}
	...
	public void run() {
		try {
			...
			WorldMapDecorationType.method4189((String)null, var12);
		}
