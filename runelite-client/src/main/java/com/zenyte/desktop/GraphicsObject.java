...
public final class GraphicsObject extends Entity implements RSGraphicsObject {
	...
	GraphicsObject(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		if (var8 != -1) {
			this.isFinished = false;
			this.sequenceDefinition = SpotAnimationDefinition.method4478(var8);
		} else {
	...
	final void method2101(int var1) {
		if (!this.isFinished) {
	...
	protected final Model vmethod3353(int var1) {
		...
		Model var3;
		if (!this.isFinished) {
			var3 = var2.method4467(this.frame);
		} else {
			var3 = var2.method4467(-1);
		}
	...
	public static byte[] method2106() {
		byte[] var0 = new byte[24];

		try {
			JagexCache.JagexCache_randomDat.method6612(0L);
			JagexCache.JagexCache_randomDat.method6614(var0);
	...
	static final void method2108(boolean var0) {
		if (var0) {
