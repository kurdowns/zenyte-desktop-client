...
final class GrandExchangeOfferUnitPriceComparator implements Comparator, RSGrandExchangeOfferUnitPriceComparator {
	...
	public static HitSplatDefinition method213(int var0) {
		HitSplatDefinition var1 = (HitSplatDefinition)HitSplatDefinition.HitSplatDefinition_cached.method3418((long)var0);
		if (var1 != null) {
			return var1;
		} else {
			byte[] var2 = HitSplatDefinition.HitSplatDefinition_archive.method4224(32, var0, (byte)-31);
			var1 = new HitSplatDefinition();
			if (var2 != null) {
				var1.method4602(new Buffer(var2));
			}

			HitSplatDefinition.HitSplatDefinition_cached.method3424(var1, (long)var0);
			return var1;
		}
	}
	...
	public static void method222(AbstractSocket var0, boolean var1) {
		...
		if (NetCache.NetCache_socket != null) {
			try {
				var2 = new Buffer(4);
				var2.method5531(var1 ? 2 : 3);
				var2.method5588(0);
				NetCache.NetCache_socket.vmethod5878(var2.array, 0, 4);
		...
		while (true) {
			NetFileRequest var9 = (NetFileRequest)NetCache.NetCache_pendingPriorityResponses.method5995();
			if (var9 == null) {
				while (true) {
					var9 = (NetFileRequest)NetCache.NetCache_pendingResponses.method5995();
					if (var9 == null) {
						if (NetCache.field3163 != 0) {
							try {
								var2 = new Buffer(4);
								var2.method5531(4);
								var2.method5531(NetCache.field3163);
								var2.method5532(0);
								NetCache.NetCache_socket.vmethod5878(var2.array, 0, 4);
						...
						NetCache.field3165 = class217.method4014();
						return;
					}

					NetCache.NetCache_pendingWritesQueue.method4851(var9);
					NetCache.NetCache_pendingWrites.method5997(var9, var9.key);
					++NetCache.NetCache_pendingWritesCount;
					--NetCache.NetCache_pendingResponsesCount;
				}
			}

			NetCache.NetCache_pendingPriorityWrites.method5997(var9, var9.key);
	...
	public static Widget method224(int var0, int var1) {
		Widget var2 = MusicPatchNode.method3898(var0);
		if (var1 == -1) {
			return var2;
		} else {
