...
public class InvDefinition extends DualNode implements RSInvDefinition {
	...
	void method4418(Buffer var1, int var2) {
		if (var2 == 2) {
			this.size = var1.method5549();
		}
	...
	static final void method4419() {
		if (ScriptEvent.Client_plane != Client.field695) {
			...
			for (var3 = 1; var3 < 103; ++var3) {
				...
				for (var5 = 1; var5 < 103; ++var5) {
					if ((Tiles.Tiles_renderFlags[var0][var5][var3] & 24) == 0) {
						GrandExchangeOfferWorldComparator.scene.method3345(var1, var4, 512, var0, var5, var3);
					}

					if (var0 < 3 && (Tiles.Tiles_renderFlags[var0 + 1][var5][var3] & 8) != 0) {
						GrandExchangeOfferWorldComparator.scene.method3345(var1, var4, 512, var0 + 1, var5, var3);
					}
			...
			ArchiveDisk.sceneMinimapSprite.method6179();
			...
			for (var5 = 0; var5 < 104; ++var5) {
				for (var6 = 0; var6 < 104; ++var6) {
					long var7 = GrandExchangeOfferWorldComparator.scene.method3309(ScriptEvent.Client_plane, var5, var6);
					if (0L != var7) {
						int var9 = WorldMapRectangle.method387(var7);
						int var10 = WorldMapSection2.method435(var9).mapIconId;
						if (var10 >= 0) {
							Client.mapIcons[Client.mapIconCount] = class25.method279(var10).method4443(false);
			...
			class206.rasterProvider.method6138();
		}
