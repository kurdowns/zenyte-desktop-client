...
public abstract class AbstractFont extends Rasterizer2D implements RSAbstractFont {
			...
			for (var13 = 0; var13 < 256; ++var13) {
				if (var13 != 32 && var13 != 160) {
					for (var8 = 0; var8 < 256; ++var8) {
						if (var8 != 32 && var8 != 160) {
							this.kerning[var8 + (var13 << 8)] = (byte)method5451(var11, var12, var4, this.advances, var10, var13, var8);
						}
					}
				}
			}
	...
	int method5383(char var1) {
		...
		return this.advances[TaskHandler.method3559(var1) & 255];
	}
		...
		if (var1 == null) {
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) {
				...
				if (var6 == '<') {
					...
					if (var2 == -1) {
						var4 += this.advances[(char)(TaskHandler.method3559(var6) & 255)];
	...
	public int method5386(String var1, int var2) {
		int var3 = this.method5385(var1, new int[]{var2}, AbstractFont_lines);
		int var4 = 0;

		for (int var5 = 0; var5 < var3; ++var5) {
			int var6 = this.method5384(AbstractFont_lines[var5]);
			if (var6 > var4) {
				var4 = var6;
			}
		}
	...
	public int method5454(String var1, int var2) {
		return this.method5385(var1, new int[]{var2}, AbstractFont_lines);
	}
	...
	public int method5397(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		if (var1 == null) {
			...
			int var12 = this.method5385(var1, var11, AbstractFont_lines);
			if (var9 == 3 && var12 == 1) {
				var9 = 1;
			}
			...
			for (var14 = 0; var14 < var12; ++var14) {
				if (var8 == 0) {
					this.method5447(AbstractFont_lines[var14], var2, var13);
				} else if (var8 == 1) {
					this.method5447(AbstractFont_lines[var14], var2 + (var4 - this.method5384(AbstractFont_lines[var14])) / 2, var13);
				} else if (var8 == 2) {
					this.method5447(AbstractFont_lines[var14], var2 + var4 - this.method5384(AbstractFont_lines[var14]), var13);
				} else if (var14 == var12 - 1) {
					this.method5447(AbstractFont_lines[var14], var2, var13);
				} else {
					this.method5400(AbstractFont_lines[var14], var4);
					this.method5447(AbstractFont_lines[var14], var2, var13);
					AbstractFont_justificationTotal = 0;
				}
	...
	void method5399(String var1) {
		try {
			...
			if (var1.startsWith("col=")) {
				...
				var2 = class105.method2379(var3, 16, true);
				...
				this.method5398(AbstractFont_previousColor, AbstractFont_previousShadow);
			}
	...
	void method5400(String var1, int var2) {
		...
		if (var3 > 0) {
			AbstractFont_justificationTotal = (var2 - this.method5384(var1) << 8) / var3;
		}
	...
	void method5447(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) {
			if (var1.charAt(var6) != 0) {
				char var7 = (char)(TaskHandler.method3559(var1.charAt(var6)) & 255);
				if (var7 == '<') {
					var4 = var6;
				} else {
					int var9;
							...
							if (!var8.equals("gt")) {
								if (var8.startsWith("img=")) {
									try {
										...
										var10.method6173(var2, var3 + this.ascent - var10.height);
										var2 += var10.width;
										var5 = -1;
					...
					if (var4 == -1) {
						...
						if (var7 != ' ') {
							if (AbstractFont_alpha == 256) {
								if (AbstractFont_shadow != -1) {
									method5450(this.pixels[var7], var2 + this.leftBearings[var7] + 1, var3 + this.topBearings[var7] + 1, var12, var9, AbstractFont_shadow);
								}

								this.vmethod5439(this.pixels[var7], var2 + this.leftBearings[var7], var3 + this.topBearings[var7], var12, var9, AbstractFont_color);
							} else {
								if (AbstractFont_shadow != -1) {
									method5404(this.pixels[var7], var2 + this.leftBearings[var7] + 1, var3 + this.topBearings[var7] + 1, var12, var9, AbstractFont_shadow, AbstractFont_alpha);
								}

								this.vmethod5477(this.pixels[var7], var2 + this.leftBearings[var7], var3 + this.topBearings[var7], var12, var9, AbstractFont_color, AbstractFont_alpha);
							}
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method6057(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method6057(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	void method5402(String var1, int var2, int var3, int[] var4, int[] var5) {
		...
		for (int var9 = 0; var9 < var1.length(); ++var9) {
			if (var1.charAt(var9) != 0) {
				char var10 = (char)(TaskHandler.method3559(var1.charAt(var9)) & 255);
				if (var10 == '<') {
					var6 = var9;
				} else {
					int var12;
							...
							if (!var11.equals("gt")) {
								if (var11.startsWith("img=")) {
									try {
										...
										var15.method6173(var12 + var2, var13 + (var3 + this.ascent - var15.height));
										var2 += var15.width;
										var7 = -1;
					...
					if (var6 == -1) {
						...
						if (var10 != ' ') {
							if (AbstractFont_alpha == 256) {
								if (AbstractFont_shadow != -1) {
									method5450(this.pixels[var10], var13 + var2 + this.leftBearings[var10] + 1, var3 + var14 + this.topBearings[var10] + 1, var17, var12, AbstractFont_shadow);
								}

								this.vmethod5439(this.pixels[var10], var13 + var2 + this.leftBearings[var10], var3 + var14 + this.topBearings[var10], var17, var12, AbstractFont_color);
							} else {
								if (AbstractFont_shadow != -1) {
									method5404(this.pixels[var10], var13 + var2 + this.leftBearings[var10] + 1, var3 + var14 + this.topBearings[var10] + 1, var17, var12, AbstractFont_shadow, AbstractFont_alpha);
								}

								this.vmethod5477(this.pixels[var10], var13 + var2 + this.leftBearings[var10], var3 + var14 + this.topBearings[var10], var17, var12, AbstractFont_color, AbstractFont_alpha);
							}
						} else if (AbstractFont_justificationTotal > 0) {
							AbstractFont_justificationCurrent += AbstractFont_justificationTotal;
							var2 += AbstractFont_justificationCurrent >> 8;
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method6057(var2, var3 + (int)((double)this.ascent * 0.7D), var18, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method6057(var2, var3 + this.ascent, var18, AbstractFont_underline);
						}
	...
	static void method5450(byte[] var0, int var1, int var2, int var3, int var4, int var5) {
		...
		if (var3 > 0 && var4 > 0) {
			method5406(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var9, var6, var3, var4, var7, var8);
		}
	}
	...
	static void method5404(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var3 > 0 && var4 > 0) {
			method5408(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var10, var7, var3, var4, var8, var9, var6);
		}
	}
