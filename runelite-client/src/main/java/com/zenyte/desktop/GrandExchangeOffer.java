...
public class GrandExchangeOffer implements RSGrandExchangeOffer {
	...
	public GrandExchangeOffer(Buffer var1, boolean var2) {
		this.state = var1.method5548();
		this.id = var1.method5549();
		this.unitPrice = var1.method5552();
		this.totalQuantity = var1.method5552();
		this.currentQuantity = var1.method5552();
		this.currentPrice = var1.method5552();
	}
	...
	static int method191(int var0, class101 var1, boolean var2) {
	...
	static final void method212(boolean var0, PacketBuffer var1) {
		...
		int var2;
		while (var1.method5488(Client.packetWriter.serverPacketLength) >= 27) {
			var2 = var1.method5495(15);
			if (var2 == 32767) {
				break;
			}
			...
			int var5;
			if (var0) {
				var5 = var1.method5495(8);
				if (var5 > 127) {
					var5 -= 256;
				}
			} else {
				var5 = var1.method5495(5);
				if (var5 > 15) {
					var5 -= 32;
				}
			}

			int var6 = Client.defaultRotations[var1.method5495(3)];
			if (var3) {
				var4.orientation = var4.rotation = var6;
			}

			int var7 = var1.method5495(1);
			int var8 = var1.method5495(1);
			if (var8 == 1) {
			...
			int var9;
			if (var0) {
				var9 = var1.method5495(8);
				if (var9 > 127) {
					var9 -= 256;
				}
			} else {
				var9 = var1.method5495(5);
				if (var9 > 15) {
					var9 -= 32;
				}
			}

			NPCDefinition var10001 = class237.method4201(var1.method5495(14));
			...
			var4.method2122(ByteArrayPool.localPlayer.pathX[0] + var9, ByteArrayPool.localPlayer.pathY[0] + var5, var7 == 1);
		}
