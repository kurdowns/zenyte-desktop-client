...
public final class NPC extends Actor implements RSNPC {
	...
	final void method2119(int var1, byte var2) {
	...
	final void method2122(int var1, int var2, boolean var3) {
		if (super.sequence != -1 && SpotAnimationDefinition.method4478(super.sequence).field3524 == 1) {
			super.sequence = -1;
			this.animationChanged(-1);
		}
	...
	public final Model copy$getModel(int var1) {
		if (this.definition == null) {
			...
			SequenceDefinition var3 = super.movementSequence != -1 && (super.idleSequence != super.movementSequence || var2 == null) ? SpotAnimationDefinition.method4478(super.movementSequence) : null;
			Model var4 = this.definition.method4764(var2, super.sequenceFrame, var3, super.movementFrame);
			if (var4 == null) {
				return null;
			} else {
				var4.method2955();
				...
				if (super.spotAnimation != -1 && super.spotAnimationFrame != -1) {
					Model var5 = MouseHandler.method1205(super.spotAnimation).method4467(super.spotAnimationFrame);
					if (var5 != null) {
	...
	static int method2133(int var0, class101 var1, boolean var2) {
	...
	static int method2131(int var0, class101 var1, boolean var2) {
		if (var0 == 3200) {
			Interpreter.Interpreter_intStackSize -= 3;
			ModelData0.method3350(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize], Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1], Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2]);
			return 1;
		} else if (var0 == 3201) {
			StudioGame.method4219(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
			return 1;
		} else if (var0 == 3202) {
			Interpreter.Interpreter_intStackSize -= 2;
			VerticalAlignment.method4415(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize], Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			return 1;
		} else {
			return 2;
		}
