...
public class SecureRandomCallable implements Callable, RSSecureRandomCallable {
	...
	static class101 method1246(byte[] var0) {
		class101 var1 = new class101();
		Buffer var2 = new Buffer(var0);
		var2.offset = var2.array.length - 2;
		int var3 = var2.method5549();
		int var4 = var2.array.length - 2 - var3 - 12;
		var2.offset = var4;
		int var5 = var2.method5552();
		var1.localIntCount = var2.method5549();
		var1.localStringCount = var2.method5549();
		var1.intArgumentCount = var2.method5549();
		var1.stringArgumentCount = var2.method5549();
		int var6 = var2.method5547();
		int var7;
		int var8;
		if (var6 > 0) {
			var1.switches = var1.method2325(var6);

			for (var7 = 0; var7 < var6; ++var7) {
				var8 = var2.method5549();
				IterableNodeHashTable var9 = new IterableNodeHashTable(var8 > 0 ? Calendar.method4012(var8) : 1);
				var1.switches[var7] = var9;

				while (var8-- > 0) {
					int var10 = var2.method5552();
					int var11 = var2.method5552();
					var9.method5963(new IntegerNode(var11), (long)var10);
				}
			}
		}
		...
		for (var7 = 0; var2.offset < var4; var1.opcodes[var7++] = var8) {
			var8 = var2.method5549();
			if (var8 == 3) {
				var1.stringOperands[var7] = var2.method5667();
			} else if (var8 < 100 && var8 != 21 && var8 != 38 && var8 != 39) {
				var1.intOperands[var7] = var2.method5552();
			} else {
				var1.intOperands[var7] = var2.method5547();
			}
		}
	...
	static int method1249(int var0, class101 var1, boolean var2) {
		int var3 = -1;
		Widget var4;
		if (var0 >= 2000) {
			var0 -= 1000;
			var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
			var4 = MusicPatchNode.method3898(var3);
		} else {
		...
		if (var0 == 1000) {
			...
			WorldMapSection1.client.method1418(var4);
		...
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null) {
				if (var3.type == 0) {
					...
					InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.method6010((long)var3.id);
					if (var4 != null) {
						class198.method3714(var4.group, var1);
					}
				}
				...
				if (var1 == 1 && var3.onSubChange != null) {
					if (var3.childIndex >= 0) {
						Widget var6 = MusicPatchNode.method3898(var3.id);
