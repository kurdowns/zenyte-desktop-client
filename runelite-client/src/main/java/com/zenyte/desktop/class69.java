...
public class class69 {
	...
	static void method1277() {
		...
		for (byte var2 = 12; var0 < 16; var1 -= var2) {
			var3 = NPC.method2132((double)((float)var1 / 360.0F), 0.9998999834060669D, (double)(0.425F * (float)var0 / 16.0F + 0.075F));
		...
		for (int var5 = var1 / 6; var0 < IntHashTable.field4034.length; var1 -= var5) {
			...
			for (int var4 = NPC.method2132((double)((float)var1 / 360.0F), 0.9998999834060669D, 0.5D); var0 < var3 && var0 < IntHashTable.field4034.length; ++var0) {
