...
public class FloorUnderlayDefinition extends DualNode implements RSFloorUnderlayDefinition {
	...
	void method4491(Buffer var1, int var2) {
		while (true) {
			...
			this.method4481(var1, var3, var2);
		}
	}
	...
	void method4481(Buffer var1, int var2, int var3) {
		if (var2 == 1) {
			this.rgb = var1.method5674();
		}
	...
	public static Sprite[] method4483(AbstractArchive var0, String var1, String var2) {
		int var3 = var0.method4240(var1);
		int var4 = var0.method4233(var3, var2);
		return ClientPacket.method3670(var0, var3, var4);
	}
}
