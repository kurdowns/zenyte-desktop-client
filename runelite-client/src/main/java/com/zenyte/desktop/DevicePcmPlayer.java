...
public class DevicePcmPlayer extends PcmPlayer implements RSDevicePcmPlayer {
	...
	protected void vmethod2530(int var1) throws LineUnavailableException {
		try {
			...
			if (Clock.method3576(var1) != 1) {
				this.vmethod2530(Calendar.method4012(var1));
			} else {
				this.line = null;
				throw var3;
			}
