...
import net.runelite.rs.api.RSViewportMouse;

@ObfuscatedName("ei")
public class ViewportMouse implements RSViewportMouse {
	@ObfuscatedName("x")
	...
	public static File method3076(String var0) {
	...
	static final void method3077() {
		Client.field794 = 0;
		int var0 = (ByteArrayPool.localPlayer.x >> 7) + class69.baseX * 731242929;
		int var1 = (ByteArrayPool.localPlayer.y >> 7) + class89.baseY * 1825982697;
	...
	static final void method3078(Widget var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (Client.field746) {
