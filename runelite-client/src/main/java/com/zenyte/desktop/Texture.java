...
public class Texture extends Node implements RSTexture {
	...
	Texture(Buffer var1) {
		this.isLoaded = false;
		this.averageRGB = var1.method5549();
		this.field1638 = var1.method5547() == 1;
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.fileIds[var3] = var1.method5549();
			}
			...
			if (var2 > 1) {
				...
				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1640[var3] = var1.method5547();
				}
			}
			...
			if (var2 > 1) {
				...
				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1633[var3] = var1.method5547();
				}
			}
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.field1634[var3] = var1.method5552();
			}

			this.animationDirection = var1.method5547();
			this.animationSpeed = var1.method5547();
			this.pixels = null;
		} else {
	...
	boolean method2940(double var1, int var3, AbstractArchive var4) {
		int var5;
		for (var5 = 0; var5 < this.fileIds.length; ++var5) {
			if (var4.method4225(this.fileIds[var5]) == null) {
				return false;
			}
		}
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			IndexedSprite var7 = class322.method5938(var4, this.fileIds[var6]);
			var7.method6156();
			...
			for (var11 = 0; var11 < var9.length; ++var11) {
				var9[var11] = Rasterizer3D.method3089(var9[var11], var1);
			}
