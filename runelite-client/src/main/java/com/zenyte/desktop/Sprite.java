...
public final class Sprite extends Rasterizer2D implements RSSprite {
	...
	public void method6179() {
		method6043(this.pixels, this.subWidth, this.subHeight);
	}
	...
	public void method6185(int var1, int var2) {
		...
		if (var5 + var2 > Rasterizer2D_yClipEnd) {
			var5 -= var5 + var2 - Rasterizer2D_yClipEnd;
		}
		...
		if (var6 + var1 > Rasterizer2D_xClipEnd) {
			var9 = var6 + var1 - Rasterizer2D_xClipEnd;
			var6 -= var9;
			var8 += var9;
			var7 += var9;
		}
		...
		if (var6 > 0 && var5 > 0) {
			method6196(Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7, var8);
		}
	}
	...
	public void method6187(int var1, int var2) {
		...
		if (var6 > 0 && var5 > 0) {
			method6238(Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
		}
	}
	...
	public void method6189(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var3 + var1 > Rasterizer2D_xClipEnd) {
				var15 = var3 + var1 - Rasterizer2D_xClipEnd;
				var3 -= var15;
				var14 += var15;
			}
			...
			method6245(Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
		}
	}
	...
	public void method6249(int var1, int var2, int var3, int var4) {
		if (var3 == 256) {
			...
			if (var7 + var2 > Rasterizer2D_yClipEnd) {
				var7 -= var7 + var2 - Rasterizer2D_yClipEnd;
			}
			...
			if (var8 + var1 > Rasterizer2D_xClipEnd) {
				var11 = var8 + var1 - Rasterizer2D_xClipEnd;
				var8 -= var11;
				var10 += var11;
				var9 += var11;
			}
			...
			if (var8 > 0 && var7 > 0) {
				method6192(Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
			}
		}
	}
	...
	public void method6193(int var1, int var2, int var3) {
		...
		if (var6 + var2 > Rasterizer2D_yClipEnd) {
			var6 -= var6 + var2 - Rasterizer2D_yClipEnd;
		}
		...
		if (var7 + var1 > Rasterizer2D_xClipEnd) {
			var10 = var7 + var1 - Rasterizer2D_xClipEnd;
			var7 -= var10;
			var9 += var10;
			var8 += var10;
		}
		...
		if (var7 > 0 && var6 > 0) {
			method6194(Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
		}
	}
	...
	public void method6195(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var3 + var1 > Rasterizer2D_xClipEnd) {
				var16 = var3 + var1 - Rasterizer2D_xClipEnd;
				var3 -= var16;
				var15 += var16;
			}
			...
			method6267(Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
		}
	}
	...
	public void method6197(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				method6198(0, 0, 0, Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
				method6199(0, 0, 0, Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
			}
	...
	public void method6231(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var5 == 256) {
				method6201(0, 0, 0, var8, this.pixels, Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
			} else {
				method6202(0, 0, 0, var8, this.pixels, Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
			}
	...
	public void method6203(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
		...
		int var13 = var3 + var11 + (var9 + var2 + var4) * Rasterizer2D_width + var1;
		int var14 = var9 + var2;
		...
		for (int var15 = var9; var15 < var10; ++var15) {
			...
			for (int var20 = var19; var20 < var12; ++var20) {
				...
				if (var21 != 0) {
					Rasterizer2D_pixels[var18++] = var21 | -16777216;
				} else {
					++var18;
				}
			}
			...
			try {
				...
				for (var2 = 0; var2 < var4; ++var2) {
					...
					for (var1 = -var10[var2]; var1 < 0; ++var1) {
						...
						int var42 = var37 * (var29 >> 8 & 255) + var38 * (var30 >> 8 & 255) + var39 * (var31 >> 8 & 255) + var40 * (var32 >> 8 & 255) >> 8 & 65280;
		...
		try {
			...
			for (var2 = 0; var2 < var4; ++var2) {
				...
				for (var1 = -var3; var1 < 0; ++var1) {
					...
					if (var20 != 0) {
						Rasterizer2D_pixels[var17++] = var20 | -16777216;
					} else {
						++var17;
					}
	...
	public void method6247(int var1, int var2, int var3, int var4) {
		this.method6229(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
	}
	...
	void method6229(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			...
			if (var20 < 0) {
				var22 = var21 - var22;
				if (var22 < 0) {
					int var23 = var19 + var21 * Rasterizer2D_width;
							...
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D_width) {
								...
								if (var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0 && var31 - (this.subHeight << 12) < 0) {
									for (; var37 < 0; ++var37) {
										...
										if (var38 != 0) {
											Rasterizer2D_pixels[var34++] = var38 | -16777216;
										} else {
											++var34;
										}
									}
	...
	public void method6287(int var1, int var2, int var3, int var4) {
		if (var3 <= this.width && var4 <= this.height) {
			...
			if (var5 < var6 && var7 < var8) {
				int var9 = var5 + var7 * Rasterizer2D_width;
						...
						for (int var12 = var5; var12 < var6; ++var12) {
							...
							if (var19 != 0) {
								...
								if (var27 >= var19) {
									...
									Rasterizer2D_pixels[var9] = var28 | -16777216;
								}
	...
	public void copy$drawRotatedMaskedCenteredAround(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
		try {
			...
			for (var2 = 0; var2 < var4; ++var2) {
				...
				for (var1 = -var10[var2]; var1 < 0; ++var1) {
					Rasterizer2D_pixels[var19++] = this.pixels[this.subWidth * (var21 >> 16) + (var20 >> 16)] | -16777216;
					var20 += var14;
					var21 -= var13;
				}
