...
public class VorbisResidue implements RSVorbisResidue {
	...
	VorbisResidue() {
		this.residueType = VorbisSample.method2462(16);
		this.begin = VorbisSample.method2462(24);
		this.end = VorbisSample.method2462(24);
		this.partitionSize = VorbisSample.method2462(24) + 1;
		this.classifications = VorbisSample.method2462(6) + 1;
		this.classbook = VorbisSample.method2462(8);
		int[] var1 = new int[this.classifications];

		int var2;
		for (var2 = 0; var2 < this.classifications; ++var2) {
			int var3 = 0;
			int var4 = VorbisSample.method2462(3);
			boolean var5 = VorbisSample.method2486() != 0;
			if (var5) {
				var3 = VorbisSample.method2462(5);
			}
		...
		for (var2 = 0; var2 < this.classifications * 8; ++var2) {
			this.cascade[var2] = (var1[var2 >> 3] & 1 << (var2 & 7)) != 0 ? VorbisSample.method2462(8) : -1;
		}
		...
		if (!var3) {
			...
			for (int var8 = 0; var8 < 8; ++var8) {
				...
				while (var9 < var6) {
					...
					int var11;
					if (var8 == 0) {
						var10 = VorbisSample.VorbisSample_codebooks[this.classbook].method2438();
