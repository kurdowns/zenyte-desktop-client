...
public class MilliClock extends Clock implements RSMilliClock {
	...
	MilliClock() {
		...
		this.field2021 = 1;
		this.field2023 = 0;
		this.field2019 = class217.method4014();
	...
	public int vmethod3578(int var1, int var2) {
	...
	public static boolean method3546(int var0) {
		return (var0 >> 29 & 1) != 0;
	}
	...
	static final void method3539(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !AbstractWorldMapData.method356(var3))) {
				...
				if (var3.type == 0) {
					...
					method3539(var0, var3.id);
					if (var3.children != null) {
						method3539(var3.children, var3.id);
					}

					InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.method6010((long)var3.id);
					if (var4 != null) {
						var5 = var4.group;
						if (LoginScreenAnimation.method1900(var5)) {
							method3539(Widget.Widget_interfaceComponents[var5], -1);
						}
					}
				}
				...
				if (var3.type == 6) {
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							SequenceDefinition var6 = SpotAnimationDefinition.method4478(var5);
