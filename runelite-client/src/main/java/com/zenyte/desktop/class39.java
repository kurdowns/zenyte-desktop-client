...
public class class39 {
	...
	public static byte[] method644(Object var0, boolean var1) {
		if (var0 == null) {
			...
			return var1 ? HorizontalAlignment.method4758(var3) : var3;
		} else if (var0 instanceof AbstractByteArrayCopier) {
			AbstractByteArrayCopier var2 = (AbstractByteArrayCopier)var0;
			return var2.vmethod4008();
		} else {
	...
	public static Font method647(AbstractArchive var0, AbstractArchive var1, String var2, String var3) {
		int var4 = var0.method4240(var2);
		int var5 = var0.method4233(var4, var3);
		Font var6;
		if (!UserComparator7.method3502(var0, var4, var5)) {
			var6 = null;
		} else {
			var6 = VertexNormal.method3080(var1.method4224(var4, var5, (byte)-14));
		}
	...
	static void method646(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != ByteArrayPool.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					var8 = FaceNormal.method3363(ClientPacket.field2267, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method5531(0);
					var8.packetBuffer.method5584(var3[var6]);
					Client.packetWriter.method2361(var8);
				} else if (var0 == 4) {
					var8 = FaceNormal.method3363(ClientPacket.field2282, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method5532(var3[var6]);
					var8.packetBuffer.method5575(0);
					Client.packetWriter.method2361(var8);
				} else if (var0 == 6) {
					var8 = FaceNormal.method3363(ClientPacket.field2250, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method5697(0);
					var8.packetBuffer.method5584(var3[var6]);
					Client.packetWriter.method2361(var8);
				} else if (var0 == 7) {
					var8 = FaceNormal.method3363(ClientPacket.field2301, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method5531(0);
					var8.packetBuffer.method5532(var3[var6]);
					Client.packetWriter.method2361(var8);
				}
		...
		if (!var4) {
			Skeleton.method3161(4, "", "Unable to find " + var1);
		}
