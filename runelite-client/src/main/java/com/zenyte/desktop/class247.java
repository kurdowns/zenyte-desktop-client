...
public class class247 {
	...
	void method4387(int var1) {
		int var2 = var1 * 2 + 1;
		double[] var3 = class105.method2381(0.0D, (double)((float)var1 / 3.0F), var1);
	...
	@ObfuscatedSignature(
		signature = "(III)V",
		garbageValue = "-1027138584"
	)
	public final void method4381(int var1, int var2) {
	...
	public final void method4383(int var1, int var2, Sprite var3, float var4) {
		int var5 = (int)(var4 * 18.0F);
		Sprite var6 = this.method4378(var5);
		int var7 = var5 * 2 + 1;
		Bounds var8 = new Bounds(0, 0, var3.subWidth, var3.subHeight);
		Bounds var9 = new Bounds(0, 0);
		this.bounds.method6015(var7, var7);
		System.nanoTime();
		...
		for (var10 = 0; var10 < this.field3188; ++var10) {
			...
			this.bounds.method6014(var13, var14);
			this.bounds.method6013(var8, var9);
			this.method4402(var6, var3, var9);
		}
	...
	void method4402(Sprite var1, Sprite var2, Bounds var3) {
