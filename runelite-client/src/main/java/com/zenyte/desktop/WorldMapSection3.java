...
import net.runelite.rs.api.RSWorldMapSection3;

@ObfuscatedName("aw")
public class WorldMapSection3 implements WorldMapSection, RSWorldMapSection3 {
	@ObfuscatedName("n")
	@ObfuscatedSignature(
		signature = "Lkx;"
	)
	...
	public int[] vmethod873(int var1, int var2, int var3) {
		if (!this.vmethod871(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field396 * 64 - this.field394 * 64 + var2 + (this.field400 * 8 - this.field402 * 8), var3 + (this.field401 * 64 - this.field397 * 64) + (this.field395 * 8 - this.field399 * 8)};
			return var4;
		}
	}
	...
	public Coord vmethod890(int var1, int var2) {
		if (!this.vmethod872(var1, var2)) {
			...
			int var4 = this.field397 * 64 - this.field401 * 64 + var2 + (this.field399 * 8 - this.field395 * 8);
	...
	public void vmethod885(Buffer var1) {
		this.field398 = var1.method5547();
		this.field393 = var1.method5547();
		this.field394 = var1.method5549();
		this.field402 = var1.method5547();
		this.field397 = var1.method5549();
		this.field399 = var1.method5547();
		this.field396 = var1.method5549();
		this.field400 = var1.method5547();
		this.field401 = var1.method5549();
		this.field395 = var1.method5547();
		this.method876();
	}
	...
	public static RunException method893(Throwable var0, String var1) {
		RunException var2;
	...
	public static synchronized void method899(byte[] var0) {
