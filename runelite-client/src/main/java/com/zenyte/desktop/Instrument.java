...
public class Instrument implements RSInstrument {
	...
	final int[] method2830(int var1, int var2) {
		class310.method5775(Instrument_samples, 0, var1);
		if (var2 < 10) {
			return Instrument_samples;
		} else {
			double var3 = (double)var1 / ((double)var2 + 0.0D);
			this.pitch.method2584();
			this.volume.method2584();
			int var5 = 0;
			int var6 = 0;
			int var7 = 0;
			if (this.pitchModifier != null) {
				this.pitchModifier.method2584();
				this.pitchModifierAmplitude.method2584();
			...
			if (this.volumeMultiplier != null) {
				this.volumeMultiplier.method2584();
				this.volumeMultiplierAmplitude.method2584();
			...
			for (var11 = 0; var11 < var1; ++var11) {
				var12 = this.pitch.method2585(var1);
				var13 = this.volume.method2585(var1);
				if (this.pitchModifier != null) {
					var14 = this.pitchModifier.method2585(var1);
					var15 = this.pitchModifierAmplitude.method2585(var1);
					var12 += this.method2834(var7, var15, this.pitchModifier.form) >> 1;
					var7 = var7 + var6 + (var14 * var5 >> 16);
				}

				if (this.volumeMultiplier != null) {
					var14 = this.volumeMultiplier.method2585(var1);
					var15 = this.volumeMultiplierAmplitude.method2585(var1);
					var13 = var13 * ((this.method2834(var10, var15, this.volumeMultiplier.form) >> 1) + 32768) >> 15;
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.oscillatorVolume[var14] != 0) {
						...
						if (var15 < var1) {
							...
							var10000[var15] += this.method2834(Instrument_phases[var14], var13 * Instrument_volumeSteps[var14] >> 15, this.pitch.form);
			...
			if (this.release != null) {
				this.release.method2584();
				this.attack.method2584();
				var11 = 0;
				boolean var19 = false;
				boolean var20 = true;

				for (var14 = 0; var14 < var1; ++var14) {
					var15 = this.release.method2585(var1);
					var16 = this.attack.method2585(var1);
					if (var20) {
			...
			if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) {
				this.filterEnvelope.method2584();
				var11 = this.filterEnvelope.method2585(var1 + 1);
				var12 = this.filter.method2790(0, (float)var11 / 65536.0F);
				var13 = this.filter.method2790(1, (float)var11 / 65536.0F);
				if (var1 >= var12 + var13) {
					var14 = 0;
					var15 = var13;
					if (var13 > var1 - var12) {
					...
					while (true) {
						...
						if (var14 >= var1 - var12) {
							while (var14 < var1) {
								...
								Instrument_samples[var14] = var17;
								this.filterEnvelope.method2585(var1 + 1);
								++var14;
							}
							break;
						}
	...
	final void method2831(Buffer var1) {
		this.pitch = new SoundEnvelope();
		this.pitch.method2581(var1);
		this.volume = new SoundEnvelope();
		this.volume.method2581(var1);
		int var2 = var1.method5547();
		if (var2 != 0) {
			--var1.offset;
			this.pitchModifier = new SoundEnvelope();
			this.pitchModifier.method2581(var1);
			this.pitchModifierAmplitude = new SoundEnvelope();
			this.pitchModifierAmplitude.method2581(var1);
		}

		var2 = var1.method5547();
		if (var2 != 0) {
			--var1.offset;
			this.volumeMultiplier = new SoundEnvelope();
			this.volumeMultiplier.method2581(var1);
			this.volumeMultiplierAmplitude = new SoundEnvelope();
			this.volumeMultiplierAmplitude.method2581(var1);
		}
		...
		if (var2 != 0) {
			...
			this.release.method2581(var1);
			this.attack = new SoundEnvelope();
			this.attack.method2581(var1);
		}

		for (int var3 = 0; var3 < 10; ++var3) {
			int var4 = var1.method5561();
			if (var4 == 0) {
				break;
			}

			this.oscillatorVolume[var3] = var4;
			this.oscillatorPitch[var3] = var1.method5628();
			this.oscillatorDelays[var3] = var1.method5561();
		}

		this.delayTime = var1.method5561();
		this.delayDecay = var1.method5561();
		this.duration = var1.method5549();
		this.offset = var1.method5549();
		this.filter = new AudioFilter();
		this.filterEnvelope = new SoundEnvelope();
		this.filter.method2799(var1, this.filterEnvelope);
	}
}
