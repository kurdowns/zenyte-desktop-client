...
public final class BZip2Decompressor implements RSBZip2Decompressor {
	...
	public static int method5831(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			method5810(BZip2Decompressor_state);
	...
	static void method5811(BZip2State var0) {
	...
	static void method5810(BZip2State var0) {
		boolean var4 = false;
		boolean var5 = false;
		boolean var6 = false;
		boolean var7 = false;
		...
		while (true) {
			while (var26) {
				...
				for (var38 = 0; var38 < var40; ++var38) {
					...
					method5817(var0.limit[var38], var0.base[var38], var0.perm[var38], var0.temp_charArray2d[var38], var2, var3, var39);
	...
	static byte method5812(BZip2State var0) {
	...
	static byte method5822(BZip2State var0) {
	...
	static int method5814(int var0, BZip2State var1) {
	...
	static void method5809(BZip2State var0) {
		var0.nInUse = 0;
