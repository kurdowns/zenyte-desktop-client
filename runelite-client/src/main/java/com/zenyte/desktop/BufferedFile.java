...
public class BufferedFile implements RSBufferedFile {
	...
	public BufferedFile(AccessFile var1, int var2, int var3) throws IOException {
		...
		this.length = this.fileLength = var1.method6650();
	...
	public void method6618() throws IOException {
		this.method6626();
		this.accessFile.method6648();
	}
	...
	public void method6614(byte[] var1) throws IOException {
		this.method6610(var1, 0, var1.length);
	}
	...
	public void method6610(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (var3 > this.readBuffer.length) {
				this.accessFile.method6647(this.offset);

				for (this.fileOffset = this.offset; var3 > 0; var3 -= var8) {
					var8 = this.accessFile.method6658(var1, var2, var3);
					if (var8 == -1) {
						break;
					}
	...
	void method6615() throws IOException {
		...
		for (this.readBufferOffset = this.offset; this.readBufferLength < this.readBuffer.length; this.readBufferLength += var2) {
			...
			var2 = this.accessFile.method6658(this.readBuffer, this.readBufferLength, var1);
			if (var2 == -1) {
				break;
			}
	...
	public void method6633(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (var3 <= this.writeBuffer.length) {
				...
				this.accessFile.method6653(var1, var2, var3);
	...
	void method6626() throws IOException {
		if (-1L != this.writeBufferOffset) {
			if (this.fileOffset != this.writeBufferOffset) {
				this.accessFile.method6647(this.writeBufferOffset);
				this.fileOffset = this.writeBufferOffset;
			}

			this.accessFile.method6653(this.writeBuffer, 0, this.writeBufferLength);
