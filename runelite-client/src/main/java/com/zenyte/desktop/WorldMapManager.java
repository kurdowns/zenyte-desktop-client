...
public final class WorldMapManager implements RSWorldMapManager {
	...
	public void method725(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) {
			...
			System.nanoTime();
			int var4 = var1.method4240(WorldMapCacheName.field339.name);
			int var5 = var1.method4233(var4, var2);
			Buffer var6 = new Buffer(var1.method4223(WorldMapCacheName.field339.name, var2));
			Buffer var7 = new Buffer(var1.method4223(WorldMapCacheName.field340.name, var2));
			System.nanoTime();
			System.nanoTime();
			...
			this.tileX = this.mapAreaData.method453() * 64;
			this.tileY = this.mapAreaData.method439() * 64;
			this.tileWidth = (this.mapAreaData.method454() - this.mapAreaData.method453() + 1) * 64;
			...
			System.nanoTime();
			System.nanoTime();
			if (var1.method4299(WorldMapCacheName.field341.name, var2)) {
				byte[] var20 = var1.method4223(WorldMapCacheName.field341.name, var2);
				this.compositeTextureSprite = class200.method3731(var20);
			}
	...
	public final void method720(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (var18 = var13.x; var18 <= var23; ++var18) {
			for (var19 = var13.y; var19 <= var17; ++var19) {
				this.regions[var18][var19].method528(var15, (WorldMapScaleHandler)this.scaleHandlers.get(var15), this.mapSceneSprites, this.geographyArchive, this.groundArchive);
			}
		}

		Rasterizer2D.method6043(var9, var10, var11);
		Rasterizer2D.method6048(var12);
	...
	public void method729(int var1, int var2, int var3, int var4, HashSet var5, int var6, int var7) {
		if (this.compositeTextureSprite != null) {
			this.compositeTextureSprite.method6189(var1, var2, var3, var4);
			if (var6 > 0 && var6 % var7 < var7 / 2) {
				...
				while (true) {
					...
					while (var11.hasNext()) {
						...
						Rasterizer2D.method6110(var13 + var1, var14 + var2, 2, 16776960, 256);
					}
				}
			}
		}
	...
	static int method750(int var0, class101 var1, boolean var2) {
