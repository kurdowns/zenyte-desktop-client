...
import net.runelite.rs.api.RSTiles;

@ObfuscatedName("ba")
public final class Tiles implements RSTiles {
	@ObfuscatedName("qs")
	@ObfuscatedSignature(
		signature = "Ldz;"
	)
	...
	public static int method1217(CharSequence var0) {
		return class105.method2379(var0, 10, true);
	}
	...
	static boolean method1239(ObjectDefinition var0) {
		if (var0.transforms != null) {
			...
			for (int var2 = 0; var2 < var1.length; ++var2) {
				int var3 = var1[var2];
				ObjectDefinition var4 = WorldMapSection2.method435(var3);
				if (var4.mapIconId != -1) {
					return true;
				}
			}
	...
	static final int method1238() {
		if (GrandExchangeOfferOwnWorldComparator.clientPreferences.roofsHidden) {
			...
			int var0 = class277.method5013(WorldMapRectangle.cameraX, class200.cameraZ, ScriptEvent.Client_plane);
			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) {
						var9 = var2[var4++] << 16;
						var9 += var2[var4++];
						var10 = MusicPatchNode.method3898(var9);
						var11 = var2[var4++];
						if (var11 != -1 && (!AbstractWorldMapData.method373(var11).isMembersOnly || Client.isMembersWorld)) {
					...
					if (var6 == 14) {
						var9 = var2[var4++];
						var7 = Projectile.method2197(var9);
					}
					...
					if (var6 == 18) {
						var7 = (ByteArrayPool.localPlayer.x >> 7) + class69.baseX * 731242929;
					}

					if (var6 == 19) {
						var7 = (ByteArrayPool.localPlayer.y >> 7) + class89.baseY * 1825982697;
					}
