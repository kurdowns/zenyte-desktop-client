...
public class TextureProvider implements TextureLoader, RSTextureProvider {
	...
	public TextureProvider(AbstractArchive var1, AbstractArchive var2, int var3, double var4, int var6) {
		...
		int[] var7 = var1.method4234(0);
		int var8 = var7.length;
		this.textures = new Texture[var1.method4246(0)];

		for (int var9 = 0; var9 < var8; ++var9) {
			Buffer var10 = new Buffer(var1.method4224(0, var7[var9], (byte)-71));
		...
		for (int var4 = 0; var4 < var3.length; ++var4) {
			...
			if (var5 != null && var5.fileIds != null) {
				...
				for (int var7 = 0; var7 < var6.length; ++var7) {
					int var8 = var6[var7];
					if (this.archive.method4227(var8)) {
						++var2;
					}
				}
			}
	...
	public int[] vmethod3376(int var1) {
		Texture var2 = this.textures[var1];
		if (var2 != null) {
			if (var2.pixels != null) {
				this.deque.method4927(var2);
				var2.isLoaded = true;
				return var2.pixels;
			}

			boolean var3 = var2.method2940(this.brightness, this.textureSize, this.archive);
			if (var3) {
				if (this.remaining == 0) {
					Texture var4 = (Texture)this.deque.method4930();
					var4.method2941();
				} else {
					--this.remaining;
				}
	...
	public int vmethod3372(int var1) {
	...
	public boolean vmethod3374(int var1) {
	...
	public boolean vmethod3380(int var1) {
	...
	public void setBrightness(double var1) {
		this.method2839(var1);
	}

	public int[] load(int var1) {
		return this.vmethod3376(var1);
	}
}
