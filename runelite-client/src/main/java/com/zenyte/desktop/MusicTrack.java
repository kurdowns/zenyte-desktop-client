...
public class MusicTrack extends Node implements RSMusicTrack {
	...
	MusicTrack(Buffer var1) {
		...
		for (var29 = 0; var29 < var6; ++var29) {
			var28 = var28 + var1.method5547() & 127;
			if (var28 != 0 && var28 != 32) {
				if (var28 == 1) {
					++var16;
				} else if (var28 == 33) {
		...
		var51.method5689(1297377380);
		var51.method5689(6);
		var51.method5532(var2 > 1 ? 1 : 0);
		var51.method5532(var2);
		var51.method5532(var3);
		var1.offset = var13;
		int var52 = 0;
		int var53 = 0;
		int var54 = 0;
		...
		for (int var60 = 0; var60 < var2; ++var60) {
			...
			while (true) {
				while (true) {
					int var63 = var1.method5571();
					var51.method5546(var63);
					int var64 = var1.array[var29++] & 255;
					boolean var65 = var64 != var62;
					var62 = var64 & 15;
					if (var64 == 7) {
						if (var65) {
							var51.method5531(255);
						}

						var51.method5531(47);
						var51.method5531(0);
						var51.method5707(var51.offset - var61);
						continue label232;
					}
					...
					if (var64 == 23) {
						...
						var51.method5531(81);
						var51.method5531(3);
						var51.method5531(var1.array[var50++]);
						var51.method5531(var1.array[var50++]);
						var51.method5531(var1.array[var50++]);
					} else {
						var52 ^= var64 >> 4;
						if (var62 == 0) {
							if (var65) {
								var51.method5531(var52 + 144);
							}

							var53 += var1.array[var37++];
							var54 += var1.array[var38++];
							var51.method5531(var53 & 127);
							var51.method5531(var54 & 127);
						} else if (var62 == 1) {
							if (var65) {
								var51.method5531(var52 + 128);
							}

							var53 += var1.array[var37++];
							var55 += var1.array[var40++];
							var51.method5531(var53 & 127);
							var51.method5531(var55 & 127);
						} else if (var62 == 2) {
							if (var65) {
								var51.method5531(var52 + 176);
							}

							var28 = var28 + var1.array[var15++] & 127;
							var51.method5531(var28);
							byte var66;
							if (var28 != 0 && var28 != 32) {
								if (var28 == 1) {
							...
							var59[var28] = var67;
							var51.method5531(var67 & 127);
						} else if (var62 == 3) {
							if (var65) {
								var51.method5531(var52 + 224);
							}

							var56 += var1.array[var45++];
							var56 += var1.array[var33++] << 7;
							var51.method5531(var56 & 127);
							var51.method5531(var56 >> 7 & 127);
						} else if (var62 == 4) {
							if (var65) {
								var51.method5531(var52 + 208);
							}

							var57 += var1.array[var32++];
							var51.method5531(var57 & 127);
						} else if (var62 == 5) {
							if (var65) {
								var51.method5531(var52 + 160);
							}

							var53 += var1.array[var37++];
							var58 += var1.array[var31++];
							var51.method5531(var53 & 127);
							var51.method5531(var58 & 127);
						} else {
							if (var62 != 6) {
								throw new RuntimeException();
							}
							...
							if (var65) {
								var51.method5531(var52 + 192);
							}

							var51.method5531(var1.array[var44++]);
						}
					}
				}
			}
					...
					while (var7 == var4.trackLengths[var6]) {
						...
						if (var9 == 144) {
							...
							if (var12 > 0) {
								...
								ByteArrayNode var14 = (ByteArrayNode)this.table.method6010((long)var13);
								if (var14 == null) {
									var14 = new ByteArrayNode(new byte[128]);
									this.table.method5997(var14, (long)var13);
								}
	...
	public static MusicTrack method3993(AbstractArchive var0, int var1, int var2) {
