...
public class WorldMapIcon_0 extends AbstractWorldMapIcon implements RSWorldMapIcon_0 {
	...
	WorldMapIcon_0(Coord var1, Coord var2, int var3, WorldMapLabel var4) {
		...
		Sprite var6 = var5.method4443(false);
		if (var6 != null) {
	...
	static final void method304() {
		...
		if (var1 > Client.npcCount) {
			...
			for (var2 = 0; var2 < var1; ++var2) {
				...
				int var5 = var0.method5495(1);
				if (var5 == 0) {
					Client.npcIndices[++Client.npcCount - 1] = var3;
					var4.npcCycle = Client.cycle;
				} else {
					int var6 = var0.method5495(2);
					if (var6 == 0) {
						Client.npcIndices[++Client.npcCount - 1] = var3;
						var4.npcCycle = Client.cycle;
						...
						if (var6 == 1) {
							Client.npcIndices[++Client.npcCount - 1] = var3;
							var4.npcCycle = Client.cycle;
							var7 = var0.method5495(3);
							var4.method2119(var7, (byte)1);
							var8 = var0.method5495(1);
							if (var8 == 1) {
								Client.field725[++Client.field851 - 1] = var3;
							}
						} else if (var6 == 2) {
							...
							var4.npcCycle = Client.cycle;
							var7 = var0.method5495(3);
							var4.method2119(var7, (byte)2);
							var8 = var0.method5495(3);
							var4.method2119(var8, (byte)2);
							int var9 = var0.method5495(1);
							if (var9 == 1) {
								Client.field725[++Client.field851 - 1] = var3;
							}
						} else if (var6 == 3) {
