...
public final class KeyHandler implements KeyListener, FocusListener, RSKeyHandler {
	...
	public final synchronized void keyReleased(KeyEvent var1) {
		WorldMapSection1.client.getCallbacks().keyReleased(var1);
		if (!var1.isConsumed()) {
	...
	public final synchronized void keyPressed(KeyEvent var1) {
		WorldMapSection1.client.getCallbacks().keyPressed(var1);
		if (!var1.isConsumed()) {
	...
	public final void keyTyped(KeyEvent var1) {
		WorldMapSection1.client.getCallbacks().keyTyped(var1);
		if (!var1.isConsumed()) {
	...
	public static ServerPacket[] method938() {
	...
	public static AccessFile method919(String var0, String var1, boolean var2) {
	...
	static final void method939(Actor var0, int var1) {
		WorldMapSection0.method308(var0.x, var0.y, var1);
	}
}
