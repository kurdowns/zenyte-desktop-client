...
final class GrandExchangeOfferAgeComparator implements Comparator, RSGrandExchangeOfferAgeComparator {
		...
		if (Login.worldSelectOpen) {
			while (true) {
				if (!class22.method255()) {
					...
					if (Login.hoveredWorldIndex != -1) {
						...
						UserComparator3.method3511(var5);
						Login.worldSelectOpen = false;
						Login.leftTitleSprite.method6185(Login.xPadding, 0);
						DirectByteArrayCopier.rightTitleSprite.method6185(Login.xPadding + 382, 0);
						class3.logoSprite.method6173(Login.xPadding + 382 - class3.logoSprite.subWidth / 2, 18);
			...
			if ((MouseHandler.MouseHandler_lastButton == 1 || !class217.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50 && MouseHandler.MouseHandler_lastPressedY >= 453) {
				...
				if (!GrandExchangeOfferOwnWorldComparator.clientPreferences.titleMusicDisabled) {
					class105.method2380(AbstractWorldMapIcon.archive6, "scape main", "", 255, false);
				} else {
					Client.method1494();
				}
			}
			...
			if (Client.gameState != 5) {
				if (Login.field1223 == -1L) {
					Login.field1223 = class217.method4014() + 1000L;
				}

				long var21 = class217.method4014();
				boolean var3;
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					if (IgnoreList.clientLanguage == Language.Language_EN) {
						...
						if (LoginPacket.World_request != null && Language.method3729()) {
							Login.worldSelectOpen = true;
							Login.worldSelectPage = 0;
							Login.worldSelectPagesCount = 0;
						}
					...
					if (Login.loginIndex == 0) {
						...
						if (var4 == 1 && var46 >= var37 - 75 && var46 <= var37 + 75 && var33 >= var36 - 20 && var33 <= var36 + 20) {
							class101.method2322(class41.method654("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}
							...
							if (Login.loginIndex == 2) {
								...
								if (class41.field315 != null) {
									...
									if (var4 == 1 && var46 >= class41.field315.lowX - var37 && var46 <= var37 + class41.field315.lowX && var33 >= var35 - 15 && var33 < var35) {
										...
										case 1:
											HealthBarUpdate.method1852("Please enter your username.", "If you created your account after November", "2010, this will be the creation email address.");
											Login.loginIndex = 5;
											return;
										case 2:
											class101.method2322("https://support.runescape.com/hc/en-gb", true, false);
										}
									}
								}
								...
								if (var4 == 1 && var46 >= var37 - 75 && var46 <= var37 + 75 && var33 >= var36 - 20 && var33 <= var36 + 20) {
									...
									if (Login.Login_username.length() == 0) {
										HealthBarUpdate.method1852("", "Please enter your username/email address.", "");
										return;
									}

									if (Login.Login_password.length() == 0) {
										HealthBarUpdate.method1852("", "Please enter your password.", "");
										return;
									}

									HealthBarUpdate.method1852("", "Connecting to server...", "");
								...
								if (Login.loginIndex == 4) {
									...
									if (var4 == 1 && var46 >= var34 - 75 && var46 <= var34 + 75 && var33 >= var8 - 20 && var33 <= var8 + 20) {
										...
										if (MilliClock.otp.length() != 6) {
											HealthBarUpdate.method1852("", "Please enter a 6-digit PIN.", "");
											return;
										}

										GraphicsObject.field1141 = Integer.parseInt(MilliClock.otp);
										MilliClock.otp = "";
										GraphicsObject.method2108(true);
										HealthBarUpdate.method1852("", "Connecting to server...", "");
										MouseRecorder.method1293(20);
										return;
									}
									...
									if (var4 == 1 && var46 >= Login.loginBoxX + 180 - 34 && var46 <= Login.loginBoxX + 34 + 180 && var33 >= 351 && var33 <= 363) {
										class101.method2322(class41.method654("secure", true) + "m=totp-authenticator/disableTOTPRequest", true, false);
									}
									...
									var34 = Login.loginBoxX + 180 + 80;
									if (var4 == 1 && var46 >= var34 - 75 && var46 <= var34 + 75 && var33 >= var8 - 20 && var33 <= var8 + 20) {
										ObjectDefinition.method4687(true);
									}
									...
									if (MusicPatchPcmStream.field2495 != null) {
										...
										if (var4 == 1 && var46 >= MusicPatchPcmStream.field2495.lowX - var10 && var46 <= var10 + MusicPatchPcmStream.field2495.lowX && var33 >= var36 - 15 && var33 < var36) {
											class101.method2322(class41.method654("secure", true) + "m=weblogin/g=oldscape/cant_log_in", true, false);
										}
									}
									...
									if (Login.loginIndex == 7) {
										...
										var8 = 321;
										if (var4 == 1 && var46 >= var34 - 75 && var46 <= var34 + 75 && var33 >= var8 - 20 && var33 <= var8 + 20) {
											class101.method2322(class41.method654("secure", true) + "m=dob/set_dob.ws", true, false);
											HealthBarUpdate.method1852("", "Page has opened in a new window.", "(Please check your popup blocker.)");
											Login.loginIndex = 6;
											return;
										}
										...
										var8 = 321;
										if (var4 == 1 && var46 >= var34 - 75 && var46 <= var34 + 75 && var33 >= var8 - 20 && var33 <= var8 + 20) {
											class101.method2322("https://www.jagex.com/terms/privacy", true, false);
											HealthBarUpdate.method1852("", "Page has opened in a new window.", "(Please check your popup blocker.)");
											Login.loginIndex = 6;
											return;
										}
										...
										var36 = 276;
										if (var4 == 1 && var46 >= var37 - 75 && var46 <= var37 + 75 && var33 >= var36 - 20 && var33 <= var36 + 20) {
											class101.method2322(var29, true, false);
											HealthBarUpdate.method1852("", "Page has opened in a new window.", "(Please check your popup blocker.)");
											Login.loginIndex = 6;
											return;
										}
			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method3614(var3, var4);
						}
					}
				}
			}
		...
		for (var2 = 0; var2 < 4; ++var2) {
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var2 > 0) {
									...
									if (var21 > 0 && !UserComparator9.method3477(var21 - 1).hideUnderlay) {
										var47 = false;
									}
								...
								var32 = 0;
								if (var31 != -1) {
									var32 = Rasterizer3D.Rasterizer3D_colorPalette[Strings.method4196(var31, 96)];
								}

								if (var21 == 0) {
									var0.method3168(var2, var11, var17, 0, 0, -1, var22, var23, var24, var25, Strings.method4196(var30, var26), Strings.method4196(var30, var27), Strings.method4196(var30, var28), Strings.method4196(var30, var29), 0, 0, 0, 0, var32, 0);
								} else {
									var33 = Tiles.field539[var2][var11][var17] + 1;
									byte var48 = Tiles.field540[var2][var11][var17];
									FloorOverlayDefinition var35 = UserComparator9.method3477(var21 - 1);
									...
									int var40;
									if (var36 >= 0) {
										var38 = Rasterizer3D.Rasterizer3D_textureLoader.vmethod3372(var36);
										var37 = -1;
									...
									var39 = 0;
									if (var38 != -2) {
										var39 = Rasterizer3D.Rasterizer3D_colorPalette[class297.method5305(var38, 96)];
									}
									...
									var0.method3168(var2, var11, var17, var33, var48, var36, var22, var23, var24, var25, Strings.method4196(var30, var26), Strings.method4196(var30, var27), Strings.method4196(var30, var28), Strings.method4196(var30, var29), class297.method5305(var37, var26), class297.method5305(var37, var27), class297.method5305(var37, var28), class297.method5305(var37, var29), var32, var39);
								}
							}
						}
					}
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					var0.method3167(var2, var12, var11, var17);
				}
			}
					...
					for (int var8 = 0; var8 <= 104; ++var8) {
						...
						if ((WorldMapSection3.field404[var6][var8][var7] & var2) != 0) {
							...
							if (var13 >= 8) {
								...
								Scene.method3263(var5, 1, var8 * 128, var8 * 128, var9 * 128, var10 * 128 + 128, var15, var16);
						...
						if ((WorldMapSection3.field404[var6][var8][var7] & var3) != 0) {
							...
							if (var13 >= 8) {
								...
								Scene.method3263(var5, 2, var9 * 128, var10 * 128 + 128, var7 * 128, var7 * 128, var15, var16);
						...
						if ((WorldMapSection3.field404[var6][var8][var7] & var4) != 0) {
							...
							if ((var12 - var11 + 1) * (var10 - var9 + 1) >= 4) {
								...
								Scene.method3263(var5, 4, var9 * 128, var10 * 128 + 128, var11 * 128, var12 * 128 + 128, var13, var13);
	...
	static final void method249() {
		for (GraphicsObject var0 = (GraphicsObject)Client.graphicsObjects.method4931(); var0 != null; var0 = (GraphicsObject)Client.graphicsObjects.method4949()) {
			if (var0.plane == ScriptEvent.Client_plane && !var0.isFinished) {
				if (Client.cycle >= var0.cycleStart) {
					var0.method2101(Client.field741);
					if (var0.isFinished) {
						var0.method3657();
					} else {
						GrandExchangeOfferWorldComparator.scene.method3174(var0.plane, var0.x, var0.y, var0.height, 60, var0, 0, -1L, false);
					}
				}
			} else {
				var0.method3657();
