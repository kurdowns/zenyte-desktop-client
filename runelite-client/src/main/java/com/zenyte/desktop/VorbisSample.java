...
public class VorbisSample extends Node implements RSVorbisSample {
	...
	void method2463(byte[] var1) {
		...
		this.sampleRate = var2.method5552();
		this.sampleCount = var2.method5552();
		this.start = var2.method5552();
		this.end = var2.method5552();
		if (this.end < 0) {
			this.end = ~this.end;
			this.field1387 = true;
		}

		int var3 = var2.method5552();
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			int var6;
			do {
				var6 = var2.method5547();
				var5 += var6;
			} while(var6 >= 255);

			byte[] var7 = new byte[var5];
			var2.method5620(var7, 0, var5);
	...
	float[] method2480(int var1) {
		...
		method2486();
		int var2 = method2462(PacketBufferNode.method3689(VorbisSample_mapping.length - 1));
		...
		boolean var15 = !VorbisSample_floors[var17].method2502();
		boolean var45 = var15;
		...
		if (!var15) {
			...
			VorbisSample_floors[var40].method2503(field1391, var4 >> 1);
		}
		...
		if (var15) {
			...
			var25 = PacketBufferNode.method3689(var4 - 1);
	...
	static void method2464(byte[] var0) {
		method2461(var0, 0);
		VorbisSample_blockSize0 = 1 << method2462(4);
		VorbisSample_blockSize1 = 1 << method2462(4);
		...
		for (var1 = 0; var1 < 2; ++var1) {
			...
			int var10 = PacketBufferNode.method3689(var5 - 1);

			for (int var11 = 0; var11 < var5; ++var11) {
				var14[var11] = VarpDefinition.method4429(var11, var10);
			}
		...
		for (int var15 = 0; var15 < var5; ++var15) {
			VorbisSample_blockFlags[var15] = method2486() != 0;
			method2462(16);
			method2462(16);
			VorbisSample_mapping[var15] = method2462(8);
		}
	...
	static boolean method2460(AbstractArchive var0) {
		if (!field1386) {
	...
	static VorbisSample method2489(AbstractArchive var0, int var1, int var2) {
		if (!method2460(var0)) {
			var0.method4238(var1, var2);
			return null;
		} else {
