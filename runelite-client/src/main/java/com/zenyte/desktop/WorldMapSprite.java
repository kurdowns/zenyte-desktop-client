...
public final class WorldMapSprite implements RSWorldMapSprite {
	...
	final int method512(int var1, int var2) {
	...
	static class101 method511(int var0) {
		class101 var1 = (class101)class101.Script_cached.method3418((long)var0);
		if (var1 != null) {
			return var1;
		} else {
			byte[] var2 = class41.archive12.method4224(var0, 0, (byte)-40);
			if (var2 == null) {
				return null;
			} else {
				var1 = SecureRandomCallable.method1246(var2);
				class101.Script_cached.method3424(var1, (long)var0);
				return var1;
			}
		}
	}
	...
	public static void method510(Buffer var0, int var1) {
		if (JagexCache.JagexCache_randomDat != null) {
			try {
				JagexCache.JagexCache_randomDat.method6612(0L);
				JagexCache.JagexCache_randomDat.method6633(var0.array, var1, 24);
