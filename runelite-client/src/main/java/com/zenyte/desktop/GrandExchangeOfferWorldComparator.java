...
final class GrandExchangeOfferWorldComparator implements Comparator, RSGrandExchangeOfferWorldComparator {
	...
	static int method137(int var0, class101 var1, boolean var2) {
	...
	static void method149(Player var0, int var1, int var2) {
		if (var0.sequence == var1 && var1 != -1) {
			int var3 = SpotAnimationDefinition.method4478(var1).field3525;
			if (var3 == 1) {
		...
		} else if (var1 == -1 || var0.sequence == -1 || SpotAnimationDefinition.method4478(var1).field3519 >= SpotAnimationDefinition.method4478(var0.sequence).field3519) {
			var0.sequence = var1;
	...
	public static void method148(int var0, int var1, int var2, boolean var3) {
		PacketBufferNode var4 = FaceNormal.method3363(ClientPacket.field2224, Client.packetWriter.isaacCipher);
		var4.packetBuffer.method5700(var2);
		var4.packetBuffer.method5689(var3 ? Client.field762 : 0);
		var4.packetBuffer.method5582(var0);
		var4.packetBuffer.method5584(var1);
