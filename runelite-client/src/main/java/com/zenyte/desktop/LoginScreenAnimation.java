...
public class LoginScreenAnimation implements RSLoginScreenAnimation {
	...
	void method1921() {
		...
		this.method1903((IndexedSprite)null);
	...
	final int method1926(int var1, int var2, int var3) {
		int var4 = 256 - var3;
	...
	final void method1905(int var1) {
		int var2 = this.field1074.length;
		if (this.field1063 > 0) {
			this.method1901(this.field1063, this.field1065);
		} else if (this.field1066 > 0) {
			this.method1901(this.field1066, this.field1064);
		} else {
	...
	final void method1901(int var1, int[] var2) {
		int var3 = this.field1074.length;

		for (int var4 = 0; var4 < var3; ++var4) {
			if (var1 > 768) {
				this.field1074[var4] = this.method1926(this.field1062[var4], var2[var4], 1024 - var1);
			} else if (var1 > 256) {
				this.field1074[var4] = var2[var4];
			} else {
				this.field1074[var4] = this.method1926(var2[var4], this.field1062[var4], 256 - var1);
			}
		}
	...
	final void method1903(IndexedSprite var1) {
		int var2;
	...
	public static boolean method1925(int var0) {
		return (var0 & 1) != 0;
	}
	...
	public static boolean method1900(int var0) {
		if (Widget.Widget_loadedInterfaces[var0]) {
			return true;
		} else if (!Widget.Widget_archive.method4250(var0)) {
			return false;
		} else {
			int var1 = Widget.Widget_archive.method4246(var0);
			if (var1 == 0) {
				...
				for (int var2 = 0; var2 < var1; ++var2) {
					if (Widget.Widget_interfaceComponents[var0][var2] == null) {
						byte[] var3 = Widget.Widget_archive.method4224(var0, var2, (byte)-57);
						if (var3 != null) {
							Widget.Widget_interfaceComponents[var0][var2] = new Widget();
							Widget.Widget_interfaceComponents[var0][var2].id = var2 + (var0 << 16);
							if (var3[0] == -1) {
								Widget.Widget_interfaceComponents[var0][var2].method4153(new Buffer(var3));
							} else {
								Widget.Widget_interfaceComponents[var0][var2].method4109(new Buffer(var3));
							}
						}
					}
				}
	...
	static void method1924(int var0) {
		for (IntegerNode var1 = (IntegerNode)Client.widgetClickMasks.method5995(); var1 != null; var1 = (IntegerNode)Client.widgetClickMasks.method6003()) {
