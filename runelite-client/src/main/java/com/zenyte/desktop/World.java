...
public class World implements RSWorld {
	...
	public static void method1894(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2, AbstractArchive var3) {
		...
		Widget.Widget_interfaceComponents = new Widget[Widget.Widget_archive.method4235()][];
		Widget.Widget_loadedInterfaces = new boolean[Widget.Widget_archive.method4235()];
	}
	...
	public static boolean method1893(char var0) {
	...
	static final void method1884(int var0, int var1) {
		NodeDeque var2 = Client.groundItems[ScriptEvent.Client_plane][var0][var1];
		if (var2 == null) {
			GrandExchangeOfferWorldComparator.scene.method3184(ScriptEvent.Client_plane, var0, var1);
		} else {
			long var3 = -99999999L;
			TileItem var5 = null;

			TileItem var6;
			for (var6 = (TileItem)var2.method4931(); var6 != null; var6 = (TileItem)var2.method4949()) {
			...
			if (var5 == null) {
				...
				long var9 = IsaacCipher.method6337(var0, var1, 3, false, 0);
				GrandExchangeOfferWorldComparator.scene.method3170(ScriptEvent.Client_plane, var0, var1, class277.method5013(var0 * 128 + 64, var1 * 128 + 64, ScriptEvent.Client_plane), var5, var9, var12, var11);
			}
		}
	}
}
