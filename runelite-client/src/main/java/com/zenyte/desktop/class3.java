...
public class class3 implements Enumerated {
	...
	static void method58(Archive var0, int var1) {
		if (class13.NetCache_reference != null) {
			...
			int var2 = class13.NetCache_reference.method5552();
			int var3 = class13.NetCache_reference.method5552();
			var0.method4323(var2, var3);
		} else {
			Frames.method3371((Archive)null, 255, 255, 0, (byte)0, true);
	...
	static void method57(int var0, Coord var1, boolean var2) {
		WorldMapArea var3 = class13.method133().method6434(var0);
		int var4 = ByteArrayPool.localPlayer.plane;
		int var5 = (ByteArrayPool.localPlayer.x >> 7) + class69.baseX * 731242929;
		int var6 = (ByteArrayPool.localPlayer.y >> 7) + class89.baseY * 1825982697;
		Coord var7 = new Coord(var4, var5, var6);
		class13.method133().method6551(var3, var7, var1, var2);
	}
	...
	static final void method60(Widget var0, int var1, int var2) {
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !class217.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				SpriteMask var3 = var0.method4115(true);
				if (var3 == null) {
					return;
				}
				...
				if (var3.method4037(var4, var5)) {
					...
					PacketBufferNode var13 = FaceNormal.method3363(ClientPacket.field2207, Client.packetWriter.isaacCipher);
					var13.packetBuffer.method5531(18);
					var13.packetBuffer.method5532(var11 + class69.baseX * 731242929);
					var13.packetBuffer.method5531(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0);
					var13.packetBuffer.method5532(var12 + class89.baseY * 1825982697);
					var13.packetBuffer.method5531(var4);
					var13.packetBuffer.method5531(var5);
					var13.packetBuffer.method5532(Client.camAngleY);
					var13.packetBuffer.method5531(57);
					var13.packetBuffer.method5531(0);
					var13.packetBuffer.method5531(0);
					var13.packetBuffer.method5531(89);
					var13.packetBuffer.method5532(ByteArrayPool.localPlayer.x);
					var13.packetBuffer.method5532(ByteArrayPool.localPlayer.y);
					var13.packetBuffer.method5531(63);
					Client.packetWriter.method2361(var13);
