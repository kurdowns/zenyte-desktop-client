...
public class ArchiveLoader implements RSArchiveLoader {
	...
	ArchiveLoader(Archive var1, String var2) {
		this.loadedCount = 0;
		this.archive = var1;
		this.groupCount = var1.method4235();
	}
	...
	boolean method1253() {
		...
		for (int var1 = 0; var1 < this.groupCount; ++var1) {
			if (!this.archive.method4329(var1) || this.archive.method4328(var1)) {
				++this.loadedCount;
			}
		}
	...
	static final void method1256(Widget var0, int var1, int var2, int var3) {
		...
		if (var4 != null) {
			Rasterizer2D.method6045(var1, var2, var4.width + var1, var2 + var4.height);
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				int var5 = Client.camAngleY & 2047;
				int var6 = ByteArrayPool.localPlayer.x / 32 + 48;
				int var7 = 464 - ByteArrayPool.localPlayer.y / 32;
				ArchiveDisk.sceneMinimapSprite.method6204(var1, var2, var4.width, var4.height, var6, var7, var5, 256, var4.xStarts, var4.xWidths);
				...
				for (var8 = 0; var8 < Client.npcCount; ++var8) {
					...
					if (var16 != null && var16.vmethod2118()) {
						NPCDefinition var18 = var16.definition;
						if (var18 != null && var18.transforms != null) {
							var18 = var18.method4766();
						}
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var17 != null && var17.vmethod2118() && !var17.isHidden && var17 != ByteArrayPool.localPlayer) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - class69.baseX * -1369995580 + 2 - ByteArrayPool.localPlayer.x / 32;
						var11 = Client.hintArrowY * 4 - class89.baseY * -1286003804 + 2 - ByteArrayPool.localPlayer.y / 32;
				...
				if (!ByteArrayPool.localPlayer.isHidden) {
					Rasterizer2D.method6052(var4.width / 2 + var1 - 1, var4.height / 2 + var2 - 1, 3, 3, 16777215);
				}
			} else {
