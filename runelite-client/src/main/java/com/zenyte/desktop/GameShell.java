...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener, RSGameShell {
	...
	protected GameShell() {
		...
		ReflectionCheck.method2383(new DevicePcmPlayerProvider());
	}
	...
	protected abstract void vmethod1410();
	...
	final void method1087() {
		...
		class329.method6041(this.canvas);
		if (this.mouseWheelHandler != null) {
	...
	protected final void method1028(int var1, int var2, int var3) {
		try {
			...
			class227.taskHandler.method3551(this, 1);
		} catch (Exception var5) {
			WorldMapDecorationType.method4189((String)null, var5);
	...
	final synchronized void method1029() {
		...
		this.isCanvasInvalid = false;
		this.onReplaceCanvasNextFrameChanged(-1);
		this.field497 = class217.method4014();
	}
	...
	void method1032() {
		...
		this.method1033();
		this.vmethod1403(this.field493);
		if (this.field493) {
			this.method1026();
		}
	...
	final synchronized void method1037() {
		if (!isKilled) {
			...
			if (class227.taskHandler != null) {
				try {
					class227.taskHandler.method3548();
	...
	protected abstract void vmethod1401();
	...
	protected abstract void vmethod1403(boolean var1);
	...
	protected abstract void vmethod1404();
	...
	public final synchronized void paint(Graphics var1) {
		if (this == gameShell && !isKilled) {
			this.field493 = true;
			if (class217.method4014() - this.field497 > 1000L) {
	...
	public final void destroy() {
		if (this == gameShell && !isKilled) {
			stopTimeMs = class217.method4014();
	...
	public void run() {
		...
		try {
			if (TaskHandler.javaVendor != null) {
				...
				if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
					...
					if (var2.startsWith("1.6.0_")) {
						int var3;
						for (var3 = 6; var3 < var2.length() && PcmPlayer.method2580(var2.charAt(var3)); ++var3) {
						}

						String var4 = var2.substring(6, var3);
						if (MusicPatch.method3959(var4) && Tiles.method1217(var4) < 10) {
							this.method1120("wrongjava");
							return;
						}
					}
			...
			while (0L == stopTimeMs || class217.method4014() < stopTimeMs) {
				ModelData0.gameCyclesToDo = clock.vmethod3578(cycleDurationMillis, fiveOrOne);
			...
			WorldMapDecorationType.method4189((String)null, var6);
			this.method1120("crash");
		}
	...
	public final void stop() {
		if (this == gameShell && !isKilled) {
			stopTimeMs = class217.method4014() + 4000L;
		}
	}
