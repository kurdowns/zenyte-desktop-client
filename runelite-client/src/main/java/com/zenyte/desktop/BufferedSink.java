...
import net.runelite.rs.api.RSBufferedSink;

@ObfuscatedName("lo")
public class BufferedSink implements Runnable, RSBufferedSink {
	@ObfuscatedName("x")
	Thread thread;
	@ObfuscatedName("m")
	...
	void method5881(byte[] var1, int var2, int var3) throws IOException {
