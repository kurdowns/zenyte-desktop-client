...
public class StructDefinition extends DualNode implements RSStructDefinition {
   ...
   void method4586(Buffer var1, int var2) {
      if(var2 == 249) {
   ...
   public int method4589(int var1, int var2) {
   ...
   public String method4587(int var1, String var2) {
   ...
   static char method4590(char var0) {
