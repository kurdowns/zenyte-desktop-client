...
public final class Player extends Actor implements RSPlayer {
   ...
   void method1333() {
      this.isFriendTriBool = Projectile.friendSystem.method1965(this.username)?TriBool.TriBool_true:TriBool.TriBool_false;
      this.updateFriended();
   }
   ...
   void method1336() {
      this.isInClanChat = InterfaceParent.clanChat != null && InterfaceParent.clanChat.method5142(this.username)?TriBool.TriBool_true:TriBool.TriBool_false;
   }
   ...
   int method1337() {
      return this.appearance != null && this.appearance.npcTransformId != -1?class237.method4226(this.appearance.npcTransformId).size:1;
   }
   ...
   public final void copy$read(Buffer var1, int var2) {
      ...
      this.headIconPk = var1.method5576();
      this.skullChanged(-1);
      this.headIconPrayer = var1.method5576();
      this.prayerChanged(-1);
      int var4 = -1;
      this.team = 0;
      int[] var5 = new int[12];
      ...
      for(int var6 = 0; var6 < 12; ++var6) {
         ...
         var7 = var1.method5575();
         if(var7 == 0) {
            var5[var6] = 0;
         } else {
            var8 = var1.method5575();
      ...
      super.idleSequence = var1.method5577();
      if(super.idleSequence == '\uffff') {
         super.idleSequence = -1;
      }

      super.turnLeftSequence = var1.method5577();
      if(super.turnLeftSequence == '\uffff') {
         super.turnLeftSequence = -1;
      }

      super.turnRightSequence = super.turnLeftSequence;
      super.walkSequence = var1.method5577();
      if(super.walkSequence == '\uffff') {
         super.walkSequence = -1;
      }

      super.walkBackSequence = var1.method5577();
      if(super.walkBackSequence == '\uffff') {
         super.walkBackSequence = -1;
      }

      super.walkLeftSequence = var1.method5577();
      if(super.walkLeftSequence == '\uffff') {
         if(var2 >= -1370407384) {
            return;
         }
      ...
      super.walkRightSequence = var1.method5577();
      if(super.walkRightSequence == '\uffff') {
         super.walkRightSequence = -1;
      }

      super.runSequence = var1.method5577();
      if(super.runSequence == '\uffff') {
         super.runSequence = -1;
      }

      this.username = new Username(var1.method5695(), WorldMapIcon_0.loginType);
      this.method1332();
      this.method1375();
      if(this == ByteArrayPool.localPlayer) {
         RunException.localPlayerName = this.username.method5263();
      }

      this.combatLevel = var1.method5575();
      this.skillLevel = var1.method5577();
      boolean var10001;
      ...
      this.appearance.method4105(var5, var10, var3 == 1, var4);
   }
   ...
   public final Model copy$getModel(int var1) {
      if(this.appearance == null) {
         ...
         SequenceDefinition var3 = super.movementSequence != -1 && !this.isUnanimated && (super.idleSequence != super.movementSequence || var2 == null)?SpotAnimationDefinition.method4503(super.movementSequence):null;
         Model var4 = this.appearance.method4094(var2, super.sequenceFrame, var3, super.movementFrame);
         if(var4 == null) {
            return null;
         } else {
            var4.method2969();
            ...
            if(!this.isUnanimated && super.spotAnimation != -1 && super.spotAnimationFrame != -1) {
               var5 = MouseHandler.method1205(super.spotAnimation).method4492(super.spotAnimationFrame);
               if(var5 != null) {
            ...
            if(!this.isUnanimated && this.model0 != null) {
               ...
               if(Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
                  var5 = this.model0;
                  var5.method2980(this.field662 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field657 * 4096 - super.y);
                  ...
                  var5.method2980(super.x - this.field662 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field657 * 4096);
               }
            }
   ...
   static void method1384(int var0, boolean var1, int var2, boolean var3) {
      if(UserComparator2.World_worlds != null) {
         ModelData0.method3363(0, UserComparator2.World_worlds.length - 1, var0, var1, var2, var3);
      }
   ...
   static final void method1380(Widget var0, int var1, int var2) {
      if(Client.clickedWidget == null && !Client.isMenuOpen) {
         if(var0 != null && KitDefinition.method4539(var0) != null) {
            Client.clickedWidget = var0;
            Client.clickedWidgetParent = KitDefinition.method4539(var0);
