...
import net.runelite.rs.api.RSBZip2Decompressor;

@ObfuscatedName("lb")
public final class BZip2Decompressor implements RSBZip2Decompressor {
   ...
   @ObfuscatedName("x")
   public static int method5859(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      ...
      synchronized(BZip2Decompressor_state) {
         ...
         method5838(BZip2Decompressor_state);
   ...
   static void method5839(BZip2State var0) {
   ...
   static void method5838(BZip2State var0) {
      ...
      if(WorldMapData_0.BZip2Decompressor_block == null) {
         WorldMapData_0.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
      }

      boolean var26 = true;

      while(var26) {
         byte var1 = method5840(var0);
         if(var1 == 23) {
            return;
         }

         var1 = method5840(var0);
         var1 = method5840(var0);
         var1 = method5840(var0);
         var1 = method5840(var0);
         var1 = method5840(var0);
         ...
         int var40 = method5842(3, var0);
         int var41 = method5842(15, var0);
         var36 = 0;
         ...
         for(var38 = 0; var38 < var40; ++var38) {
            ...
            method5845(var0.limit[var38], var0.base[var38], var0.perm[var38], var0.temp_charArray2d[var38], var2, var3, var39);
         ...
         int var52;
         byte var53;
         for(var52 = method5842(var22, var0); var52 > var23[var51]; var52 = var52 << 1 | var53) {
            ++var51;
            var53 = method5850(var0);
         }
         ...
         for(var36 = 0; var36 < var47; ++var36) {
            ...
            WorldMapData_0.BZip2Decompressor_block[var0.cftab[var1 & 255]] |= var36 << 8;
            ++var0.cftab[var1 & 255];
         }
   ...
   static byte method5840(BZip2State var0) {
      return (byte)method5842(8, var0);
   }
   ...
   static byte method5850(BZip2State var0) {
      return (byte)method5842(1, var0);
   }
   ...
   static int method5842(int var0, BZip2State var1) {
   ...
   static void method5837(BZip2State var0) {
      var0.nInUse = 0;
   ...
   @ObfuscatedName("z")
   static void method5845(int[] var0, int[] var1, int[] var2, byte[] var3, int var4, int var5, int var6) {
      int var7 = 0;
