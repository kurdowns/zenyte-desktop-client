...
@ObfuscatedName("kw")
public abstract class UserList implements RSUserList {
   ...
   UserList(int var1) {
      this.capacity = var1;
      this.array = this.vmethod5309(var1);
   ...
   abstract User[] vmethod5309(int var1);
   ...
   public boolean method5142(Username var1) {
      return !var1.method5264()?false:(this.usernamesMap.containsKey(var1)?true:this.previousUsernamesMap.containsKey(var1));
   }
   ...
   public User method5227(Username var1) {
      User var2 = this.method5144(var1);
      return var2 != null?var2:this.method5145(var1);
   }
   ...
   User method5144(Username var1) {
      return !var1.method5264()?null:(User)this.usernamesMap.get(var1);
   }
   ...
   User method5145(Username var1) {
      return !var1.method5264()?null:(User)this.previousUsernamesMap.get(var1);
   }
   ...
   public final boolean method5146(Username var1) {
      User var2 = this.method5144(var1);
      if(var2 == null) {
         return false;
      } else {
   ...
   final void method5220(User var1) {
      this.remove(var1);
      int var2 = this.method5176(var1);
      if(var2 != -1) {
         this.method5157(var2);
         this.method5189(var1);
      }
   }
   ...
   User method5148(Username var1) {
      return this.method5209(var1, (Username)null);
   }
   ...
   User method5209(Username var1, Username var2) {
      if(this.method5144(var1) != null) {
         throw new IllegalStateException();
      } else {
         User var3 = this.vmethod5297();
         var3.method5104(var1, var2);
         this.method5201(var3);
         this.method5156(var3);
         this.add(var1, var2);
         return var3;
      }
   }
   ...
   public final User method5221(int var1) {
   ...
   final void method5152(User var1, Username var2, Username var3) {
      this.method5189(var1);
      var1.method5104(var2, var3);
      this.method5156(var1);
   }
   ...
   final int method5176(User var1) {
   ...
   final void method5189(User var1) {
   ...
   final void method5201(User var1) {
   ...
   final void method5156(User var1) {
   ...
   final void method5157(int var1) {
      --this.size;
      if(var1 < this.size) {
   ...
   public final void method5161(Comparator var1) {
      if(this.comparator == null) {
         this.comparator = var1;
      } else if(this.comparator instanceof AbstractUserComparator) {
         ((AbstractUserComparator)this.comparator).method5111(var1);
      }
   ...
   public Nameable findByName(RSUsername var1) {
      return this.method5227((Username)var1);
   }

   public int getCount() {
      return this.method5140();
   }
   ...
   public static void method5180(AbstractArchive var0) {
   ...
   static int method5226(int var0, Script var1, boolean var2) {
      int var4 = -1;
      Widget var3;
      if(var0 >= 2000) {
         var0 -= 1000;
         var4 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
         var3 = MusicPatchNode.method3920(var4);
      } else {
      ...
      if(var0 == 1100) {
         ...
         if(var0 == 1110) {
            ...
            var8 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
            class332 var6 = (class332)GrandExchangeEvent.method159(MusicPatchNode.method3921(), var8);
            if(var6 != null) {
               var3.fillMode = var6;
               ItemContainer.method1273(var3);
            }
