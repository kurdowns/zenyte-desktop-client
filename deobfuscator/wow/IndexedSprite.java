...
public final class IndexedSprite extends Rasterizer2D implements RSIndexedSprite {
   ...
   @ObfuscatedName("m")
   public void method6198(int var1, int var2, int var3) {
   ...
   public void method6213(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method6200(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("w")
   public void method6214(int var1, int var2, int var3, int var4) {
      ...
      method6202(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
   }
   ...
   @ObfuscatedName("d")
   static void method6200(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("v")
   static void method6202(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
