...
public class class277 {
   ...
   public static void method5039() {
      NPCDefinition.NpcDefinition_cached.method3427();
      NPCDefinition.NpcDefinition_cachedModels.method3427();
   }

   @ObfuscatedName("hz")
   @ObfuscatedSignature(
      signature = "(IIII)I",
      garbageValue = "5787884"
   )
   static final int method5038(int var0, int var1, int var2) {
      int var3 = var0 >> 7;
      int var4 = var1 >> 7;
