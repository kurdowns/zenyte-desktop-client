...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener, RSMouseHandler {
   ...
   public final synchronized void copy$mousePressed(MouseEvent var1) {
      if(MouseHandler_instance != null) {
         ...
         MouseHandler_lastPressedTimeMillisVolatile = class217.method4036();
   ...
   public static SpotAnimationDefinition method1205(int var0) {
      SpotAnimationDefinition var1 = (SpotAnimationDefinition)SpotAnimationDefinition.SpotAnimationDefinition_cached.method3432((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = SpotAnimationDefinition.SpotAnimationDefinition_archive.method4249(13, var0, (byte)-47);
         ...
         SpotAnimationDefinition.SpotAnimationDefinition_cached.method3438(var1, (long)var0);
         return var1;
      }
   }
      ...
      for(int var3 = 0; var3 < var1; ++var3) {
         ...
         if((var4 < 97 || var4 > 122) && (var4 < 65 || var4 > 90) && (var4 < 48 || var4 > 57) && var4 != 46 && var4 != 45 && var4 != 42 && var4 != 95) {
            if(var4 == 32) {
               ...
               byte var5 = TaskHandler.method3574(var4);
               var2.append('%');
               int var6 = var5 >> 4 & 15;
               if(var6 >= 10) {
   ...
   static int method1200(PacketBuffer var0) {
      int var1 = var0.method5523(2);
      int var2;
      if(var1 == 0) {
         var2 = 0;
      } else if(var1 == 1) {
         var2 = var0.method5523(5);
      } else if(var1 == 2) {
         var2 = var0.method5523(8);
      } else {
         var2 = var0.method5523(11);
      }
      ...
      for(var9 = 0; var9 < Client.overheadTextCount; ++var9) {
         ...
         if(Client.chatEffects == 0) {
            ...
            if(Client.overheadTextEffects[var9] == 0) {
               TaskHandler.fontBold12.method5420(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0);
            }

            if(Client.overheadTextEffects[var9] == 1) {
               TaskHandler.fontBold12.method5422(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount);
            }

            if(Client.overheadTextEffects[var9] == 2) {
               TaskHandler.fontBold12.method5423(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount);
            }

            if(Client.overheadTextEffects[var9] == 3) {
               TaskHandler.fontBold12.method5424(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount, 150 - Client.overheadTextCyclesRemaining[var9]);
            }

            if(Client.overheadTextEffects[var9] == 4) {
               var17 = (150 - Client.overheadTextCyclesRemaining[var9]) * (TaskHandler.fontBold12.method5412(var20) + 100) / 150;
               Rasterizer2D.method6106(var0 + Client.viewportTempX - 50, var1, var0 + Client.viewportTempX + 50, var3 + var1);
               TaskHandler.fontBold12.method5417(var20, var0 + Client.viewportTempX + 50 - var17, Client.viewportTempY + var1, var16, 0);
            ...
            if(Client.overheadTextEffects[var9] == 5) {
               ...
               Rasterizer2D.method6106(var0, Client.viewportTempY + var1 - TaskHandler.fontBold12.ascent - 1, var0 + var2, Client.viewportTempY + var1 + 5);
               TaskHandler.fontBold12.method5420(var20, var0 + Client.viewportTempX, var18 + Client.viewportTempY + var1, var16, 0);
               Rasterizer2D.method6085(var0, var1, var0 + var2, var3 + var1);
            }
         } else {
            TaskHandler.fontBold12.method5420(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, 16776960, 0);
         }
      }
   ...
   static void method1161(Widget[] var0, Widget var1, boolean var2) {
      ...
      InterfaceParent var5 = (InterfaceParent)Client.interfaceParents.method6046((long)var1.id);
      if(var5 != null) {
         int var6 = var5.group;
         if(LoginScreenAnimation.method1914(var6)) {
