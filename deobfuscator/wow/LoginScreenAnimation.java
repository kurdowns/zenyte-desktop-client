...
@ObfuscatedName("cr")
public class LoginScreenAnimation implements RSLoginScreenAnimation {
   ...
   void method1935() {
      ...
      for(var1 = 0; var1 < 64; ++var1) {
         this.field1065[var1 + 64] = var1 * 4 + '\uff00';
      }

      for(var1 = 0; var1 < 64; ++var1) {
         this.field1065[var1 + 128] = var1 * 262144 + '\uffff';
      }
   ...
   @ObfuscatedName("k")
   void method1932(int var1, int var2, byte var3) {
      if(WorldMapSection1.client.shouldRenderLoginScreenFire()) {
         this.copy$draw(var1, var2, var3);
      }
   ...
   final void method1912(int var1) {
      ...
      if(this.field1063 * 16 > 0) {
         this.field1063 = this.field1063 * 16 - var1 * 4;
      }

      if(this.field1066 * 16 > 0) {
         this.field1066 = this.field1066 * 16 - var1 * 4;
      }

      if(this.field1063 * 16 == 0 && this.field1066 * 16 == 0) {
      ...
      this.field1072 = this.field1072 * 10000 + var1 * 10000;
   ...
   final void method1919(int var1) {
      ...
      if(this.field1063 * 16 > 0) {
         this.method1915(this.field1063 * 16, this.field1065);
      } else if(this.field1066 * 16 > 0) {
         this.method1915(this.field1066 * 16, this.field1064);
      } else {
      ...
      for(int var3 = 1; var3 < 255; ++var3) {
         ...
         for(int var9 = var6; var9 < var7; ++var9) {
            ...
            if(var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
               ...
               class206.rasterProvider.pixels[var8++] = -16777216 | ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) + (var13 * (var14 & '\uff00') + var12 * (var10 & '\uff00') & 16711680) >> 8;
            } else {
               ++var8;
            }
         }
   ...
   public void copy$draw(int var1, int var2, byte var3) {
   ...
   @ObfuscatedSignature(
      signature = "(II)Z",
      garbageValue = "824484622"
   )
   public static boolean method1914(int var0) {
      if(Widget.Widget_loadedInterfaces[var0]) {
         return true;
      } else if(!Widget.Widget_archive.method4275(var0)) {
         return false;
      } else {
         int var1 = Widget.Widget_archive.method4271(var0);
         if(var1 == 0) {
            ...
            for(int var2 = 0; var2 < var1; ++var2) {
               if(Widget.Widget_interfaceComponents[var0][var2] == null) {
                  byte[] var3 = Widget.Widget_archive.method4249(var0, var2, (byte)-57);
                  if(var3 != null) {
                     Widget.Widget_interfaceComponents[var0][var2] = new Widget();
                     Widget.Widget_interfaceComponents[var0][var2].id = var2 + (var0 << 16);
                     if(var3[0] == -1) {
                        Widget.Widget_interfaceComponents[var0][var2].method4178(new Buffer(var3));
                     } else {
                        Widget.Widget_interfaceComponents[var0][var2].method4134(new Buffer(var3));
                     }
                  }
               }
            }
   ...
   static void method1938(int var0) {
      for(IntegerNode var1 = (IntegerNode)Client.widgetClickMasks.method6031(); var1 != null; var1 = (IntegerNode)Client.widgetClickMasks.method6039()) {
