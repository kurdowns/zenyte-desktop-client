...
public class ObjectDefinition extends DualNode implements RSObjectDefinition {
   ...
   static ModelData[] field3376 = new ModelData[4];
   @ObfuscatedName("t")
   @ObfuscatedGetter(
      intValue = -1540034327
   )
   ...
   void method4661(Buffer var1, int var2) {
      int var3;
      int var4;
      if(var2 == 1) {
         ...
         if(var3 > 0) {
            if(this.modelIds != null && !ObjectDefinition_isLowDetail) {
               ...
               for(var4 = 0; var4 < var3; ++var4) {
                  this.modelIds[var4] = var1.method5577();
                  this.models[var4] = var1.method5575();
               }
            }
         }
      } else if(var2 == 2) {
         ...
         this.sizeX = var1.method5575();
      } else if(var2 == 15) {
         this.sizeY = var1.method5575();
      } else if(var2 == 17) {
         this.interactType = 0;
         this.boolean1 = false;
      } else if(var2 == 18) {
         ...
         this.animationId = var1.method5577();
         if(this.animationId == '\uffff') {
            this.animationId = -1;
         }
      } else if(var2 == 27) {
         ...
         this.modelSizeX = var1.method5577();
      } else if(var2 == 66) {
         this.modelHeight = var1.method5577();
      } else if(var2 == 67) {
         this.modelSizeY = var1.method5577();
      } else if(var2 == 68) {
         this.mapSceneId = var1.method5577();
      } else if(var2 == 69) {
         var1.method5575();
      } else if(var2 == 70) {
         this.offsetX = var1.method5578();
      } else if(var2 == 71) {
         this.offsetHeight = var1.method5578();
      } else if(var2 == 72) {
         this.offsetY = var1.method5578();
      } else if(var2 == 73) {
         this.boolean2 = true;
      } else if(var2 == 74) {
         this.isSolid = true;
      } else if(var2 == 75) {
         this.int3 = var1.method5575();
      } else if(var2 != 77 && var2 != 92) {
         if(var2 == 78) {
            this.ambientSoundId = var1.method5577();
            this.int4 = var1.method5575();
         } else if(var2 == 79) {
            this.int5 = var1.method5577();
            this.int6 = var1.method5577();
            this.int4 = var1.method5575();
            var3 = var1.method5575();
            this.soundEffectIds = new int[var3];

            for(var4 = 0; var4 < var3; ++var4) {
               this.soundEffectIds[var4] = var1.method5577();
            }
         } else if(var2 == 81) {
            this.clipType = var1.method5575() * 256;
         } else if(var2 == 82) {
            this.mapIconId = var1.method5577();
         } else if(var2 == 249) {
      ...
      if(this.models != null) {
         for(int var4 = 0; var4 < this.models.length; ++var4) {
            if(this.models[var4] == var1) {
               return ObjectDefinition_modelsArchive.method4263(this.modelIds[var4] & '\uffff', 0);
            }
         }
         ...
         for(int var3 = 0; var3 < this.modelIds.length; ++var3) {
            var2 &= ObjectDefinition_modelsArchive.method4263(this.modelIds[var3] & '\uffff', 0);
         }
   ...
   public final boolean method4663() {
      if(this.modelIds == null) {
         ...
         for(int var2 = 0; var2 < this.modelIds.length; ++var2) {
            var1 &= ObjectDefinition_modelsArchive.method4263(this.modelIds[var2] & '\uffff', 0);
         }
   ...
   public final Entity method4679(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      long var7;
      if(this.models == null) {
      ...
      Object var9 = (Entity)ObjectDefinition_cachedEntities.method3432(var7);
      if(var9 == null) {
         ModelData var10 = this.method4677(var1, var2);
         if(var10 == null) {
            return null;
         }

         if(!this.nonFlatShading) {
            var9 = var10.method2900(this.ambient + 64, this.contrast * 25 + 768, -50, -10, -50);
         } else {
         ...
         ObjectDefinition_cachedEntities.method3438((DualNode)var9, var7);
      }
      ...
      if(this.clipType * 65536 >= 0) {
         if(var9 instanceof Model) {
            var9 = ((Model)var9).method2999(var3, var4, var5, var6, true, this.clipType * 65536);
         } else if(var9 instanceof ModelData) {
            var9 = ((ModelData)var9).method2886(var3, var4, var5, var6, true, this.clipType * 65536);
         }
      }
   ...
   public final Model method4664(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      long var7;
      if(this.models == null) {
         var7 = (long)(var2 + (this.id << 10));
      } else {
      ...
      Model var9 = (Model)ObjectDefinition_cachedModels.method3432(var7);
      if(var9 == null) {
         ModelData var10 = this.method4677(var1, var2);
         if(var10 == null) {
            return null;
         ...
         var9 = var10.method2900(this.ambient + 64, this.contrast * 25 + 768, -50, -10, -50);
         ObjectDefinition_cachedModels.method3438(var9, var7);
      }

      if(this.clipType * 65536 >= 0) {
         var9 = var9.method2999(var3, var4, var5, var6, true, this.clipType * 65536);
      }
   ...
   public final Model method4666(int var1, int var2, int[][] var3, int var4, int var5, int var6, SequenceDefinition var7, int var8) {
      long var9;
      if(this.models == null) {
      ...
      Model var11 = (Model)ObjectDefinition_cachedModels.method3432(var9);
      if(var11 == null) {
         ModelData var12 = this.method4677(var1, var2);
         if(var12 == null) {
            return null;
         }

         var11 = var12.method2900(this.ambient + 64, this.contrast * 25 + 768, -50, -10, -50);
         ObjectDefinition_cachedModels.method3438(var11, var9);
      }
      ...
      if(var7 == null && this.clipType * 65536 == -1) {
         ...
         if(var7 != null) {
            var11 = var7.method4846(var11, var8, var2, -1535419363);
         } else {
            var11 = var11.method2985(true);
         }

         if(this.clipType * 65536 >= 0) {
            var11 = var11.method2999(var3, var4, var5, var6, false, this.clipType * 65536);
         }
   ...
   final ModelData method4677(int var1, int var2) {
      ModelData var3 = null;
      boolean var4;
      int var5;
      int var7;
      if(this.models == null) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            var3 = (ModelData)ObjectDefinition_cachedModelData.method3432((long)var7);
            if(var3 == null) {
               var3 = ModelData.method2879(ObjectDefinition_modelsArchive, var7 & '\uffff', 0);
               if(var3 == null) {
                  return null;
               }
               ...
               ObjectDefinition_cachedModelData.method3438(var3, (long)var7);
            }
         ...
         var3 = (ModelData)ObjectDefinition_cachedModelData.method3432((long)var5);
         if(var3 == null) {
            var3 = ModelData.method2879(ObjectDefinition_modelsArchive, var5 & '\uffff', 0);
            if(var3 == null) {
               return null;
            }
            ...
            ObjectDefinition_cachedModelData.method3438(var3, (long)var5);
         }
      }
      ...
      if(this.recolorFrom != null) {
         for(var7 = 0; var7 < this.recolorFrom.length; ++var7) {
            var8.method2893(this.recolorFrom[var7], this.recolorTo[var7]);
         }
      }

      if(this.retextureFrom != null) {
         for(var7 = 0; var7 < this.retextureFrom.length; ++var7) {
            var8.method2945(this.retextureFrom[var7], this.retextureTo[var7]);
         }
      }

      if(var4) {
         var8.method2896(this.modelSizeX, this.modelHeight, this.modelSizeY);
      }

      if(var11) {
         var8.method2892(this.offsetX, this.offsetHeight, this.offsetY);
      }
   ...
   public final ObjectDefinition method4670() {
      int var1 = -1;
   ...
   public int method4692(int var1, int var2) {
   ...
   static void method4712(boolean var0) {
   ...
   static int method4711(int var0, Script var1, boolean var2) {
      int var3;
      int var4;
      if(var0 == 4000) {
