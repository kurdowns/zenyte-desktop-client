...
public class Rasterizer2D extends DualNode implements RSRasterizer2D {
   ...
   @ObfuscatedName("db")
   public static void method6083(int[] var0, int var1, int var2) {
      Rasterizer2D_pixels = var0;
      Rasterizer2D_width = var1;
      Rasterizer2D_height = var2;
      method6085(0, 0, var1, var2);
   }
   ...
   @ObfuscatedName("de")
   public static void method6085(int var0, int var1, int var2, int var3) {
      if(var0 < 0) {
         var0 = 0;
      }
   ...
   @ObfuscatedName("dh")
   public static void method6106(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("dk")
   public static void method6087(int[] var0) {
   ...
   @ObfuscatedName("da")
   public static void method6088(int[] var0) {
   ...
   @ObfuscatedName("dr")
   static void method6102(int var0, int var1, int var2, int var3) {
      if(var2 == 0) {
         method6100(var0, var1, var3);
      } else {
         if(var2 < 0) {
            var2 = -var2;
         }
   ...
   @ObfuscatedName("dx")
   public static void method6150(int var0, int var1, int var2, int var3, int var4) {
      if(var4 != 0) {
         if(var4 == 256) {
            method6102(var0, var1, var2, var3);
         } else {
            if(var2 < 0) {
               var2 = -var2;
            }
   ...
   @ObfuscatedName("dy")
   public static void method6091(int var0, int var1, int var2, int var3, int var4, int var5) {
   ...
   @ObfuscatedName("dc")
   public static void method6092(int var0, int var1, int var2, int var3, int var4) {
      if(var0 < Rasterizer2D_xClipStart) {
         var2 -= Rasterizer2D_xClipStart - var0;
         var0 = Rasterizer2D_xClipStart;
      }
   ...
   @ObfuscatedName("ds")
   public static void method6093(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var2 > 0 && var3 > 0) {
         int var6 = 0;
         int var7 = 65536 / var3;
         if(var0 < Rasterizer2D_xClipStart) {
   ...
   @ObfuscatedName("dt")
   public static void method6117(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      if(!WorldMapSection1.client.isGpu()) {
         ...
         if(var2 > 0 && var3 > 0) {
            ...
            for(int var18 = -var3; var18 < 0; ++var18) {
               ...
               int var20 = var14 >> 8;
               int var21 = (var19 * var6 + var20 * var7 & '\uff00') >>> 8;
               if(var21 == 0) {
                  var17 += var8;
                  var14 += var15;
               } else {
                  int var22 = (var19 * (var4 & '\uff00') + var20 * (var5 & '\uff00') & 16711680) + (var19 * (var4 & 16711935) + var20 * (var5 & 16711935) & -16711936) >>> 8;
                  int var23 = 255 - var21;
                  int var24 = ((var22 & 16711935) * var21 >> 8 & 16711935) + (var21 * (var22 & '\uff00') >> 8 & '\uff00');

                  for(int var25 = -var2; var25 < 0; ++var25) {
                     int var26 = var13[var17];
                     var26 = ((var26 & 16711935) * var23 >> 8 & 16711935) + (var23 * (var26 & '\uff00') >> 8 & '\uff00');
   ...
   @ObfuscatedName("dp")
   public static void method6094(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7, boolean var8) {
            ...
            if(var16 == 255 && var17 == 255) {
               ...
               for(var19 = var13 + var1; var19 < var3 + var13 + var1; ++var19) {
                  for(var20 = var0 + var12; var20 < var0 + var12 + var2; ++var20) {
                     ...
                     int var27 = (var24 * (var23 & '\uff00') + var25 * (var26 & '\uff00') & 16711680) + ((var23 & 16711935) * var24 + (var26 & 16711935) * var25 & -16711936) >> 8;
   ...
   @ObfuscatedName("df")
   public static void method6177(int var0, int var1, int var2, int var3, int var4) {
      method6097(var0, var1, var2, var4);
      method6097(var0, var3 + var1 - 1, var2, var4);
      method6099(var0, var1, var3, var4);
      method6099(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("di")
   public static void method6096(int var0, int var1, int var2, int var3, int var4, int var5) {
      method6163(var0, var1, var2, var4, var5);
      method6163(var0, var3 + var1 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method6144(var0, var1 + 1, var3 - 2, var4, var5);
         method6144(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }
   ...
   @ObfuscatedName("ea")
   static void method6163(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= Rasterizer2D_yClipStart && var1 < Rasterizer2D_yClipEnd) {
         if(var0 < Rasterizer2D_xClipStart) {
            var2 -= Rasterizer2D_xClipStart - var0;
            var0 = Rasterizer2D_xClipStart;
   ...
   @ObfuscatedName("ex")
   public static void method6099(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("eo")
   static void method6144(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= Rasterizer2D_xClipStart && var0 < Rasterizer2D_xClipEnd) {
         if(var1 < Rasterizer2D_yClipStart) {
            var2 -= Rasterizer2D_yClipStart - var1;
            var1 = Rasterizer2D_yClipStart;
   ...
   public static void method6101(int var0, int var1, int var2, int var3, int var4) {
      ...
      if(var3 == 0) {
         ...
         if(var3 >= 0) {
            method6099(var0, var1, var3 + 1, var4);
         } else {
            method6099(var0, var3 + var1, -var3 + 1, var4);
         }
   ...
   @ObfuscatedName("eh")
   static void method6100(int var0, int var1, int var2) {
   ...
   @ObfuscatedName("eq")
   public static void method6141(int var0, int var1, int var2, int[] var3, int[] var4) {
