...
public final class Tile extends Node implements RSTile {
   ...
   public static RSNodeDeque[][][] lastGroundItems = new RSNodeDeque[4][104][104];
   ...
   static final void method2961() {
      ...
      if(Client.oculusOrbState == 0) {
         ...
         var4 = class277.method5038(SoundSystem.oculusOrbFocalPointX, ServerPacket.oculusOrbFocalPointY, ScriptEvent.Client_plane);
         var5 = 0;
         int var6;
         ...
         Client.field756 = class277.method5038(ByteArrayPool.localPlayer.x, ByteArrayPool.localPlayer.y, ScriptEvent.Client_plane) - Client.camFollowHeight;
         ...
         if(Client.field770 && ByteArrayPool.localPlayer != null) {
            ...
            if(var0 >= 0 && var1 >= 0 && var0 < 104 && var1 < 104) {
               ...
               var2 = class277.method5038(ByteArrayPool.localPlayer.x, ByteArrayPool.localPlayer.y, ScriptEvent.Client_plane) - Client.camFollowHeight;
         ...
         if(KeyHandler.KeyHandler_pressedKeys[13]) {
            Client.packetWriter.method2375(FaceNormal.method3377(ClientPacket.field2306, Client.packetWriter.isaacCipher));
