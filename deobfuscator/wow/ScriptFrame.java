...
public class ScriptFrame implements RSScriptFrame {
   ...
   static final void method1243(int var0, int var1, int var2, int var3, int var4) {
      long var5 = GrandExchangeOfferWorldComparator.scene.method3203(var0, var1, var2);
      int var7;
      int var8;
      int var9;
      int var10;
      ...
      int var13;
      if(var5 != 0L) {
         var7 = GrandExchangeOfferWorldComparator.scene.method3207(var0, var1, var2, var5);
         var8 = var7 >> 6 & 3;
         var9 = var7 & 31;
         var10 = var3;
         ...
         if(var14.mapSceneId != -1) {
            ...
            if(var15 != null) {
               ...
               var15.method6213(var1 * 4 + var16 + 48, (104 - var2 - var14.sizeY) * 4 + var17 + 48);
            }
         } else {
            if(var9 == 0 || var9 == 2) {
               if(var8 == 0) {
      ...
      var5 = GrandExchangeOfferWorldComparator.scene.method3205(var0, var1, var2);
      if(var5 != 0L) {
         var7 = GrandExchangeOfferWorldComparator.scene.method3207(var0, var1, var2, var5);
         var8 = var7 >> 6 & 3;
         var9 = var7 & 31;
         ...
         if(var24.mapSceneId != -1) {
            ...
            if(var18 != null) {
               ...
               var18.method6213(var13 + var1 * 4 + 48, var19 + (104 - var2 - var24.sizeY) * 4 + 48);
            }
         } else if(var9 == 9) {
            var12 = 15658734;
            if(Decimator.method2635(var5)) {
      ...
      var5 = GrandExchangeOfferWorldComparator.scene.method3323(var0, var1, var2);
      if(0L != var5) {
         ...
         if(var20.mapSceneId != -1) {
            ...
            if(var21 != null) {
               ...
               var21.method6213(var10 + var1 * 4 + 48, (104 - var2 - var20.sizeY) * 4 + var22 + 48);
            }
         }
      }
   ...
   static final void method1241() {
      for(PendingSpawn var0 = (PendingSpawn)Client.pendingSpawns.method4956(); var0 != null; var0 = (PendingSpawn)Client.pendingSpawns.method4974()) {
         if(var0.hitpoints == -1) {
            var0.delay = 0;
