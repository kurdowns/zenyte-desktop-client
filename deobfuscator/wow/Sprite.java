...
public final class Sprite extends Rasterizer2D implements RSSprite {
   ...
   public void method6219() {
      Rasterizer2D.method6083(this.pixels, this.subWidth, this.subHeight);
   }
   ...
   @ObfuscatedName("w")
   public void method6221(int var1) {
      if(this.subWidth != this.width || this.subHeight != this.height) {
         int var2 = var1;
   ...
   @ObfuscatedName("e")
   public void method6225(int var1, int var2) {
      var1 += this.xOffset;
      var2 += this.yOffset;
      ...
      if(var6 > 0 && var5 > 0) {
         method6236(Rasterizer2D.Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("p")
   public void method6227(int var1, int var2) {
      var1 += this.xOffset;
      var2 += this.yOffset;
      int var3 = var1 + var2 * Rasterizer2D.Rasterizer2D_width;
      int var4 = 0;
      ...
      if(var6 > 0 && var5 > 0) {
         method6278(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("u")
   public void method6229(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         ...
         method6285(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }

   @ObfuscatedName("g")
   public void method6289(int var1, int var2, int var3, int var4) {
      if(var3 == 256) {
         this.method6227(var1, var2);
      } else {
         var1 += this.xOffset;
         var2 += this.yOffset;
         ...
         if(var8 > 0 && var7 > 0) {
            method6232(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
         }
      }
   }

   @ObfuscatedName("a")
   public void method6233(int var1, int var2, int var3) {
      var1 += this.xOffset;
      var2 += this.yOffset;
      ...
      if(var7 > 0 && var6 > 0) {
         method6234(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("c")
   public void method6235(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.subWidth;
         int var7 = this.subHeight;
         int var8 = 0;
         ...
         method6307(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }

   @ObfuscatedName("ae")
   public void method6237(int var1, int var2, int var3) {
      var1 += this.xOffset;
      var2 += this.yOffset;
      int var4 = var1 + var2 * Rasterizer2D.Rasterizer2D_width;
      int var5 = 0;
      ...
      if(var7 > 0 && var6 > 0) {
         if(var3 == 256) {
            method6238(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
         } else {
            method6239(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
         }
   ...
   @ObfuscatedName("ap")
   public void method6271(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.subWidth;
         int var7 = this.subHeight;
         int var8 = 0;
         ...
         if(var5 == 256) {
            method6241(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
         } else {
            method6242(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
         }
   ...
   @ObfuscatedName("af")
   public void method6243(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
      ...
      for(int var15 = var9; var15 < var10; ++var15) {
         ...
         for(int var20 = var19; var20 < var12; ++var20) {
            ...
            if(var21 != 0) {
               Rasterizer2D.Rasterizer2D_pixels[var18++] = var21 | -16777216;
            } else {
               ++var18;
            }
         }
   ...
   @ObfuscatedName("at")
   public void method6244(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      if(!Client.hdMinimapEnabled) {
         this.copy$drawRotatedMaskedCenteredAround(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10);
      } else {
         try {
            int[] var11 = WorldMapSection1.client.getGraphicsPixels();
            int[] var12 = this.getPixels();
            int var13 = this.getWidth();
            int var14 = -var3 / 2;
            int var15 = -var4 / 2;
            int var16 = (int)(Math.sin((double)var7 / 326.11D) * 65536.0D);
            int var17 = (int)(Math.cos((double)var7 / 326.11D) * 65536.0D);
            var16 = var16 * var8 >> 8;
            var17 = var17 * var8 >> 8;
            int var18 = var15 * var16 + var14 * var17 + (var5 << 16);
            int var19 = var15 * var17 - var14 * var16 + (var6 << 16);
            int var20 = var1 + var2 * WorldMapSection1.client.getGraphicsPixelsWidth();

            for(var2 = 0; var2 < var4; ++var2) {
               int var21 = var9[var2];
               int var22 = var20 + var21;
               int var23 = var18 + var17 * var21;
               int var24 = var19 - var16 * var21;
               ...
               for(var1 = -var10[var2]; var1 < 0; ++var1) {
                  ...
                  int var27 = var25 + 1;
                  int var28 = var26 + 1;
                  int var29 = var12[var25 + var26 * var13];
                  int var30 = var12[var27 + var26 * var13];
                  int var31 = var12[var25 + var28 * var13];
                  int var32 = var12[var27 + var28 * var13];
                  int var33 = (var23 >> 8) - (var25 << 8);
                  int var34 = (var24 >> 8) - (var26 << 8);
                  int var35 = (var27 << 8) - (var23 >> 8);
                  int var36 = (var28 << 8) - (var24 >> 8);
                  int var37 = var35 * var36;
                  int var38 = var33 * var36;
                  int var39 = var35 * var34;
                  int var40 = var33 * var34;
                  int var41 = var37 * (var29 >> 16 & 255) + var38 * (var30 >> 16 & 255) + var39 * (var31 >> 16 & 255) + var40 * (var32 >> 16 & 255) & 16711680;
                  int var42 = var37 * (var29 >> 8 & 255) + var38 * (var30 >> 8 & 255) + var39 * (var31 >> 8 & 255) + var40 * (var32 >> 8 & 255) >> 8 & '\uff00';
                  int var43 = (var29 & 255) * var37 + (var30 & 255) * var38 + (var31 & 255) * var39 + (var32 & 255) * var40 >> 16;
                  var11[var22++] = -16777216 | var41 | var42 | var43;
                  var23 += var17;
                  var24 -= var16;
               }
               ...
               var18 += var16;
               var19 += var17;
               var20 += WorldMapSection1.client.getGraphicsPixelsWidth();
            }
   ...
   @ObfuscatedName("as")
   public void method6245(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
         ...
         for(var2 = 0; var2 < var4; ++var2) {
            ...
            for(var1 = -var3; var1 < 0; ++var1) {
               ...
               if(var20 != 0) {
                  Rasterizer2D.Rasterizer2D_pixels[var17++] = var20 | -16777216;
               } else {
                  ++var17;
               }
   ...
   public void method6287(int var1, int var2, int var3, int var4) {
      this.method6269(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("au")
   void method6269(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.xOffset << 4;
         var2 -= this.yOffset << 4;
                     ...
                     for(var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
                        ...
                        if(var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0 && var31 - (this.subHeight << 12) < 0) {
                           for(; var37 < 0; ++var37) {
                              ...
                              if(var38 != 0) {
                                 Rasterizer2D.Rasterizer2D_pixels[var34++] = var38 | -16777216;
                              } else {
                                 ++var34;
                              }
                           }
   ...
   @ObfuscatedName("ao")
   public void method6327(int var1, int var2, int var3, int var4) {
                  ...
                  for(int var12 = var5; var12 < var6; ++var12) {
                     ...
                     if(var19 != 0) {
                        ...
                        if(var27 >= var19) {
                           ...
                           Rasterizer2D.Rasterizer2D_pixels[var9] = var28 | -16777216;
                        }
   ...
   public void copy$drawRotatedMaskedCenteredAround(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
         ...
         for(var2 = 0; var2 < var4; ++var2) {
            ...
            for(var1 = -var10[var2]; var1 < 0; ++var1) {
               Rasterizer2D.Rasterizer2D_pixels[var19++] = this.pixels[this.subWidth * (var21 >> 16) + (var20 >> 16)] | -16777216;
               var20 += var14;
               var21 -= var13;
            }
   ...
   @ObfuscatedName("s")
   static void method6236(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedName("n")
   static void method6278(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("h")
   static void method6285(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   @ObfuscatedName("i")
   static void method6232(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("o")
   static void method6234(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
      ...
      for(int var11 = -var6; var11 < 0; ++var11) {
         for(int var12 = -var5; var12 < 0; ++var12) {
            ...
            if(var2 != 0) {
               int var13 = var0[var4];
               Client.drawAlpha(var0, var4++, ((var13 & 16711935) * var10 + var9 * (var2 & 16711935) & -16711936) + ((var2 & '\uff00') * var9 + var10 * (var13 & '\uff00') & 16711680) >> 8, var9);
            } else {
               ++var4;
            }
         }
   ...
   @ObfuscatedName("f")
   static void method6307(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
      ...
      for(int var15 = -var8; var15 < 0; ++var15) {
         ...
         for(int var17 = -var7; var17 < 0; ++var17) {
            ...
            if(var2 != 0) {
               int var18 = var0[var5];
               Client.drawAlpha(var0, var5++, ((var2 & '\uff00') * var12 + var13 * (var18 & '\uff00') & 16711680) + ((var18 & 16711935) * var13 + var12 * (var2 & 16711935) & -16711936) >> 8, var12);
            } else {
               ++var5;
            }
   ...
   @ObfuscatedName("an")
   static void method6238(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      for(var8 = -var10; var8 < 0; ++var8) {
         for(var6 = -var9; var6 < 0; ++var6) {
            ...
            if(var0 != 0) {
               ...
               var3[var7++] = var2 - var1 | var1 - (var1 >>> 8) | -16777216;
            } else {
               ++var7;
            }
         }
   ...
   @ObfuscatedName("ai")
   static void method6239(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
      for(var8 = -var10; var8 < 0; ++var8) {
         for(var6 = -var9; var6 < 0; ++var6) {
            var0 = var4[var5++];
            if(var0 != 0) {
   ...
   @ObfuscatedName("ab")
   static void method6241(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
      for(int var16 = var3; var8 < 0; ++var8) {
         ...
         for(var6 = -var12; var6 < 0; ++var6) {
            ...
            if(var0 != 0) {
               ...
               var0 = (var0 & 16711935) + (var1 & 16711935);
               var1 = (var0 & 16777472) + (var2 - var0 & 65536);
               var5[var10++] = var2 - var1 | var1 - (var1 >>> 8) | -16777216;
            } else {
               ++var10;
            }
   ...
   @ObfuscatedName("ar")
   static void method6242(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
