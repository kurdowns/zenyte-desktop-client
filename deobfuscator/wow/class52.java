...
public final class class52 {
   ...
   static final void method902(String var0, int var1) {
      PacketBufferNode var2 = FaceNormal.method3377(ClientPacket.field2259, Client.packetWriter.isaacCipher);
      var2.packetBuffer.method5559(class234.method4223(var0) + 1);
      var2.packetBuffer.method5655(var0);
      var2.packetBuffer.method5725(var1);
   ...
   static int method904(int var0, Script var1, boolean var2) {
      ...
      if(var0 == 3400) {
         ...
         if(var0 == 3411) {
            ...
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var10.method4614();
            return 1;
         } else {
            return 2;
         }
