...
@ObfuscatedName("mp")
public class DesktopPlatformInfoProvider implements PlatformInfoProvider, RSDesktopPlatformInfoProvider {
   ...
   public PlatformInfo vmethod6395() {
      byte var1;
   ...
   void method6384(String var1) {
      if(var1.startsWith("1.")) {
         this.method6382(var1);
      } else {
         this.method6383(var1);
      }
