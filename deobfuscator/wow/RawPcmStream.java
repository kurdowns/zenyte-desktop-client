...
public class RawPcmStream extends PcmStream implements RSRawPcmStream {
   ...
   @ObfuscatedName("t")
   public synchronized void vmethod3988(int[] var1, int var2, int var3) {
   ...
   @ObfuscatedName("e")
   public synchronized void method2689(int var1) {
      this.numLoops = var1;
   }

   @ObfuscatedName("s")
   public synchronized void vmethod3989(int var1) {
      if(this.field1491 > 0) {
   ...
   public static RawPcmStream method2654(RawSound var0, int var1, int var2) {
