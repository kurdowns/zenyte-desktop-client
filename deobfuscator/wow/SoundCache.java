...
public class SoundCache implements RSSoundCache {
   ...
   RawSound method2610(int var1, int var2, int[] var3) {
      int var4 = var2 ^ (var1 << 4 & '\uffff' | var1 >>> 12);
      var4 |= var1 << 16;
      long var5 = (long)var4;
      RawSound var7 = (RawSound)this.rawSounds.method6046(var5);
      if(var7 != null) {
         return var7;
      } else if(var3 != null && var3[0] <= 0) {
         return null;
      } else {
         SoundEffect var8 = SoundEffect.method2469(this.soundEffectIndex, var1, var2);
         if(var8 == null) {
            return null;
         } else {
            var7 = var8.method2466();
            this.rawSounds.method6033(var7, var5);
            if(var3 != null) {
   ...
   RawSound method2618(int var1, int var2, int[] var3) {
      int var4 = var2 ^ (var1 << 4 & '\uffff' | var1 >>> 12);
      var4 |= var1 << 16;
      ...
      if(var7 != null) {
         ...
         VorbisSample var8 = (VorbisSample)this.musicSamples.method6046(var5);
         if(var8 == null) {
            var8 = VorbisSample.method2503(this.musicSampleIndex, var1, var2);
            if(var8 == null) {
               return null;
            }

            this.musicSamples.method6033(var8, var5);
         }

         var7 = var8.method2481(var3);
         if(var7 == null) {
            return null;
         } else {
            var8.method3676();
   ...
   public RawSound method2612(int var1, int[] var2) {
      if(this.soundEffectIndex.method4260() == 1) {
         return this.method2610(0, var1, var2);
      } else if(this.soundEffectIndex.method4271(var1) == 1) {
         return this.method2610(var1, 0, var2);
      } else {
   ...
   public RawSound method2613(int var1, int[] var2) {
      if(this.musicSampleIndex.method4260() == 1) {
         return this.method2618(0, var1, var2);
      } else if(this.musicSampleIndex.method4271(var1) == 1) {
         return this.method2618(var1, 0, var2);
      } else {
         throw new RuntimeException();
      }
   }
   ...
   static final void method2620(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         boolean var11 = false;
         if(var1 == 0) {
            var7 = GrandExchangeOfferWorldComparator.scene.method3203(var0, var2, var3);
         }

         if(var1 == 1) {
            var7 = GrandExchangeOfferWorldComparator.scene.method3204(var0, var2, var3);
         }

         if(var1 == 2) {
            var7 = GrandExchangeOfferWorldComparator.scene.method3205(var0, var2, var3);
         }

         if(var1 == 3) {
            var7 = GrandExchangeOfferWorldComparator.scene.method3323(var0, var2, var3);
         }

         int var12;
         if(var7 != 0L) {
            var12 = GrandExchangeOfferWorldComparator.scene.method3207(var0, var2, var3, var7);
            int var39 = WorldMapRectangle.method387(var7);
            int var40 = var12 & 31;
            int var41 = var12 >> 6 & 3;
            ObjectDefinition var13;
            if(var1 == 0) {
               GrandExchangeOfferWorldComparator.scene.method3194(var0, var2, var3);
               var13 = WorldMapSection2.method435(var39);
               if(var13.interactType != 0) {
                  Client.collisionMaps[var0].method3636(var2, var3, var40, var41, var13.boolean1);
               }
            }

            if(var1 == 1) {
               GrandExchangeOfferWorldComparator.scene.method3276(var0, var2, var3);
            }

            if(var1 == 2) {
               GrandExchangeOfferWorldComparator.scene.method3196(var0, var2, var3);
               var13 = WorldMapSection2.method435(var39);
               ...
               if(var13.interactType != 0) {
                  Client.collisionMaps[var0].method3654(var2, var3, var13.sizeX, var13.sizeY, var41, var13.boolean1);
               }
            }

            if(var1 == 3) {
               GrandExchangeOfferWorldComparator.scene.method3197(var0, var2, var3);
               var13 = WorldMapSection2.method435(var39);
         ...
         if(var4 >= 0) {
            ...
            long var26 = IsaacCipher.method6377(var2, var3, 2, var15.int1 == 0, var4);
            ...
            if(var6 == 22) {
               if(var15.animationId == -1 && var15.transforms == null) {
                  var29 = var15.method4664(22, var5, var22, var24, var23, var25);
               } else {
                  var29 = new DynamicObject(var4, 22, var5, var12, var2, var3, var15.animationId, true, (Entity)null);
               }

               var42.method3176(var0, var2, var3, var23, (Entity)var29, var26, var28);
               if(var15.interactType == 1) {
                  var14.method3634(var2, var3);
               }
            } else if(var6 != 10 && var6 != 11) {
               if(var6 >= 12) {
                  if(var15.animationId == -1 && var15.transforms == null) {
                     var29 = var15.method4664(var6, var5, var22, var24, var23, var25);
                  } else {
                  ...
                  if(var15.interactType != 0) {
                     var14.method3632(var2, var3, var16, var17, var15.boolean1);
                  }
               } else if(var6 == 0) {
                  if(var15.animationId == -1 && var15.transforms == null) {
                     var29 = var15.method4664(0, var5, var22, var24, var23, var25);
                  } else {
                     var29 = new DynamicObject(var4, 0, var5, var12, var2, var3, var15.animationId, true, (Entity)null);
                  }

                  var42.method3283(var0, var2, var3, var23, (Entity)var29, (Entity)null, Tiles.field544[var5], 0, var26, var28);
                  if(var15.interactType != 0) {
                     var14.method3631(var2, var3, var6, var5, var15.boolean1);
                  }
               } else if(var6 == 1) {
                  if(var15.animationId == -1 && var15.transforms == null) {
                     var29 = var15.method4664(1, var5, var22, var24, var23, var25);
                  } else {
                     var29 = new DynamicObject(var4, 1, var5, var12, var2, var3, var15.animationId, true, (Entity)null);
                  }

                  var42.method3283(var0, var2, var3, var23, (Entity)var29, (Entity)null, Tiles.field542[var5], 0, var26, var28);
                  if(var15.interactType != 0) {
                     var14.method3631(var2, var3, var6, var5, var15.boolean1);
                  }
               } else {
                  ...
                  if(var6 == 2) {
                     ...
                     Object var31;
                     if(var15.animationId == -1 && var15.transforms == null) {
                        var30 = var15.method4664(2, var5 + 4, var22, var24, var23, var25);
                        var31 = var15.method4664(2, var35, var22, var24, var23, var25);
                     } else {
                     ...
                     var42.method3283(var0, var2, var3, var23, (Entity)var30, (Entity)var31, Tiles.field544[var5], Tiles.field544[var35], var26, var28);
                     if(var15.interactType != 0) {
                        var14.method3631(var2, var3, var6, var5, var15.boolean1);
                     }
                  } else if(var6 == 3) {
                     if(var15.animationId == -1 && var15.transforms == null) {
                        var29 = var15.method4664(3, var5, var22, var24, var23, var25);
                     } else {
                     ...
                     if(var15.animationId == -1 && var15.transforms == null) {
                        var29 = var15.method4664(4, var5, var22, var24, var23, var25);
                     } else {
                        var29 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, true, (Entity)null);
                     }

                     var42.method3299(var0, var2, var3, var23, (Entity)var29, (Entity)null, Tiles.field544[var5], 0, 0, 0, var26, var28);
                  } else {
                     Object var32;
                     long var36;
                     if(var6 == 5) {
                        var35 = 16;
                        var36 = var42.method3203(var0, var2, var3);
                        if(var36 != 0L) {
                           var35 = WorldMapSection2.method435(WorldMapRectangle.method387(var36)).int2;
                        }

                        if(var15.animationId == -1 && var15.transforms == null) {
                           var32 = var15.method4664(4, var5, var22, var24, var23, var25);
                        } else {
                           var32 = new DynamicObject(var4, 4, var5, var12, var2, var3, var15.animationId, true, (Entity)null);
                        }

                        var42.method3299(var0, var2, var3, var23, (Entity)var32, (Entity)null, Tiles.field544[var5], 0, var35 * Tiles.field541[var5], var35 * Tiles.field547[var5], var26, var28);
                     } else if(var6 == 6) {
                        var35 = 8;
                        var36 = var42.method3203(var0, var2, var3);
                        if(0L != var36) {
                        ...
                        if(var15.animationId == -1 && var15.transforms == null) {
                           var32 = var15.method4664(4, var5 + 4, var22, var24, var23, var25);
                        } else {
                           var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, true, (Entity)null);
                        }

                        var42.method3299(var0, var2, var3, var23, (Entity)var32, (Entity)null, 256, var5, var35 * Tiles.field546[var5], var35 * Tiles.field552[var5], var26, var28);
                     } else if(var6 == 7) {
                        int var38 = var5 + 2 & 3;
                        if(var15.animationId == -1 && var15.transforms == null) {
                           var29 = var15.method4664(4, var38 + 4, var22, var24, var23, var25);
                        } else {
                           var29 = new DynamicObject(var4, 4, var38 + 4, var12, var2, var3, var15.animationId, true, (Entity)null);
                        }

                        var42.method3299(var0, var2, var3, var23, (Entity)var29, (Entity)null, 256, var38, 0, 0, var26, var28);
                     } else if(var6 == 8) {
                        var35 = 8;
                        var36 = var42.method3203(var0, var2, var3);
                        if(var36 != 0L) {
                        ...
                        if(var15.animationId == -1 && var15.transforms == null) {
                           var32 = var15.method4664(4, var5 + 4, var22, var24, var23, var25);
                           var33 = var15.method4664(4, var34 + 4, var22, var24, var23, var25);
                        } else {
                           var32 = new DynamicObject(var4, 4, var5 + 4, var12, var2, var3, var15.animationId, true, (Entity)null);
                           var33 = new DynamicObject(var4, 4, var34 + 4, var12, var2, var3, var15.animationId, true, (Entity)null);
                        }

                        var42.method3299(var0, var2, var3, var23, (Entity)var32, (Entity)var33, 256, var5, var35 * Tiles.field546[var5], var35 * Tiles.field552[var5], var26, var28);
                     }
                  }
               }
            } else {
               if(var15.animationId == -1 && var15.transforms == null) {
                  var29 = var15.method4664(10, var5, var22, var24, var23, var25);
               } else {
         ...
         if(var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) {
            ...
            if(var8 == 1) {
               ...
               while(true) {
                  ...
                  if(var9.vmethod3665(1, var15, var16, var10)) {
                     Coord.field2530 = var15;
                     class182.field2097 = var16;
                     var34 = true;
                     break;
               ...
               while(true) {
                  ...
                  var24 = var15 - var10.xInset;
                  var25 = var16 - var10.yInset;
                  if(var9.vmethod3665(2, var15, var16, var10)) {
                     Coord.field2530 = var15;
                     class182.field2097 = var16;
                     var34 = true;
                     break;
               ...
               while(true) {
                  ...
                  var24 = var15 - var10.xInset;
                  var25 = var16 - var10.yInset;
                  if(var9.vmethod3665(var8, var15, var16, var10)) {
                     Coord.field2530 = var15;
                     class182.field2097 = var16;
                     var34 = true;
                     break;
                  ...
                  if(var35 < 128 - var8 && var36 < 128 - var8 && class182.directions[var35 + 1][var36 + 1] == 0 && (var23[var24 + var8][var8 + var25] & 19136992) == 0) {
