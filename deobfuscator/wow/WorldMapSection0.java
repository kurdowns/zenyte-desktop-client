...
public class WorldMapSection0 implements WorldMapSection, RSWorldMapSection0 {
   ...
   public boolean vmethod871(int var1, int var2, int var3) {
      return var1 >= this.oldZ && var1 < this.newZ + this.oldZ?var2 >= (this.oldX << 6) + (this.oldChunkXLow << 3) && var2 <= (this.oldX << 6) + (this.oldChunkXHigh << 3) + 7 && var3 >= (this.oldY << 6) + (this.oldChunkYLow << 3) && var3 <= (this.oldY << 6) + (this.oldChunkYHigh << 3) + 7:false;
   }
   ...
   public void vmethod885(Buffer var1) {
      this.oldZ = var1.method5575();
      this.newZ = var1.method5575();
      this.oldX = var1.method5577();
      this.oldChunkXLow = var1.method5575();
      this.oldChunkXHigh = var1.method5575();
      this.oldY = var1.method5577();
      this.oldChunkYLow = var1.method5575();
      this.oldChunkYHigh = var1.method5575();
      this.newX = var1.method5577();
      this.newChunkXLow = var1.method5575();
      this.newChunkXHigh = var1.method5575();
      this.newY = var1.method5577();
      this.newChunkYLow = var1.method5575();
      this.newChunkYHigh = var1.method5575();
      this.method327();
   }
   ...
   static final void method308(int var0, int var1, int var2) {
      if(var0 >= 128 && var1 >= 128 && var0 <= 13056 && var1 <= 13056) {
         int var3 = class277.method5038(var0, var1, ScriptEvent.Client_plane) - var2;
      ...
      for(int var1 = 0; var1 < Client.field851; ++var1) {
         ...
         if((var4 & 128) != 0) {
            ...
            if(var5 == var3.sequence && var5 != -1) {
               var7 = SpotAnimationDefinition.method4503(var5).field3525;
               if(var7 == 1) {
            ...
            } else if(var5 == -1 || var3.sequence == -1 || SpotAnimationDefinition.method4503(var5).field3519 >= SpotAnimationDefinition.method4503(var3.sequence).field3519) {
               var3.sequence = var5;
         ...
         if((var4 & 16) != 0) {
            ...
            var6 = var0.method5615();
            var7 = var3.x - (var5 - class69.baseX * 64 - class69.baseX * 64) * 64;
            var8 = var3.y - (var6 - class89.baseY * 64 - class89.baseY * 64) * 64;
            if(var7 != 0 || var8 != 0) {
         ...
         if((var4 & 32) != 0) {
            NPCDefinition var10001 = class237.method4226(var0.method5615());
         ...
         if((var4 & 8) != 0) {
            var3.targetIndex = var0.method5577();
         ...
         if((var4 & 64) != 0) {
            var3.overheadText = var0.method5695();
         ...
         if((var4 & 1) != 0) {
            ...
            if(var5 > 0) {
               for(var6 = 0; var6 < var5; ++var6) {
                  ...
                  var9 = -1;
                  var10 = -1;
                  var7 = var0.method5589();
                  if(var7 == 32767) {
                     var7 = var0.method5589();
                     var9 = var0.method5589();
                     var8 = var0.method5589();
                     var10 = var0.method5589();
                  } else if(var7 != 32766) {
                     var9 = var0.method5589();
                  } else {
                     var7 = -1;
                  ...
                  var11 = var0.method5589();
                  var3.method1859(var7, var9, var8, var10, Client.cycle, var11);
               }
            }
            ...
            if(var6 > 0) {
               for(var7 = 0; var7 < var6; ++var7) {
                  ...
                  if(var9 != 32767) {
                     var10 = var0.method5589();
                     var11 = var0.method5605();
                     int var12 = var9 > 0?var0.method5606():var11;
                     var3.method1845(var8, Client.cycle, var9, var10, var11, var12);
                  } else {
                     var3.method1846(var8);
                  }
               }
            }
         }
         ...
         if((var4 & 4) != 0) {
            var3.field990 = var0.method5608();
            var3.field1017 = var0.method5609();
            var3.field972 = var0.method5607();
            var3.field1018 = var0.method5576();
            var3.field1019 = var0.method5565() + Client.cycle;
            var3.field1020 = var0.method5614() + Client.cycle;
            var3.field1021 = var0.method5577();
            var3.pathLength = 1;
            var3.field1032 = 0;
