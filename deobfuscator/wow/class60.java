...
public class class60 {
   ...
   public static FloorUnderlayDefinition method995(int var0) {
      FloorUnderlayDefinition var1 = (FloorUnderlayDefinition)FloorUnderlayDefinition.FloorUnderlayDefinition_cached.method3432((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = FloorUnderlayDefinition.FloorUnderlayDefinition_archive.method4249(1, var0, (byte)-104);
         var1 = new FloorUnderlayDefinition();
         if(var2 != null) {
            var1.method4516(new Buffer(var2), var0);
         }

         var1.method4504();
         FloorUnderlayDefinition.FloorUnderlayDefinition_cached.method3438(var1, (long)var0);
         return var1;
      }
   }
   ...
   static final void method999(String var0) {
      if(var0.equalsIgnoreCase("toggleroof")) {
         ...
         if(GrandExchangeOfferOwnWorldComparator.clientPreferences.roofsHidden) {
            Skeleton.method3175(99, "", "Roofs are now all hidden");
         } else {
            Skeleton.method3175(99, "", "Roofs will only be removed selectively");
         }
      }
      ...
      PacketBufferNode var1 = FaceNormal.method3377(ClientPacket.field2246, Client.packetWriter.isaacCipher);
      var1.packetBuffer.method5559(var0.length() + 1);
