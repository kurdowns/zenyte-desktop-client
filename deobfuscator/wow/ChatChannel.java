...
public class ChatChannel implements RSChatChannel {
   ...
   Message method2348(int var1, String var2, String var3, String var4) {
   ...
   static void method2355(int var0, String var1, String var2, String var3) {
      ...
      Message var5 = var4.method2348(var0, var1, var2, var3);
      Messages.Messages_hashTable.method5998(var5, (long)var5.count);
      Messages.Messages_queue.method5024(var5);
   ...
   static Archive method2353(int var0, boolean var1, boolean var2, boolean var3) {
   ...
   static final void method2356() {
      if(AbstractWorldMapData.pcmPlayer1 != null) {
         AbstractWorldMapData.pcmPlayer1.method2536();
      }

      if(WorldMapManager.pcmPlayer0 != null) {
         WorldMapManager.pcmPlayer0.method2536();
      }
   ...
   static void method2354() {
      ...
      MusicPatchNode.method3923(WorldMapScaleHandler.menuWidth / 2 + WorldMapDecoration.menuX, PacketBufferNode.menuY);
   }
}
