...
public enum class169 implements Enumerated {
   ...
   field2012("runelite", 0, 0, 0),
   @ObfuscatedName("m")
   @ObfuscatedSignature(
      signature = "Lfu;"
   )
   field2007("runelite", 1, 1, 1),
   @ObfuscatedName("k")
   @ObfuscatedSignature(
      signature = "Lfu;"
   )
   field2008("runelite", 2, 3, 2),
   @ObfuscatedName("d")
   @ObfuscatedSignature(
      signature = "Lfu;"
   )
   field2006("runelite", 3, 2, 3);
   @ObfuscatedName("z")
   ...
   class169(String var1, int var2, int var3, int var4) {
      this.field2014 = var3;
      this.id = var4;
   }
   ...
   @ObfuscatedName("x")
   public static final void method3542(long var0) {
      if(var0 > 0L) {
         if(0L == var0 % 10L) {
            long var2 = var0 - 1L;
   ...
   static int method3546(int var0, int var1) {
      FloorOverlayDefinition var2 = UserComparator9.method3492(var0);
      if(var2 == null) {
         return var1;
         ...
         int var5;
         if(var2.texture >= 0) {
            var4 = Rasterizer3D.Rasterizer3D_textureLoader.vmethod3386(var2.texture);
            byte var11 = 96;
            int var3;
            if(var4 == -2) {
               var3 = 12345678;
