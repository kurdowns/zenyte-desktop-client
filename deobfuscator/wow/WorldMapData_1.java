...
public class WorldMapData_1 extends AbstractWorldMapData implements RSWorldMapData_1 {
   ...
   void method801(Buffer var1) {
      ...
      if(var2 != WorldMapID.field303.value) {
         ...
         super.minPlane = var1.method5575();
         super.planes = var1.method5575();
         super.regionXLow = var1.method5577() * 4096;
         super.regionYLow = var1.method5577() * 64;
         this.chunkXLow = var1.method5575();
         this.chunkYLow = var1.method5575();
         super.regionX = var1.method5577();
         super.regionY = var1.method5577();
         this.chunkX = var1.method5575();
         this.chunkY = var1.method5575();
         super.groupId = var1.method5592();
         super.fileId = var1.method5592();
      }
   }
   ...
   public boolean equals(Object var1) {
      if(!(var1 instanceof WorldMapData_1)) {
         ...
         return super.regionX == var2.regionX && super.regionY == var2.regionY?var2.chunkX == this.chunkX && var2.chunkY == this.chunkY:false;
      }
   }
   ...
   static ClientPreferences method813() {
      ...
      try {
         ...
         byte[] var2 = new byte[(int)var0.method6693()];

         int var4;
         for(int var3 = 0; var3 < var2.length; var3 += var4) {
            var4 = var0.method6705(var2, var3, var2.length - var3);
            if(var4 == -1) {
   ...
   static final void method816(class194 var0) {
      ...
      if(class194.field2327 == var0) {
         ...
         if(var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
            Skeleton.method3174(ScriptEvent.Client_plane, var7, var8, var5, -1, var3, var4, 0, -1);
         }
         ...
         if(class194.field2324 == var0) {
            byte var2 = var1.method5609();
            var3 = var1.method5615();
            var4 = var1.method5577();
            var5 = var1.method5615();
            var6 = var1.method5605();
            var7 = var6 >> 2;
            var8 = var6 & 3;
            var9 = Client.field699[var7];
            byte var10 = var1.method5576();
            var11 = var1.method5604();
            ...
            int var15 = var1.method5615();
            byte var16 = var1.method5607();
            Player var17;
            ...
            if(var17 != null) {
               ...
               Model var29 = var18.method4664(var7, var8, var25, var27, var26, var28);
               if(var29 != null) {
                  Skeleton.method3174(ScriptEvent.Client_plane, var12, var13, var9, -1, 0, 0, var15 + 1, var3 + 1);
         ...
         if(class194.field2331 == var0) {
            ...
            if(var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
               ...
               if(var31 != null) {
                  for(var32 = (TileItem)var31.method4956(); var32 != null; var32 = (TileItem)var31.method4974()) {
            ...
            if(var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
               ...
               if(var41 != null) {
                  for(TileItem var34 = (TileItem)var41.method4956(); var34 != null; var34 = (TileItem)var41.method4974()) {
                  ...
                  World.method1898(var6, var7);
               }
            }

         } else if(class194.field2330 == var0) {
            var37 = var1.method5575();
            var3 = (var37 >> 4 & 7) + GrandExchangeOfferTotalQuantityComparator.field91;
            var4 = (var37 & 7) + PlatformInfo.field3959;
            var5 = var1.method5615();
            var6 = var1.method5606();
            var7 = var6 >> 2;
            var8 = var6 & 3;
            var9 = Client.field699[var7];
            if(var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
               Skeleton.method3174(ScriptEvent.Client_plane, var3, var4, var9, var5, var7, var8, 0, -1);
            }
            ...
            if(class194.field2323 == var0) {
               var37 = var1.method5614();
               var3 = var1.method5565();
               ...
               if(var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                  ...
                  Client.groundItems[ScriptEvent.Client_plane][var5][var6].method4977(var32);
                  World.method1898(var5, var6);
               }

            } else if(class194.field2332 == var0) {
               var37 = var1.method5614();
               var3 = var1.method5606() * 4;
               var4 = var1.method5605() * 4;
               var5 = var1.method5605();
               byte var38 = var1.method5608();
               var7 = var1.method5615();
               var8 = var1.method5565();
               var9 = var1.method5575();
               var39 = (var9 >> 4 & 7) + GrandExchangeOfferTotalQuantityComparator.field91;
               var11 = (var9 & 7) + PlatformInfo.field3959;
               var12 = var1.method5575();
               var13 = var1.method5578();
               var14 = var1.method5608();
               var6 = var38 + var39;
               int var40 = var14 + var11;
               if(var39 >= 0 && var11 >= 0 && var39 < 104 && var11 < 104 && var6 >= 0 && var40 >= 0 && var6 < 104 && var40 < 104 && var7 != '\uffff') {
                  var39 = var39 * 128 + 64;
                  var11 = var11 * 128 + 64;
                  var6 = var6 * 128 + 64;
                  var40 = var40 * 128 + 64;
                  Projectile var35 = new Projectile(var7, ScriptEvent.Client_plane, var39, var11, class277.method5038(var39, var11, ScriptEvent.Client_plane) - var4, var8 + Client.cycle, var37 + Client.cycle, var5, var12, var13, var3);
                  var35.method2210(var6, var40, class277.method5038(var6, var40, ScriptEvent.Client_plane) - var3, var8 + Client.cycle);
                  Client.projectiles.method4977(var35);
               }

            } else if(class194.field2326 == var0) {
               var37 = var1.method5604();
               var3 = var1.method5577();
               var4 = var1.method5604();
               var5 = (var4 >> 4 & 7) + GrandExchangeOfferTotalQuantityComparator.field91;
               var6 = (var4 & 7) + PlatformInfo.field3959;
               ...
               if(var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                  var5 = var5 * 128 + 64;
                  var6 = var6 * 128 + 64;
                  GraphicsObject var33 = new GraphicsObject(var3, ScriptEvent.Client_plane, var5, var6, class277.method5038(var5, var6, ScriptEvent.Client_plane) - var37, var7, Client.cycle);
                  Client.graphicsObjects.method4977(var33);
               }
               ...
               if(var3 >= 0 && var4 >= 0 && var3 < 103 && var4 < 103) {
                  ...
                  if(var8 == 3) {
                     FloorDecoration var44 = GrandExchangeOfferWorldComparator.scene.method3202(ScriptEvent.Client_plane, var3, var4);
                     if(var44 != null) {
