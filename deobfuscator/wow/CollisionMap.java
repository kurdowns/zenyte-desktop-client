...
public class CollisionMap implements RSCollisionMap {
   ...
   public void method3631(int var1, int var2, int var3, int var4, boolean var5) {
      var1 -= this.xInset;
      var2 -= this.yInset;
      if(var3 == 0) {
         if(var4 == 0) {
      ...
      if(var5) {
         ...
         if(var3 == 1 || var3 == 3) {
            ...
            if(var4 == 1) {
               ...
               this.method3635(var1 + 1, var2 + 1, '\u8000');
            }
   ...
   public void method3632(int var1, int var2, int var3, int var4, boolean var5) {
      int var6 = 256;
      if(var5) {
         var6 += 131072;
      }
   ...
   public void method3633(int var1, int var2) {
      var1 -= this.xInset;
      var2 -= this.yInset;
   ...
   public void method3634(int var1, int var2) {
      var1 -= this.xInset;
      var2 -= this.yInset;
   ...
   public void method3636(int var1, int var2, int var3, int var4, boolean var5) {
      var1 -= this.xInset;
      var2 -= this.yInset;
      if(var3 == 0) {
         if(var4 == 0) {
            this.method3638(var1, var2, 128);
            this.method3638(var1 - 1, var2, 8);
         }

         if(var4 == 1) {
            this.method3638(var1, var2, 2);
            this.method3638(var1, var2 + 1, 32);
         }

         if(var4 == 2) {
            this.method3638(var1, var2, 8);
            this.method3638(var1 + 1, var2, 128);
         }

         if(var4 == 3) {
            this.method3638(var1, var2, 32);
            this.method3638(var1, var2 - 1, 2);
         }
      }

      if(var3 == 1 || var3 == 3) {
         if(var4 == 0) {
            this.method3638(var1, var2, 1);
            this.method3638(var1 - 1, var2 + 1, 16);
         }

         if(var4 == 1) {
            this.method3638(var1, var2, 4);
            this.method3638(var1 + 1, var2 + 1, 64);
         }

         if(var4 == 2) {
            this.method3638(var1, var2, 16);
            this.method3638(var1 + 1, var2 - 1, 1);
         }

         if(var4 == 3) {
            this.method3638(var1, var2, 64);
            this.method3638(var1 - 1, var2 - 1, 4);
         }
      }

      if(var3 == 2) {
         if(var4 == 0) {
            this.method3638(var1, var2, 130);
            this.method3638(var1 - 1, var2, 8);
            this.method3638(var1, var2 + 1, 32);
         }

         if(var4 == 1) {
            this.method3638(var1, var2, 10);
            this.method3638(var1, var2 + 1, 32);
            this.method3638(var1 + 1, var2, 128);
         }

         if(var4 == 2) {
            this.method3638(var1, var2, 40);
            this.method3638(var1 + 1, var2, 128);
            this.method3638(var1, var2 - 1, 2);
         }

         if(var4 == 3) {
            this.method3638(var1, var2, 160);
            this.method3638(var1, var2 - 1, 2);
            this.method3638(var1 - 1, var2, 8);
         }
      }
      ...
      if(var5) {
         if(var3 == 0) {
            if(var4 == 0) {
               this.method3638(var1, var2, 65536);
               this.method3638(var1 - 1, var2, 4096);
            }

            if(var4 == 1) {
               this.method3638(var1, var2, 1024);
               this.method3638(var1, var2 + 1, 16384);
            }

            if(var4 == 2) {
               this.method3638(var1, var2, 4096);
               this.method3638(var1 + 1, var2, 65536);
            }

            if(var4 == 3) {
               this.method3638(var1, var2, 16384);
               this.method3638(var1, var2 - 1, 1024);
            }
         }

         if(var3 == 1 || var3 == 3) {
            if(var4 == 0) {
               this.method3638(var1, var2, 512);
               this.method3638(var1 - 1, var2 + 1, 8192);
            }

            if(var4 == 1) {
               this.method3638(var1, var2, 2048);
               this.method3638(var1 + 1, var2 + 1, '\u8000');
            }

            if(var4 == 2) {
               this.method3638(var1, var2, 8192);
               this.method3638(var1 + 1, var2 - 1, 512);
            }

            if(var4 == 3) {
               this.method3638(var1, var2, '\u8000');
               this.method3638(var1 - 1, var2 - 1, 2048);
            }
         }

         if(var3 == 2) {
            if(var4 == 0) {
               this.method3638(var1, var2, 66560);
               this.method3638(var1 - 1, var2, 4096);
               this.method3638(var1, var2 + 1, 16384);
            }

            if(var4 == 1) {
               this.method3638(var1, var2, 5120);
               this.method3638(var1, var2 + 1, 16384);
               this.method3638(var1 + 1, var2, 65536);
            }

            if(var4 == 2) {
               this.method3638(var1, var2, 20480);
               this.method3638(var1 + 1, var2, 65536);
               this.method3638(var1, var2 - 1, 1024);
            }

            if(var4 == 3) {
               this.method3638(var1, var2, 81920);
               this.method3638(var1, var2 - 1, 1024);
               this.method3638(var1 - 1, var2, 4096);
            }
         }
   ...
   public void method3654(int var1, int var2, int var3, int var4, int var5, boolean var6) {
      int var7 = 256;
      if(var6) {
         var7 += 131072;
      }
         ...
         if(var8 >= 0 && var8 < this.xSize) {
            for(int var9 = var2; var9 < var2 + var4; ++var9) {
               if(var9 >= 0 && var9 < this.ySize) {
                  this.method3638(var8, var9, var7);
               }
            }
         }
      }
   ...
   void method3638(int var1, int var2, int var3) {
      this.flags[var1][var2] &= ~var3;
   }
