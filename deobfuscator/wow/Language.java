...
public class Language implements Enumerated, RSLanguage {
   ...
   public static final Language Language_EN = new Language("EN", "en", "English", ModeWhere.field2375, 0, "GB");
   @ObfuscatedName("m")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   static final Language Language_DE = new Language("DE", "de", "German", ModeWhere.field2375, 1, "DE");
   @ObfuscatedName("k")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   public static final Language Language_FR = new Language("FR", "fr", "French", ModeWhere.field2375, 2, "FR");
   @ObfuscatedName("d")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   static final Language Language_PT = new Language("PT", "pt", "Portuguese", ModeWhere.field2375, 3, "BR");
   @ObfuscatedName("w")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   static final Language Language_NL = new Language("NL", "nl", "Dutch", ModeWhere.field2376, 4, "NL");
   @ObfuscatedName("v")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   public static final Language Language_ES = new Language("ES", "es", "Spanish", ModeWhere.field2376, 5, "ES");
   @ObfuscatedName("q")
   @ObfuscatedSignature(
      signature = "Lgl;"
   )
   static final Language Language_ES_MX = new Language("ES_MX", "es-mx", "Spanish (Latin American)", ModeWhere.field2375, 6, "MX");
   @ObfuscatedName("s")
   @ObfuscatedSignature(
      signature = "[Lgl;"
   )
   ...
   public String toString() {
      return this.method3749().toLowerCase(Locale.ENGLISH);
   }
   ...
   static boolean method3751() {
      try {
         if(LoginPacket.World_request == null) {
            LoginPacket.World_request = WorldMapLabel.urlRequester.method3411(new URL(ModeWhere.worldListURL));
         } else if(LoginPacket.World_request.method3417()) {
            byte[] var0 = LoginPacket.World_request.method3420();
            Buffer var1 = new Buffer(var0);
            var1.method5580();
            World.World_count = var1.method5577();
            UserComparator2.World_worlds = new World[World.World_count];

            World var3;
            for(int var2 = 0; var2 < World.World_count; var3.index = var2++) {
               var3 = UserComparator2.World_worlds[var2] = new World();
               var3.id = var1.method5577();
               var3.properties = var1.method5580();
               var3.host = var1.method5695();
               var3.activity = var1.method5695();
               var3.location = var1.method5575();
               var3.population = var1.method5578();
   ...
   public static int method3750(int var0, int var1, int var2, int var3, int var4, int var5) {
      if((var5 & 1) == 1) {
         int var6 = var3;
         var3 = var4;
         var4 = var6;
   ...
   public static Language method3737(int var0) {
