...
public class Archive extends AbstractArchive implements RSArchive {
   ...
   void vmethod4346(int var1) {
      ...
      NetFileRequest var5 = (NetFileRequest)NetCache.NetCache_pendingWrites.method6046(var3);
      if(var5 != null) {
         NetCache.NetCache_pendingWritesQueue.method4876(var5);
      }
   ...
   int vmethod4371(int var1) {
      return super.groups[var1] != null?100:(this.validGroups[var1]?100:class3.method59(this.index, var1));
   }
   ...
   void vmethod4347(int var1) {
      if(this.archiveDisk != null && this.validGroups != null && this.validGroups[var1]) {
         ...
         Frames.method3385(this, this.index, var1, super.groupCrcs[var1], (byte)2, true);
      }
   ...
   public void method4348(int var1, int var2) {
      this.indexCrc = var1;
      this.indexVersion = var2;
      if(this.masterDisk != null) {
         DynamicObject.method2342(this.index, this.masterDisk, this);
      } else {
         Frames.method3385(this, 255, this.index, this.indexCrc, (byte)0, true);
      }
   ...
   public void method4345(int var1, byte[] var2, boolean var3, boolean var4) {
      if(var3) {
         if(this.field3154) {
         ...
         if(this.masterDisk != null) {
            ...
            synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) {
               ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.method4977(var7);
            }

            Object var16 = ArchiveDiskActionHandler.ArchiveDiskActionHandler_lock;
         ...
         if(var4) {
            ...
            if(var2 == null) {
               ...
               DirectByteArrayCopier var17 = new DirectByteArrayCopier();
               var17.vmethod4028(var2);
               var15 = var17;
            } else {
               var15 = var2;
            }
   ...
   public void method4374(ArchiveDisk var1, int var2, byte[] var3, boolean var4) {
      int var5;
      if(var1 == this.masterDisk) {
         ...
         Buffer var11 = new Buffer(class217.method4035(var3));
         int var12 = var11.method5575();
         if(var12 != 5 && var12 != 6) {
         ...
         if(var3 == null || var3.length <= 2) {
            ...
            if(this.field3156 || var4) {
               Frames.method3385(this, this.index, var2, super.groupCrcs[var2], (byte)2, var4);
            }
      ...
      if(this.archiveDisk == null) {
         ...
         for(var1 = 0; var1 < this.validGroups.length; ++var1) {
            if(super.fileCounts[var1] > 0) {
               class228.method4205(var1, this.archiveDisk, this);
               this.field3161 = var1;
            }
         }
   ...
   public boolean method4354(int var1) {
      return this.method4259(var1) != null;
   }
