...
public final class TileItem extends Entity implements RSTileItem {
   ...
   protected final Model vmethod3367(int var1) {
      return AbstractWorldMapData.method373(this.id).method4721(this.quantity, (byte)-102);
   }
   ...
   public void quantityChanged(int var1) {
      if(this.rl$sceneX != -1) {
         WorldMapSection1.client.getLogger().debug("Item quantity changed: {} ({} -> {})", new Object[]{Integer.valueOf(this.getId()), Integer.valueOf(this.getQuantity()), Integer.valueOf(var1)});
