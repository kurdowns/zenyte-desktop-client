...
import net.runelite.rs.api.RSApproximateRouteStrategy;
import netscape.javascript.JSObject;

@ObfuscatedName("bj")
public class ApproximateRouteStrategy extends RouteStrategy implements RSApproximateRouteStrategy {
   ...
   public boolean vmethod3665(int var1, int var2, int var3, CollisionMap var4) {
   ...
   static void method1328(String var0) {
      ...
      try {
         ...
         if(var0.length() == 0) {
            ...
            long var6 = class217.method4036() + 94608000000L;
