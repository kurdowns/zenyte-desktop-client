...
public class WorldMapSection2 implements WorldMapSection, RSWorldMapSection2 {
   ...
   public boolean vmethod871(int var1, int var2, int var3) {
      return var1 >= this.minPlane && var1 < this.minPlane + this.planes?var2 >> 6 >= this.regionStartX && var2 >> 6 <= this.regionEndX && var3 >> 6 >= this.regionStartY && var3 >> 6 <= this.regionEndY:false;
   }
   ...
   public void vmethod885(Buffer var1) {
      ...
      this.field232 = var1.method5577();
      this.field239 = var1.method5577();
      this.field234 = var1.method5577();
      this.field241 = var1.method5577();
      this.method415();
   }
   ...
   public static ObjectDefinition method435(int var0) {
      ObjectDefinition var1 = (ObjectDefinition)ObjectDefinition.ObjectDefinition_cached.method3432((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = ObjectDefinition.ObjectDefinition_archive.method4249(6, var0, (byte)-45);
         var1 = new ObjectDefinition();
         var1.id = var0;
         if(var2 != null) {
            var1.method4660(new Buffer(var2));
         }
         ...
         ObjectDefinition.ObjectDefinition_cached.method3438(var1, (long)var0);
         return var1;
      }
   }
