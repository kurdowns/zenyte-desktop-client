...
public class WorldMapIcon_1 extends AbstractWorldMapIcon implements RSWorldMapIcon_1 {
   ...
   static void method406(int var0) {
      ...
      if(Client.gameState >= 25) {
         PacketBufferNode var1 = FaceNormal.method3377(ClientPacket.field2257, Client.packetWriter.isaacCipher);
         var1.packetBuffer.method5559(ApproximateRouteStrategy.method1327());
         var1.packetBuffer.method5560(WorldMapLabel.canvasWidth);
         var1.packetBuffer.method5560(Varps.canvasHeight);
