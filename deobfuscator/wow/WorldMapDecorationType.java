...
public class WorldMapDecorationType implements Enumerated, RSWorldMapDecorationType {
   ...
   public static final WorldMapDecorationType field2732 = new WorldMapDecorationType(0, 0);
   @ObfuscatedName("m")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2718 = new WorldMapDecorationType(1, 0);
   @ObfuscatedName("k")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   public static final WorldMapDecorationType field2728 = new WorldMapDecorationType(2, 0);
   @ObfuscatedName("d")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   public static final WorldMapDecorationType field2742 = new WorldMapDecorationType(3, 0);
   @ObfuscatedName("w")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   public static final WorldMapDecorationType field2722 = new WorldMapDecorationType(9, 2);
   @ObfuscatedName("v")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2723 = new WorldMapDecorationType(4, 1);
   @ObfuscatedName("q")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2724 = new WorldMapDecorationType(5, 1);
   @ObfuscatedName("z")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2721 = new WorldMapDecorationType(6, 1);
   @ObfuscatedName("t")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2726 = new WorldMapDecorationType(7, 1);
   @ObfuscatedName("e")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2730 = new WorldMapDecorationType(8, 1);
   @ObfuscatedName("s")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2734 = new WorldMapDecorationType(12, 2);
   @ObfuscatedName("p")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2729 = new WorldMapDecorationType(13, 2);
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2720 = new WorldMapDecorationType(14, 2);
   @ObfuscatedName("u")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2731 = new WorldMapDecorationType(15, 2);
   @ObfuscatedName("h")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2725 = new WorldMapDecorationType(16, 2);
   @ObfuscatedName("g")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2738 = new WorldMapDecorationType(17, 2);
   @ObfuscatedName("i")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2737 = new WorldMapDecorationType(18, 2);
   @ObfuscatedName("a")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2735 = new WorldMapDecorationType(19, 2);
   @ObfuscatedName("b")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2736 = new WorldMapDecorationType(20, 2);
   @ObfuscatedName("l")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2733 = new WorldMapDecorationType(21, 2);
   @ObfuscatedName("r")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2719 = new WorldMapDecorationType(10, 2);
   @ObfuscatedName("o")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   static final WorldMapDecorationType field2739 = new WorldMapDecorationType(11, 2);
   @ObfuscatedName("c")
   @ObfuscatedSignature(
      signature = "Lha;"
   )
   public static final WorldMapDecorationType field2740 = new WorldMapDecorationType(22, 3);
   @ObfuscatedName("j")
   @ObfuscatedGetter(
      intValue = -1867992849
   )
   ...
   public static void method4214(String var0, Throwable var1) {
      if(var1 != null) {
   ...
   @ObfuscatedName("z")
   static boolean method4213(long var0) {
   ...
   static final void method4210(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
            ...
            if(var32 || !var9.isIf3 || var12 < var14 && var13 < var15) {
               if(var9.isIf3) {
                  ...
                  if(var9.noClickThrough) {
                     if(MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
                        for(var26 = (ScriptEvent)Client.scriptEvents.method4956(); var26 != null; var26 = (ScriptEvent)Client.scriptEvents.method4974()) {
               ...
               if(var9.contentType == 1337) {
                  ...
                  if(var9.contentType == 1400) {
                     GrandExchangeOfferAgeComparator.worldMap.method6422(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y, var33, var10, var11, var9.width, var9.height);
                  }

                  if(!Client.isMenuOpen && var33) {
                     if(var9.contentType == 1400) {
                        GrandExchangeOfferAgeComparator.worldMap.method6466(var10, var11, var9.width, var9.height, var17, var18);
                     } else {
                  ...
                  if(var32) {
                     for(int var20 = 0; var20 < var9.field2555.length; ++var20) {
                        ...
                        if(var22) {
                           if(var20 < 10) {
                              ClientPacket.method3686(var20 + 1, var9.id, var9.childIndex, var9.itemId, "");
                           } else if(var20 == 10) {
                              ...
                              Client.selectedSpellActionName = PrivateChatMode.method5966(var9);
                              if(Client.selectedSpellActionName == null) {
                                 Client.selectedSpellActionName = "null";
                              }

                              Client.selectedSpellName = var9.dataText + class297.method5342(16777215);
                           }
                  ...
                  if(var9.isIf3) {
                     ...
                     if(var9.contentType == 1400) {
                        GrandExchangeOfferAgeComparator.worldMap.method6423(var17, var18, var33 & var34, var33 & var21);
                     }
                     ...
                     if(var9.hasListener) {
                        ...
                        if(var33 && Client.mouseWheelRotation != 0 && var9.onScroll != null) {
                           ...
                           Client.scriptEvents.method4977(var27);
                        }
                        ...
                        if(var9.isClicked && !var34) {
                           ...
                           if(var9.onRelease != null) {
                              ...
                              Client.field919.method4977(var27);
                           }
                        }
                        ...
                        if(var9.onTimer != null) {
                           ...
                           Client.field727.method4977(var27);
                        }
                              ...
                              for(var35 = var9.field2701; var35 < Client.field772; ++var35) {
                                 ...
                                 for(var36 = 0; var36 < var9.varTransmitTriggers.length; ++var36) {
                                    if(var23 == var9.varTransmitTriggers[var36]) {
                                       ...
                                       Client.scriptEvents.method4977(var30);
                                       break label867;
                                    }
                                 }
                              }
                        ...
                        if(var9.onKey != null) {
                           for(var35 = 0; var35 < Client.field901; ++var35) {
                              ...
                              Client.scriptEvents.method4977(var31);
                           }
                        }
                     }
                  }
                  ...
                  if(var9.type == 0) {
                     method4210(var0, var9.id, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY);
                     if(var9.children != null) {
                        method4210(var9.children, var9.id, var12, var13, var14, var15, var10 - var9.scrollX, var11 - var9.scrollY);
                     }

                     InterfaceParent var28 = (InterfaceParent)Client.interfaceParents.method6046((long)var9.id);
                     if(var28 != null) {
                        if(var28.type == 0 && MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15 && !Client.isMenuOpen) {
                           for(ScriptEvent var29 = (ScriptEvent)Client.scriptEvents.method4956(); var29 != null; var29 = (ScriptEvent)Client.scriptEvents.method4974()) {
