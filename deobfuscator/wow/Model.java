...
public class Model extends Entity implements RSModel {
   ...
   @ObfuscatedName("ba")
   static int[] Model_sine = Rasterizer3D.Rasterizer3D_sine;
   @ObfuscatedName("bv")
   static int[] Model_cosine = Rasterizer3D.Rasterizer3D_cosine;
   @ObfuscatedName("bx")
   static int[] field1748 = Rasterizer3D.Rasterizer3D_colorPalette;
   @ObfuscatedName("bz")
   static int[] field1749 = Rasterizer3D.field1793;
   @ObfuscatedName("w")
   int verticesCount = 0;
   @ObfuscatedName("v")
   int[] verticesX;
   ...
   public Model method2999(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
   ...
   public Model method2985(boolean var1) {
      if(!var1 && Model_sharedSequenceModelFaceAlphas.length < this.indicesCount) {
         Model_sharedSequenceModelFaceAlphas = new byte[this.indicesCount + 100];
      }

      return this.method2967(var1, Model_sharedSequenceModel, Model_sharedSequenceModelFaceAlphas);
   }
   ...
   public Model method3027(boolean var1) {
      if(!var1 && Model_sharedSpotAnimationModelFaceAlphas.length < this.indicesCount) {
         Model_sharedSpotAnimationModelFaceAlphas = new byte[this.indicesCount + 100];
      }

      return this.method2967(var1, Model_sharedSpotAnimationModel, Model_sharedSpotAnimationModelFaceAlphas);
   }
   ...
   Model method2967(boolean var1, Model var2, byte[] var3) {
   ...
   public void method2973(Frames var1, int var2) {
      if(this.vertexLabels != null) {
         if(var2 != -1) {
            ...
            for(int var5 = 0; var5 < var3.transformCount; ++var5) {
               ...
               this.method3028(var4.transformTypes[var6], var4.labels[var6], var3.transformXs[var5], var3.transformYs[var5], var3.transformZs[var5]);
            }
   ...
   public void method2974(Frames var1, int var2, Frames var3, int var4, int[] var5) {
      if(var2 != -1) {
         if(var5 != null && var4 != -1) {
            ...
            for(var11 = 0; var11 < var6.transformCount; ++var11) {
               ...
               if(var12 != var10 || var8.transformTypes[var12] == 0) {
                  this.method3028(var8.transformTypes[var12], var8.labels[var12], var6.transformXs[var11], var6.transformYs[var11], var6.transformZs[var11]);
               }
            }
            ...
            for(var11 = 0; var11 < var7.transformCount; ++var11) {
               ...
               if(var12 == var10 || var8.transformTypes[var12] == 0) {
                  this.method3028(var8.transformTypes[var12], var8.labels[var12], var7.transformXs[var11], var7.transformYs[var11], var7.transformZs[var11]);
               }
            }

            this.method2971();
         } else {
            this.method2973(var1, var2);
         }
      }
   }

   @ObfuscatedName("n")
   void method3028(int var1, int[] var2, int var3, int var4, int var5) {
   ...
   @ObfuscatedName("a")
   public void method2980(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.verticesCount; ++var4) {
   ...
   @ObfuscatedName("o")
   public void method2981(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.verticesCount; ++var4) {
   ...
   public final void method2982(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      try {
         this.method3007(false, false, false, 0L);
   ...
   @ObfuscatedName("ae")
   final void method3007(boolean var1, boolean var2, boolean var3, long var4) {
   ...
   public void animate(int var1, int[] var2, int var3, int var4, int var5) {
      this.method3028(var1, var2, var3, var4, var5);
   }
            ...
            if(var17 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidX) {
               ...
               if(var20 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidY) {
                  ...
                  if(var22 / var14 < Rasterizer3D.Rasterizer3D_clipMidY2) {
                     ...
                     try {
                        this.method3007(var24, var33, this.isSingleTile, var9);
