...
public abstract class AbstractUserComparator implements Comparator, RSAbstractUserComparator {
   ...
   final void method5111(Comparator var1) {
      if(this.nextComparator == null) {
         this.nextComparator = var1;
      } else if(this.nextComparator instanceof AbstractUserComparator) {
         ((AbstractUserComparator)this.nextComparator).method5111(var1);
      }
   ...
   protected final int method5112(User var1, User var2) {
   ...
   static int method5120(int var0, Script var1, boolean var2) {
      if(var0 == 3300) {
         ...
         if(var0 == 3301) {
            ...
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ModeWhere.method3762(var3, var4);
            return 1;
         } else if(var0 == 3302) {
            Interpreter.Interpreter_intStackSize -= 2;
            var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
            var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = PacketBufferNode.method3709(var3, var4);
            return 1;
         } else if(var0 == 3303) {
            Interpreter.Interpreter_intStackSize -= 2;
            var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
            ...
            var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class231.method4218(var3).size;
            return 1;
         } else if(var0 == 3305) {
            var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
            ...
            if(var0 == 3308) {
               ...
               var4 = class69.baseX * 64 + (ByteArrayPool.localPlayer.x >> 7);
               var5 = class89.baseY * 64 + (ByteArrayPool.localPlayer.y >> 7);
