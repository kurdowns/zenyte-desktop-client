...
public final class WorldMapSprite implements RSWorldMapSprite {
   ...
   static Script method511(int var0) {
      Script var1 = (Script)Script.Script_cached.method3432((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = class41.archive12.method4249(var0, 0, (byte)-40);
         if(var2 == null) {
            return null;
         } else {
            var1 = SecureRandomCallable.method1246(var2);
            Script.Script_cached.method3438(var1, (long)var0);
            return var1;
         }
      }
   }
   ...
   public static void method510(Buffer var0, int var1) {
      if(JagexCache.JagexCache_randomDat != null) {
         try {
            ...
            JagexCache.JagexCache_randomDat.method6676(var0.array, var1, 24);
