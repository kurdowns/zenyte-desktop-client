...
public abstract class AbstractWorldMapData implements RSAbstractWorldMapData {
   ...
   void method352(AbstractArchive var1) {
      if(!this.method370()) {
         byte[] var2 = var1.method4249(this.groupId, this.fileId, (byte)-108);
         if(var2 != null) {
   ...
   void method355(int var1, int var2, Buffer var3, int var4) {
      ...
      if(var5) {
         this.floorOverlayIds[0][var1][var2] = (short)var3.method5575();
      }

      this.floorUnderlayIds[0][var1][var2] = (short)var3.method5575();
   }
   ...
   void method372(int var1, int var2, Buffer var3, int var4) {
      ...
      int var11;
      if(var6) {
         var8 = var3.method5575();

         for(var9 = 0; var9 < var8; ++var9) {
            int var10 = var3.method5575();
            if(var10 != 0) {
               this.floorOverlayIds[var9][var1][var2] = (short)var10;
               var11 = var3.method5575();
         ...
         for(var8 = 0; var8 < var5; ++var8) {
            ...
            if(var9 != 0) {
               ...
               for(var11 = 0; var11 < var9; ++var11) {
                  int var12 = var3.method5592();
                  int var13 = var3.method5575();
   ...
   public static ItemDefinition method373(int var0) {
      ItemDefinition var1 = (ItemDefinition)ItemDefinition.ItemDefinition_cached.method3432((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = PrivateChatMode.ItemDefinition_archive.method4249(10, var0, (byte)-127);
         var1 = new ItemDefinition();
         var1.id = var0;
         if(var2 != null) {
            var1.method4728(new Buffer(var2));
         }

         var1.method4767();
         if(var1.noteTemplate != -1) {
            var1.method4764(method373(var1.noteTemplate), method373(var1.note));
         }

         if(var1.notedId != -1) {
            var1.method4718(method373(var1.notedId), method373(var1.unnotedId));
         }

         if(var1.placeholderTemplate != -1) {
            var1.method4719(method373(var1.placeholderTemplate), method373(var1.placeholder));
         }
         ...
         if(!class169.ItemDefinition_inMembersWorld && var1.isMembersOnly) {
            ...
            if(var1.params != null) {
               ...
               for(Node var4 = var1.params.method6013(); var4 != null; var4 = var1.params.method6001()) {
                  ParamDefinition var5 = IgnoreList.method5135((int)var4.key);
                  if(var5.autoDisable) {
                     var4.method3676();
                  } else {
                     var3 = true;
         ...
         ItemDefinition.ItemDefinition_cached.method3438(var1, (long)var0);
         return var1;
      }
   }
   ...
   static int method384(int var0, Script var1, boolean var2) {
      ...
      if(var0 == 4100) {
         ...
         if(var0 == 4101) {
            ...
            var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
            var4 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
            Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3 + class280.method5041(var4, true);
            return 1;
         } else if(var0 == 4103) {
            var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
            ...
            if(var0 == 4104) {
               ...
               if(var0 == 4106) {
                  ...
                  Interpreter.Interpreter_stringStackSize -= 2;
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class227.method4201(Huffman.method4047(Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize], Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1], IgnoreList.clientLanguage));
                  return 1;
               } else {
                  int var5;
                  byte[] var13;
                  ...
                  if(var0 == 4108) {
                     ...
                     var13 = NPC.archive13.method4249(var5, 0, (byte)-38);
                     var14 = new Font(var13);
                     Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var14.method5482(var3, var4);
                     return 1;
                  } else if(var0 == 4109) {
                     var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
                     Interpreter.Interpreter_intStackSize -= 2;
                     var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
                     var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
                     var13 = NPC.archive13.method4249(var5, 0, (byte)-51);
                     var14 = new Font(var13);
                     Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var14.method5414(var3, var4);
                     return 1;
                  } else if(var0 == 4110) {
                     Interpreter.Interpreter_stringStackSize -= 2;
                     var3 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize];
                     ...
                     var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
                     Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = AbstractFont.method5416(var3);
                     return 1;
                  } else if(var0 == 4112) {
                     var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
                     var4 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                     ...
                     var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                     Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = World.method1907((char)var10)?1:0;
                     return 1;
                  } else if(var0 == 4116) {
                     var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                     Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = PcmPlayer.method2594((char)var10)?1:0;
                     return 1;
                  } else if(var0 == 4117) {
                     var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
                     if(var3 != null) {
   ...
   static final InterfaceParent method382(int var0, int var1, int var2) {
      ...
      var3.group = var1;
      var3.type = var2;
      Client.interfaceParents.method6033(var3, (long)var0);
      class4.method73(var1);
      Widget var4 = MusicPatchNode.method3920(var0);
      ...
      if(Client.rootInterface != -1) {
         class198.method3733(Client.rootInterface, 1);
      }
