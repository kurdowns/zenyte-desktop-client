...
public final class Tiles implements RSTiles {
   ...
   public static int method1217(CharSequence var0) {
      return class105.method2393(var0, 10, true);
   }
   ...
   static final int method1238() {
      if(GrandExchangeOfferOwnWorldComparator.clientPreferences.roofsHidden) {
         ...
         int var0 = class277.method5038(WorldMapRectangle.cameraX, class200.cameraZ, ScriptEvent.Client_plane);
         ...
         try {
            ...
            while(true) {
               ...
               if(var6 == 4) {
                  var9 = var2[var4++] << 16;
                  var9 += var2[var4++];
                  var10 = MusicPatchNode.method3920(var9);
                  var11 = var2[var4++];
               ...
               if(var6 == 14) {
                  var9 = var2[var4++];
                  var7 = Projectile.method2211(var9);
               }
               ...
               if(var6 == 18) {
                  var7 = class69.baseX * 64 + (ByteArrayPool.localPlayer.x >> 7);
               }

               if(var6 == 19) {
                  var7 = class89.baseY * 64 + (ByteArrayPool.localPlayer.y >> 7);
               }
