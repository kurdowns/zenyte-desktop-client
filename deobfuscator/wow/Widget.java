...
public class Widget extends Node implements RSWidget {
   ...
   void method4134(Buffer var1) {
      this.isIf3 = false;
      this.type = var1.method5575();
      this.buttonType = var1.method5575();
      this.contentType = var1.method5577();
      this.rawX = var1.method5578();
      this.rawY = var1.method5578();
      this.rawWidth = var1.method5577();
      this.rawHeight = var1.method5577();
      this.transparencyTop = var1.method5575();
      this.parentId = var1.method5577();
      if(this.parentId == '\uffff') {
         this.parentId = -1;
      } else {
      ...
      this.mouseOverRedirect = var1.method5577();
      if(this.mouseOverRedirect == '\uffff') {
         this.mouseOverRedirect = -1;
      }
      ...
      if(var2 > 0) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            this.cs1Comparisons[var3] = var1.method5575();
            this.cs1ComparisonValues[var3] = var1.method5577();
         }
      }
      ...
      if(var3 > 0) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            ...
            for(var6 = 0; var6 < var5; ++var6) {
               this.cs1Instructions[var4][var6] = var1.method5577();
               if(this.cs1Instructions[var4][var6] == '\uffff') {
      ...
      if(this.type == 0) {
         this.scrollHeight = var1.method5577();
         this.isHidden = var1.method5575() == 1;
         this.onHiddenChanged(-1);
      }
      ...
      if(this.type == 2) {
         ...
         var5 = var1.method5575();
         if(var5 == 1) {
            this.clickMask |= 1073741824;
         }

         var6 = var1.method5575();
         if(var6 == 1) {
         ...
         this.paddingX = var1.method5575();
         this.paddingY = var1.method5575();
         ...
         for(var8 = 0; var8 < 20; ++var8) {
            int var9 = var1.method5575();
            if(var9 == 1) {
               this.inventoryXOffsets[var8] = var1.method5578();
               this.inventoryYOffsets[var8] = var1.method5578();
               this.inventorySprites[var8] = var1.method5580();
            } else {
      ...
      if(this.type == 3) {
         this.fill = var1.method5575() == 1;
      }

      if(this.type == 4 || this.type == 1) {
         this.textXAlignment = var1.method5575();
         this.textYAlignment = var1.method5575();
         this.textLineHeight = var1.method5575();
         this.fontId = var1.method5577();
         if(this.fontId == '\uffff') {
            this.fontId = -1;
         }

         this.textShadowed = var1.method5575() == 1;
      }

      if(this.type == 4) {
         this.text = var1.method5695();
         this.text2 = var1.method5695();
      }

      if(this.type == 1 || this.type == 3 || this.type == 4) {
         this.color = var1.method5580();
      }

      if(this.type == 3 || this.type == 4) {
         this.color2 = var1.method5580();
         this.mouseOverColor = var1.method5580();
         this.mouseOverColor2 = var1.method5580();
      }

      if(this.type == 5) {
         this.spriteId2 = var1.method5580();
         this.spriteId = var1.method5580();
      }

      if(this.type == 6) {
         this.modelType = 1;
         this.modelId = var1.method5577();
         if(this.modelId == '\uffff') {
            this.modelId = -1;
         }

         this.modelType2 = 1;
         this.modelId2 = var1.method5577();
         if(this.modelId2 == '\uffff') {
            this.modelId2 = -1;
         }

         this.sequenceId = var1.method5577();
         if(this.sequenceId == '\uffff') {
            this.sequenceId = -1;
         }

         this.sequenceId2 = var1.method5577();
         if(this.sequenceId2 == '\uffff') {
            this.sequenceId2 = -1;
         }

         this.modelZoom = var1.method5577();
         this.modelAngleX = var1.method5577();
         this.modelAngleY = var1.method5577();
      }
      ...
      if(this.type == 7) {
         ...
         this.textShadowed = var1.method5575() == 1;
         this.color = var1.method5580();
         this.paddingX = var1.method5578();
         this.paddingY = var1.method5578();
         var4 = var1.method5575();
         if(var4 == 1) {
            this.clickMask |= 1073741824;
         }
      ...
      if(this.buttonType == 2 || this.type == 2) {
         this.spellActionName = var1.method5695();
         this.spellName = var1.method5695();
         var4 = var1.method5577() & 63;
         this.clickMask |= var4 << 11;
      }

      if(this.buttonType == 1 || this.buttonType == 4 || this.buttonType == 5 || this.buttonType == 6) {
         this.buttonText = var1.method5695();
   ...
   void method4178(Buffer var1) {
      ...
      this.rawWidth = var1.method5577();
      if(this.type == 9) {
         this.rawHeight = var1.method5578();
      } else {
         this.rawHeight = var1.method5577();
      }

      this.widthAlignment = var1.method5576();
      this.heightAlignment = var1.method5576();
      this.xAlignment = var1.method5576();
      this.yAlignment = var1.method5576();
      this.parentId = var1.method5577();
      if(this.parentId == '\uffff') {
         this.parentId = -1;
      } else {
      ...
      this.onHiddenChanged(-1);
      if(this.type == 0) {
         this.scrollWidth = var1.method5577();
         this.scrollHeight = var1.method5577();
         this.noClickThrough = var1.method5575() == 1;
      }

      if(this.type == 5) {
         this.spriteId2 = var1.method5580();
         this.spriteAngle = var1.method5577();
         this.spriteTiling = var1.method5575() == 1;
         this.transparencyTop = var1.method5575();
         this.outline = var1.method5575();
         this.spriteShadow = var1.method5580();
         this.spriteFlipV = var1.method5575() == 1;
         this.spriteFlipH = var1.method5575() == 1;
      }
      ...
      if(this.type == 6) {
         ...
         this.modelOffsetX = var1.method5578();
         this.modelOffsetY = var1.method5578();
         this.modelAngleX = var1.method5577();
         this.modelAngleY = var1.method5577();
         this.modelAngleZ = var1.method5577();
         this.modelZoom = var1.method5577();
         this.sequenceId = var1.method5577();
         if(this.sequenceId == '\uffff') {
            this.sequenceId = -1;
         ...
         this.modelOrthog = var1.method5575() == 1;
         var1.method5577();
         if(this.widthAlignment != 0) {
            this.field2622 = var1.method5577();
         }
      ...
      if(this.type == 9) {
         this.lineWid = var1.method5575();
         this.color = var1.method5580();
         this.field2601 = var1.method5575() == 1;
      }

      this.clickMask = var1.method5702();
      this.dataText = var1.method5695();
      int var2 = var1.method5575();
      if(var2 > 0) {
         this.actions = new String[var2];

         for(int var3 = 0; var3 < var2; ++var3) {
            this.actions[var3] = var1.method5695();
         }
      }

      this.dragZoneSize = var1.method5575();
      this.dragThreshold = var1.method5575();
      this.isScrollBar = var1.method5575() == 1;
      this.spellActionName = var1.method5695();
      this.onLoad = this.method4136(var1);
      this.onMouseOver = this.method4136(var1);
      this.onMouseLeave = this.method4136(var1);
      this.onTargetLeave = this.method4136(var1);
      this.onTargetEnter = this.method4136(var1);
      this.onVarTransmit = this.method4136(var1);
      this.onInvTransmit = this.method4136(var1);
      this.onStatTransmit = this.method4136(var1);
      this.onTimer = this.method4136(var1);
      this.onOp = this.method4136(var1);
      this.onMouseRepeat = this.method4136(var1);
      this.onClick = this.method4136(var1);
      this.onClickRepeat = this.method4136(var1);
      this.onRelease = this.method4136(var1);
      this.onHold = this.method4136(var1);
      this.onDrag = this.method4136(var1);
      this.onDragComplete = this.method4136(var1);
      this.onScroll = this.method4136(var1);
      this.varTransmitTriggers = this.method4145(var1);
      this.invTransmitTriggers = this.method4145(var1);
      this.statTransmitTriggers = this.method4145(var1);
   }
   ...
   Object[] method4136(Buffer var1) {
      ...
      if(var2 == 0) {
         ...
         for(int var4 = 0; var4 < var2; ++var4) {
            int var5 = var1.method5575();
            if(var5 == 0) {
               var3[var4] = new Integer(var1.method5580());
            } else if(var5 == 1) {
               var3[var4] = var1.method5695();
            }
         }
   ...
   public void method4138(int var1, int var2) {
   ...
   public Sprite method4139(boolean var1, byte var2) {
   ...
   public Font method4146() {
      field2565 = false;
      if(this.fontId == -1) {
         return null;
      } else {
         Font var1 = (Font)Widget_cachedFonts.method3432((long)this.fontId);
         if(var1 != null) {
            return var1;
         } else {
            ...
            if(!UserComparator7.method3517(var3, var5, 0)) {
               ...
               var2 = VertexNormal.method3094(var4.method4249(var5, 0, (byte)-101));
            }

            if(var2 != null) {
               Widget_cachedFonts.method3438(var2, (long)this.fontId);
            } else {
               field2565 = true;
            }
   ...
   public Sprite method4141(int var1) {
      field2565 = false;
      if(var1 >= 0 && var1 < this.inventorySprites.length) {
         ...
         if(var2 == -1) {
            ...
            Sprite var3 = (Sprite)Widget_cachedSprites.method3432((long)var2);
            if(var3 != null) {
               return var3;
            } else {
               var3 = MusicPatchNode2.method3774(Varps.Widget_spritesArchive, var2, 0, 273345835);
               if(var3 != null) {
                  Widget_cachedSprites.method3438(var3, (long)var2);
               } else {
                  field2565 = true;
               }
   ...
   public Model method4142(SequenceDefinition var1, int var2, boolean var3, PlayerAppearance var4, byte var5) {
   ...
   public SpriteMask method4140(boolean var1) {
      if(this.spriteId == -1) {
         var1 = false;
      }
      ...
      if(var2 == -1) {
         ...
         SpriteMask var5 = (SpriteMask)Widget_cachedSpriteMasks.method3432(var3);
         if(var5 != null) {
            return var5;
         } else {
            Sprite var6 = this.method4139(var1, (byte)-24);
            if(var6 == null) {
               return null;
            } else {
               Sprite var7 = var6.method6218();
               int[] var8 = new int[var7.subHeight];
               int[] var9 = new int[var7.subHeight];
               int var10 = 0;

               while(var10 < var7.subHeight) {
                  int var11 = 0;
                  int var12 = var7.subWidth;
                  int var13 = 0;

                  while(true) {
                     if(var13 < var7.subWidth) {
               ...
               Widget_cachedSpriteMasks.method3438(var5, var3);
               return var5;
            }
         }
      }
   ...
   public void method4170(int var1, String var2) {
   ...
   public RSSprite getSprite(boolean var1) {
      return this.method4139(var1, (byte)-39);
   }
   ...
   public Model copy$getModel(SequenceDefinition var1, int var2, boolean var3, PlayerAppearance var4, byte var5) {
      ...
      if(var6 == 0) {
         ...
         Model var8 = (Model)Widget_cachedModels.method3432((long)(var7 + (var6 << 16)));
         if(var8 == null) {
            ModelData var9;
            if(var6 == 1) {
               var9 = ModelData.method2879(SoundSystem.Widget_modelsArchive, var7, 0);
               if(var9 == null) {
                  field2565 = true;
                  return null;
               }

               var8 = var9.method2900(64, 768, -50, -10, -50);
            }

            if(var6 == 2) {
               var9 = class237.method4226(var7).method4785();
               if(var9 == null) {
                  field2565 = true;
                  return null;
               }
            ...
            if(var6 == 4) {
               ...
               var9 = var10.method4720(10);
               if(var9 == null) {
                  field2565 = true;
                  return null;
               }

               var8 = var9.method2900(var10.ambient + 64, var10.contrast + 768, -50, -10, -50);
            }

            Widget_cachedModels.method3438(var8, (long)(var7 + (var6 << 16)));
         }

         if(var1 != null) {
            var8 = var1.method4873(var8, var2, (byte)14);
         }
   ...
   public Sprite copy$getSprite(boolean var1, byte var2) {
      ...
      if(var3 == -1) {
         ...
         Sprite var6 = (Sprite)Widget_cachedSprites.method3432(var4);
         if(var6 != null) {
            return var6;
         } else {
            var6 = MusicPatchNode2.method3774(Varps.Widget_spritesArchive, var3, 0, 273345835);
            if(var6 == null) {
               field2565 = true;
               return null;
            } else {
               ...
               if(this.outline >= 2) {
                  var6.method6309(16777215);
               }

               if(this.spriteShadow != 0) {
                  var6.method6224(this.spriteShadow);
               }

               Widget_cachedSprites.method3438(var6, var4);
               return var6;
            }
         }
      }
   ...
   public RSFont getFont() {
      return this.method4146();
   }

   public void setAction(int var1, String var2) {
      this.method4170(var1, var2);
   }
   ...
   static int method4184(int var0, Script var1, boolean var2) {
      String var3;
      if(var0 == 3100) {
         var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
         Skeleton.method3175(0, "", var3);
         return 1;
      } else if(var0 == 3101) {
         ...
         if(var0 == 3104) {
            var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
            var10 = 0;
            if(MusicPatch.method3981(var3)) {
               var10 = Tiles.method1217(var3);
            }

            PacketBufferNode var12 = FaceNormal.method3377(ClientPacket.field2279, Client.packetWriter.isaacCipher);
            var12.packetBuffer.method5717(var10);
            Client.packetWriter.method2375(var12);
            return 1;
         } else {
            PacketBufferNode var14;
            if(var0 == 3105) {
               var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
               var14 = FaceNormal.method3377(ClientPacket.field2213, Client.packetWriter.isaacCipher);
               var14.packetBuffer.method5559(var3.length() + 1);
               var14.packetBuffer.method5655(var3);
               Client.packetWriter.method2375(var14);
               return 1;
            } else if(var0 == 3106) {
               var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
               var14 = FaceNormal.method3377(ClientPacket.field2273, Client.packetWriter.isaacCipher);
               var14.packetBuffer.method5559(var3.length() + 1);
               var14.packetBuffer.method5655(var3);
               Client.packetWriter.method2375(var14);
               return 1;
               ...
               if(var0 == 3107) {
                  ...
                  Widget var13 = MusicPatchNode.method3920(var9);
                  ...
                  Script.method2336(var3, var4, false);
                  return 1;
               } else if(var0 == 3115) {
                  var15 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  var14 = FaceNormal.method3377(ClientPacket.field2253, Client.packetWriter.isaacCipher);
                  var14.packetBuffer.method5560(var15);
                  Client.packetWriter.method2375(var14);
                  return 1;
               } else if(var0 == 3116) {
                  var15 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  ...
                  if(var7.length() > 500) {
                     ...
                     PacketBufferNode var6 = FaceNormal.method3377(ClientPacket.field2214, Client.packetWriter.isaacCipher);
                     var6.packetBuffer.method5560(1 + class234.method4223(var7) + class234.method4223(var5));
                     var6.packetBuffer.method5728(var15);
                     var6.packetBuffer.method5655(var7);
                     var6.packetBuffer.method5655(var5);
                     Client.packetWriter.method2375(var6);
                     return 1;
                  }
               } else if(var0 == 3117) {
   ...
   private static void rl$$clinit() {
      $assertionsDisabled = !he.class.desiredAssertionStatus();
   }
}
