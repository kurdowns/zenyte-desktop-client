...
@ObfuscatedName("ao")
public class WorldMapRegion implements RSWorldMapRegion {
   ...
   void method519(int var1, int var2, int var3) {
      ...
      Sprite var4 = (Sprite)WorldMapRegion_cachedSprites.method3473(HorizontalAlignment.method4778(var5, var6, var7));
      if(var4 != null) {
         if(var3 == this.pixelsPerTile * 64) {
            var4.method6225(var1, var2);
         } else {
            var4.method6327(var1, var2, var3, var3);
         }
   ...
   void method520(WorldMapData_0 var1, List var2) {
      this.iconMap.clear();
   ...
   void method561(HashSet var1, List var2) {
      this.iconMap.clear();
      Iterator var3 = var1.iterator();

      while(var3.hasNext()) {
         WorldMapData_1 var4 = (WorldMapData_1)var3.next();
         if(var4.method358() == this.regionX && var4.method359() == this.regionY) {
   ...
   void method522(int var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
                  ...
                  label61: {
                     ...
                     if(var9 != null && var9.length != 0) {
                        ...
                        for(int var11 = 0; var11 < var10.length; ++var11) {
                           ...
                           ObjectDefinition var13 = WorldMapSection2.method435(var12.objectDefinitionId);
                           if(Tiles.method1239(var13)) {
                              this.method564(var13, var8, var6, var7, var5);
                              break label61;
                           }
                        }
                     }
   ...
   void method564(ObjectDefinition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
      ...
      if(this.worldMapData_0 != null) {
         ...
         var7 = new Coord(var2 + var8.minPlane, var3 + var8.regionXLow * 64 + var8.method786() * 8, var8.regionYLow * 4096 + var4 + var8.method787() * 8);
      }
      ...
      if(var1.transforms != null) {
         ...
         WorldMapElement var9 = class25.method279(var1.mapIconId);
         var10 = new WorldMapIcon_0(var7, var6, var9.objectId, this.method549(var9));
      }
   ...
   boolean method539(AbstractArchive var1) {
      this.iconMap.clear();
      if(this.worldMapData_0 != null) {
         this.worldMapData_0.method352(var1);
         if(this.worldMapData_0.method370()) {
            this.method522(0, 0, 64, 64, this.worldMapData_0);
            return true;
         } else {
            return false;
         }
         ...
         Iterator var3;
         WorldMapData_1 var4;
         for(var3 = this.worldMapData1List.iterator(); var3.hasNext(); var2 &= var4.method370()) {
         ...
         if(var2) {
            ...
            while(var3.hasNext()) {
               var4 = (WorldMapData_1)var3.next();
               this.method522(var4.method784() * 8, var4.method789() * 8, 8, 8, var4);
            }
         }
   ...
   void method528(int var1, WorldMapScaleHandler var2, IndexedSprite[] var3, AbstractArchive var4, AbstractArchive var5) {
      this.pixelsPerTile = var1;
      if(this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) {
         int var7 = this.regionX;
         int var8 = this.regionY;
         Sprite var6 = (Sprite)WorldMapRegion_cachedSprites.method3473(HorizontalAlignment.method4778(var7, var8, var1));
         if(var6 == null) {
            boolean var9 = true;
            var9 &= this.method539(var4);
            int var11;
            if(this.worldMapData_0 != null) {
            ...
            var9 &= var5.method4275(var11);
            if(var9) {
               byte[] var10 = var5.method4256(var11);
               WorldMapSprite var12;
               if(var10 == null) {
                  var12 = new WorldMapSprite();
               } else {
                  var12 = new WorldMapSprite(class200.method3753(var10).pixels);
               }
               ...
               WorldMapRegion_cachedSprites.method3460(var14, HorizontalAlignment.method4778(var15, var16, var17), var14.pixels.length * 4);
               this.method526();
            }
         }
      }
   ...
   void method529(int var1, int var2, int var3, HashSet var4) {
      ...
      this.method560(var1, var2, var4, var3);
      this.method585(var1, var2, var4, var3);
   }
   ...
   void method618(HashSet var1, int var2, int var3) {
      ...
      while(var4.hasNext()) {
         ...
         if(var5.method689()) {
            ...
            if(var1.contains(Integer.valueOf(var6))) {
               WorldMapElement var7 = class25.method279(var6);
               this.method541(var7, var5.screenX, var5.screenY, var2, var3);
            }
         }
      }
   ...
   void method531(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
      ...
      for(var4 = 0; var4 < 64; ++var4) {
         for(var5 = 0; var5 < 64; ++var5) {
            this.method534(var4, var5, this.worldMapData_0, var1, var3);
   ...
   void method532(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
      ...
      while(var4.hasNext()) {
         ...
         for(var6 = var5.method784() * 8; var6 < var5.method784() * 8 + 8; ++var6) {
            for(var7 = var5.method789() * 8; var7 < var5.method789() * 8 + 8; ++var7) {
               this.method534(var6, var7, var5, var1, var3);
   ...
   void method534(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
      int var6 = var3.floorUnderlayIds[0][var1][var2] - 1;
      int var7 = var3.floorOverlayIds[0][var1][var2] - 1;
      if(var6 == -1 && var7 == -1) {
         Rasterizer2D.method6092(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, this.backgroundColor);
      }

      int var8 = 16711935;
      if(var7 != -1) {
         var8 = class169.method3546(var7, this.backgroundColor);
      }

      if(var7 > -1 && var3.field205[0][var1][var2] == 0) {
         Rasterizer2D.method6092(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var8);
      } else {
         int var9 = this.method536(var1, var2, var3, var5);
         if(var7 == -1) {
            Rasterizer2D.method6092(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var9);
         } else {
   ...
   void method535(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4) {
      for(int var5 = 1; var5 < var3.planes; ++var5) {
         ...
         if(var6 > -1) {
            int var7 = class169.method3546(var6, this.backgroundColor);
            if(var3.field205[var5][var1][var2] == 0) {
               Rasterizer2D.method6092(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var7);
            } else {
   ...
   int method536(int var1, int var2, AbstractWorldMapData var3, WorldMapSprite var4) {
      return var3.floorUnderlayIds[0][var1][var2] == 0?this.backgroundColor:var4.method512(var1, var2);
   }
      ...
      for(int var5 = 0; var5 < var3.planes; ++var5) {
         ...
         if(var6 != null && var6.length != 0) {
            ...
            for(int var8 = 0; var8 < var7.length; ++var8) {
               ...
               ObjectDefinition var12 = WorldMapSection2.method435(var9.objectDefinitionId);
               if(var12.mapSceneId != -1) {
                  if(var12.mapSceneId != 46 && var12.mapSceneId != 52) {
                     var4[var12.mapSceneId].method6214(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2, this.pixelsPerTile * 2);
                  } else {
                     var4[var12.mapSceneId].method6214(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2 + 1, this.pixelsPerTile * 2 + 1);
                  }
               }
            }
         }
      ...
      for(int var4 = 0; var4 < var3.planes; ++var4) {
         ...
         if(var5 != null && var5.length != 0) {
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               if(var9) {
                  ObjectDefinition var11 = WorldMapSection2.method435(var8.objectDefinitionId);
                  ...
                  if(var8.decoration == WorldMapDecorationType.field2742.id) {
                     if(var8.rotation == 0) {
                        Rasterizer2D.method6097(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 1, var12);
                     }

                     if(var8.rotation == 1) {
                        Rasterizer2D.method6097(this.pixelsPerTile * var1 + this.pixelsPerTile - 1, this.pixelsPerTile * (63 - var2), 1, var12);
                     }

                     if(var8.rotation == 2) {
                        Rasterizer2D.method6097(this.pixelsPerTile + this.pixelsPerTile * var1 - 1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, 1, var12);
                     }

                     if(var8.rotation == 3) {
                        Rasterizer2D.method6097(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, 1, var12);
                     }
                  }
                  ...
                  if(var8.decoration == WorldMapDecorationType.field2722.id) {
                     ...
                     if(var13 == 0) {
                        for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                           Rasterizer2D.method6097(var14 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var14, 1, var12);
                        }
                     } else {
                        for(var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                           Rasterizer2D.method6097(var14 + this.pixelsPerTile * var1, var14 + this.pixelsPerTile * (63 - var2), 1, var12);
                        }
                     }
                  }
               }
   ...
   void method560(int var1, int var2, HashSet var3, int var4) {
      ...
      while(var7.hasNext()) {
         ...
         if(var12 != null && var12.method689()) {
            var12.screenX = var10;
            var12.screenY = var11;
            WorldMapElement var13 = class25.method279(var12.vmethod685());
            if(!var3.contains(Integer.valueOf(var13.method4483()))) {
   ...
   void method540(HashSet var1, int var2, int var3) {
      ...
      while(var4.hasNext()) {
         AbstractWorldMapIcon var5 = (AbstractWorldMapIcon)var4.next();
         if(var5.method689()) {
            WorldMapElement var6 = class25.method279(var5.vmethod685());
            if(var6 != null && var1.contains(Integer.valueOf(var6.method4483()))) {
               this.method541(var6, var5.screenX, var5.screenY, var2, var3);
            }
         }
      }
   ...
   void method541(WorldMapElement var1, int var2, int var3, int var4, int var5) {
      Sprite var6 = var1.method4468(false);
      if(var6 != null) {
         var6.method6227(var2 - var6.subWidth / 2, var3 - var6.subHeight / 2);
         if(var4 % var5 < var5 / 2) {
            Rasterizer2D.method6150(var2, var3, 15, 16776960, 128);
            Rasterizer2D.method6150(var2, var3, 7, 16777215, 256);
         }
   ...
   void method542(AbstractWorldMapIcon var1, int var2, int var3, float var4) {
      WorldMapElement var5 = class25.method279(var1.vmethod685());
   ...
   void method544(AbstractWorldMapIcon var1, WorldMapElement var2, int var3, int var4, float var5) {
      WorldMapLabel var6 = var1.vmethod710();
      if(var6 != null) {
         if(var6.size.method289(var5)) {
            Font var7 = (Font)this.fonts.get(var6.size);
            var7.method5425(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height, -16777216 | var2.field3216, 0, 1, 0, var7.ascent / 2);
         }
      }
   }
   ...
   void method585(int var1, int var2, HashSet var3, int var4) {
      float var5 = (float)var4 / 64.0F;
      ...
      while(var6.hasNext()) {
         ...
         if(var7.method689()) {
            ...
            if(!var3.contains(Integer.valueOf(var7.vmethod685()))) {
   ...
   WorldMapLabel method548(int var1) {
      WorldMapElement var2 = class25.method279(var1);
      return this.method549(var2);
   }
   ...
   WorldMapLabel method549(WorldMapElement var1) {
      if(var1.name != null && this.fonts != null && this.fonts.get(WorldMapLabelSize.WorldMapLabelSize_small) != null) {
         ...
         if(var2 == null) {
            ...
            if(var14 == null) {
               ...
               int var15 = var14.method5482(var1.name, 1000000);
               String[] var7 = new String[var15];
               var14.method5413(var1.name, (int[])null, var7);
               ...
               for(int var11 = 0; var11 < var10.length; ++var11) {
                  ...
                  int var13 = var14.method5412(var12);
                  if(var13 > var9) {
                     var9 = var13;
                  }
               }
      ...
      if(var4 >= var1 && var5 >= var2) {
         if(var4 < var3 + var1 && var5 < var3 + var2) {
            ...
            while(var7.hasNext()) {
               ...
               if(var8.method689() && var8.method711(var4, var5)) {
                  var6.add(var8);
               }
            }
   ...
   void method552(int var1, int var2, int var3, int var4) {
      var3 %= 4;
      if(var3 == 0) {
         Rasterizer2D.method6099(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, var4);
      }
      ...
      if(var3 == 2) {
         Rasterizer2D.method6099(this.pixelsPerTile + this.pixelsPerTile * var1 - 1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, var4);
      }

      if(var3 == 3) {
         Rasterizer2D.method6097(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
      }
   ...
   static final void method640(NPCDefinition var0, int var1, int var2, int var3) {
      if(Client.menuOptionsCount < 400) {
         if(var0.transforms != null) {
            var0 = var0.method4791();
         }
            ...
            if(var0.isInteractable) {
               if(!var0.isFollower || Client.followerIndex == var1) {
                  ...
                  if(var0.combatLevel != 0) {
                     ...
                     String var6;
                     if(var9 < -9) {
                        var6 = class297.method5342(16711680);
                     } else if(var9 < -6) {
                        var6 = class297.method5342(16723968);
                     } else if(var9 < -3) {
                        var6 = class297.method5342(16740352);
                     } else if(var9 < 0) {
                        var6 = class297.method5342(16756736);
                     } else if(var9 > 9) {
                        var6 = class297.method5342('\uff00');
                     } else if(var9 > 6) {
                        var6 = class297.method5342(4259584);
                     } else if(var9 > 3) {
                        var6 = class297.method5342(8453888);
                     } else if(var9 > 0) {
                        var6 = class297.method5342(12648192);
                     } else {
                        var6 = class297.method5342(16776960);
                     }
                  ...
                  if(var0.isFollower && Client.followerOpsLowPriority) {
                     IgnoreList.method5136("Examine", class297.method5342(16776960) + var4, 1003, var1, var2, var3);
                  }

                  if(Client.isItemSelected == 1) {
                     IgnoreList.method5136("Use", Client.selectedItemName + " " + "->" + " " + class297.method5342(16776960) + var4, 7, var1, var2, var3);
                  } else if(Client.isSpellSelected) {
                     if((AbstractWorldMapIcon.selectedSpellFlags & 2) == 2) {
                        IgnoreList.method5136(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + class297.method5342(16776960) + var4, 8, var1, var2, var3);
                     }
                  } else {
                     ...
                     if(var11 != null) {
                        for(var7 = 4; var7 >= 0; --var7) {
                           if(var11[var7] != null && !var11[var7].equalsIgnoreCase("Attack")) {
                              ...
                              IgnoreList.method5136(var11[var7], class297.method5342(16776960) + var4, var8, var1, var2, var3);
                           }
                        }
                     }
