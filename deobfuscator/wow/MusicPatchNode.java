...
public class MusicPatchNode extends Node implements RSMusicPatchNode {
   ...
   public static String method3922(CharSequence[] var0, int var1, int var2) {
      if(var2 == 0) {
         return "";
      } else if(var2 == 1) {
   ...
   public static class332[] method3921() {
   ...
   static void method3923(int var0, int var1) {
      int var2 = TaskHandler.fontBold12.method5412("Choose Option");
