...
public class FaceNormal implements RSFaceNormal {
   ...
   public static PacketBufferNode method3377(ClientPacket var0, IsaacCipher var1) {
      PacketBufferNode var2 = UserComparator9.method3497();
      ...
      var2.packetBuffer.method5518(var1);
      var2.packetBuffer.method5519(var2.clientPacket.id);
      var2.index = 0;
      return var2;
   }
   ...
   static char method3380(char var0, Language var1) {
   ...
   public static void method3378(int var0, AbstractArchive var1, int var2, int var3, int var4, boolean var5) {
