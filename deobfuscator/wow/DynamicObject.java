...
public class DynamicObject extends Entity implements RSDynamicObject {
   ...
   DynamicObject(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, Entity var9) {
      ...
      this.y = var6;
      if(var7 != -1) {
         this.sequenceDefinition = SpotAnimationDefinition.method4503(var7);
         this.frame = 0;
   ...
   protected final Model vmethod3367(int var1) {
      ...
      try {
         ...
         if(var2 < 0) {
            this.setAnimFrame((var2 ^ Integer.MIN_VALUE) & '\uffff');
         }
         ...
         if(var8) {
            ...
            if(var6 < 0) {
               this.setAnimFrame((var6 ^ Integer.MIN_VALUE) & '\uffff');
            }
      ...
      if(var4 < 0) {
         this.setAnimFrame((var4 ^ Integer.MIN_VALUE) & '\uffff');
      }
   ...
   public final Model copy$getModel(int var1) {
      if(this.sequenceDefinition != null) {
         ...
         while(var2 > this.sequenceDefinition.frameLengths[this.frame]) {
      ...
      if(var13 == null) {
         ...
         return var13.method4666(this.type, this.orientation, var9, var11, var10, var12, this.sequenceDefinition, this.frame);
      }
   }
   ...
   static void method2342(int var0, ArchiveDisk var1, Archive var2) {
      ...
      synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) {
         ArchiveDiskAction var5 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.method4956();

         while(var5 != null) {
            if(var5.key != (long)var0 || var1 != var5.archiveDisk || var5.type != 0) {
               var5 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.method4974();
            } else {
               var3 = var5.data;
               break;
            }
      ...
      if(var3 != null) {
         var2.method4374(var1, var0, var3, true);
      } else {
         byte[] var8 = var1.method5930(var0);
         var2.method4374(var1, var0, var8, true);
      }
   }
}
