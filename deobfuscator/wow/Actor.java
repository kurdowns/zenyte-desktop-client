...
public abstract class Actor extends Entity implements RSActor {
   ...
   final void method1859(int var1, int var2, int var3, int var4, int var5, int var6) {
      boolean var7 = true;
      boolean var8 = true;
   ...
   final void method1845(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      HealthBarDefinition var8 = (HealthBarDefinition)HealthBarDefinition.HealthBarDefinition_cached.method3432((long)var1);
      HealthBarDefinition var7;
      if(var8 != null) {
         var7 = var8;
      } else {
         byte[] var9 = HealthBarDefinition.HealthBarDefinition_archive.method4249(33, var1, (byte)-90);
         var8 = new HealthBarDefinition();
         if(var9 != null) {
            var8.method4546(new Buffer(var9));
         }

         HealthBarDefinition.HealthBarDefinition_cached.method3438(var8, (long)var1);
         var7 = var8;
      }
      ...
      HealthBar var13;
      for(var13 = (HealthBar)this.healthBars.method4885(); var13 != null; var13 = (HealthBar)this.healthBars.method4940()) {
         ++var12;
         if(var13.definition.field3276 == var8.field3276) {
            var13.method2125(var2 + var4, var5, var6, var3);
            return;
         }
      ...
      if(var10 != null || var12 < 4) {
         ...
         if(var14 == null) {
            this.healthBars.method4905(var13);
         } else {
            IterableNodeDeque.method4918(var13, var14);
         }
   ...
   final void method1846(int var1) {
      HealthBarDefinition var3 = (HealthBarDefinition)HealthBarDefinition.HealthBarDefinition_cached.method3432((long)var1);
      HealthBarDefinition var2;
      if(var3 != null) {
         var2 = var3;
      } else {
         byte[] var4 = HealthBarDefinition.HealthBarDefinition_archive.method4249(33, var1, (byte)-57);
         var3 = new HealthBarDefinition();
         if(var4 != null) {
            var3.method4546(new Buffer(var4));
         }

         HealthBarDefinition.HealthBarDefinition_cached.method3438(var3, (long)var1);
         var2 = var3;
      }

      var3 = var2;

      for(HealthBar var5 = (HealthBar)this.healthBars.method4885(); var5 != null; var5 = (HealthBar)this.healthBars.method4940()) {
