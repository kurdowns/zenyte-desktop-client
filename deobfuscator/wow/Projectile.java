...
public final class Projectile extends Entity implements RSProjectile {
   ...
   Projectile(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      ...
      if(var12 != -1) {
         this.sequenceDefinition = SpotAnimationDefinition.method4503(var12);
      } else {
   ...
   final void method2210(int var1, int var2, int var3, int var4) {
   ...
   protected final Model vmethod3367(int var1) {
      ...
      Model var3 = var2.method4492(this.frame);
      if(var3 == null) {
         return null;
      } else {
         var3.method2979(this.pitch);
         return var3;
      }
   }
   ...
   public static int method2211(int var0) {
      VarbitDefinition var2 = (VarbitDefinition)VarbitDefinition.VarbitDefinition_cached.method3432((long)var0);
      VarbitDefinition var1;
      if(var2 != null) {
         var1 = var2;
      } else {
         byte[] var7 = VarbitDefinition.VarbitDefinition_archive.method4249(14, var0, (byte)-79);
         var2 = new VarbitDefinition();
         if(var7 != null) {
            var2.method4561(new Buffer(var7));
         }

         VarbitDefinition.VarbitDefinition_cached.method3438(var2, (long)var0);
         var1 = var2;
      }
