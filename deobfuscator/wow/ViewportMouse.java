...
public class ViewportMouse implements RSViewportMouse {
   ...
   static int ViewportMouse_entityCount = 0;
   @ObfuscatedName("h")
   static long[] ViewportMouse_entityTags = new long[1000];
   ...
   public static File method3090(String var0) {
   ...
   static final void method3091() {
      Client.field794 = 0;
      int var0 = class69.baseX * 64 + (ByteArrayPool.localPlayer.x >> 7);
      int var1 = class89.baseY * 64 + (ByteArrayPool.localPlayer.y >> 7);
