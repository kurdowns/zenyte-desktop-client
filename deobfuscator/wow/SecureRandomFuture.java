...
public class SecureRandomFuture implements RSSecureRandomFuture {
   ...
   public static final Sprite method2227(int var0, int var1, int var2, int var3, int var4, boolean var5) {
      if(var1 == -1) {
         var4 = 0;
      ...
      Sprite var8;
      if(!var5) {
         var8 = (Sprite)ItemDefinition.ItemDefinition_cachedSprites.method3432(var6);
         if(var8 != null) {
            return var8;
         }
      }
      ...
      Model var19 = var9.method4721(1, (byte)-96);
      if(var19 == null) {
         return null;
      } else {
         Sprite var20 = null;
         if(var9.noteTemplate != -1) {
            var20 = method2227(var9.note, 10, 1, 0, 0, true);
            if(var20 == null) {
               return null;
            }
         } else if(var9.notedId != -1) {
            var20 = method2227(var9.unnotedId, var1, var2, var3, 0, false);
            if(var20 == null) {
               return null;
            }
         } else if(var9.placeholderTemplate != -1) {
            var20 = method2227(var9.placeholder, var1, 0, 0, 0, false);
            if(var20 == null) {
               return null;
            }
         }
         ...
         if(var4 == 1 || var4 == 2 && var9.isStackable == 1) {
            WorldMapSection3.ItemDefinition_fontPlain11.method5417(GrandExchangeOfferOwnWorldComparator.method1385(var1), 0, 9, 16776960, 1);
         }

         if(!var5) {
            ItemDefinition.ItemDefinition_cachedSprites.method3438(var8, var6);
         }

         Rasterizer2D.method6083(var12, var13, var14);
         Rasterizer2D.method6088(var15);
         Rasterizer3D.method3147();
