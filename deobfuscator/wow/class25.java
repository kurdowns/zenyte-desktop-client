...
public class class25 {
   ...
   static void method278(PacketBuffer var0, int var1) {
      boolean var2 = var0.method5523(1) == 1;
      if(var2) {
         Players.Players_pendingUpdateIndices[++Players.Players_pendingUpdateCount - 1] = var1;
      }

      int var3 = var0.method5523(2);
      ...
      if(var3 == 0) {
         if(var2) {
            ...
            Players.Players_regions[var1] = (var4.plane << 28) + (class69.baseX * 64 + var4.pathX[0] >> 13 << 14) + (class89.baseY * 64 + var4.pathY[0] >> 13);
            if(var4.field1015 != -1) {
         ...
         if(var3 == 1) {
            ...
            var5 = var0.method5523(1);
            int var8;
            int var9;
            int var10;
            int var11;
            if(var5 == 0) {
               var6 = var0.method5523(12);
               var7 = var6 >> 10;
               var8 = var6 >> 5 & 31;
               if(var8 > 15) {
                  var8 -= 32;
               ...
               var6 = var0.method5523(30);
               var7 = var6 >> 28;
               var8 = var6 >> 14 & 16383;
               var9 = var6 & 16383;
               var10 = (class69.baseX * 64 + var8 + var4.pathX[0] & 16383) - class69.baseX * 64;
               var11 = (class89.baseY * 64 + var9 + var4.pathY[0] & 16383) - class89.baseY * 64;
               if(Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
                  var4.method1379(var10, var11);
                  var4.field670 = false;
               } else if(var2) {
