...
public class TriBool implements RSTriBool {
   ...
   static void method5250() {
      for(ObjectSound var0 = (ObjectSound)ObjectSound.objectSounds.method4956(); var0 != null; var0 = (ObjectSound)ObjectSound.objectSounds.method4974()) {
         if(var0.stream1 != null) {
            Tiles.pcmStreamMixer.method2400(var0.stream1);
            var0.stream1 = null;
         }

         if(var0.stream2 != null) {
            Tiles.pcmStreamMixer.method2400(var0.stream2);
            var0.stream2 = null;
         }
      }

      ObjectSound.objectSounds.method4950();
   }
   ...
   static final void method5251(PacketBuffer var0) {
      var0.method5524();
      ...
      var2.index = var1;
      int var3 = var0.method5523(30);
      byte var4 = (byte)(var3 >> 28);
      int var5 = var3 >> 14 & 16383;
      int var6 = var3 & 16383;
      var2.pathX[0] = var5 - class69.baseX * 64;
      var2.x = (var2.pathX[0] << 7) + (var2.method1337() << 6);
      var2.pathY[0] = var6 - class89.baseY * 64;
