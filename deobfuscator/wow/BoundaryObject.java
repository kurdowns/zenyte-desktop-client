...
public final class BoundaryObject implements RSBoundaryObject {
   ...
   public Shape getClickbox() {
      ...
      return (Shape)(var1 == null && var2 == null?null:(var1 != null && var2 != null?new Shapes(new Shape[]{var1, var2}):(var1 != null?var1:var2)));
   }
   ...
   static Script method3375(int var0, int var1, int var2) {
      int var3 = (var1 << 8) + var0;
      Script var6 = (Script)Script.Script_cached.method3432((long)(var3 << 16));
      Script var5;
      if(var6 != null) {
         var5 = var6;
      } else {
         String var7 = String.valueOf(var3);
         int var8 = class41.archive12.method4265(var7);
         if(var8 == -1) {
            var5 = null;
         } else {
            label56: {
               byte[] var9 = class41.archive12.method4256(var8);
               if(var9 != null) {
                  if(var9.length <= 1) {
                     var5 = null;
                     break label56;
                  ...
                  if(var6 != null) {
                     Script.Script_cached.method3438(var6, (long)(var3 << 16));
                     var5 = var6;
                     break label56;
                  }
               }
      ...
      if(var5 != null) {
         ...
         Script var12 = (Script)Script.Script_cached.method3432((long)(var4 << 16));
         Script var13;
         if(var12 != null) {
            var13 = var12;
         } else {
            String var14 = String.valueOf(var4);
            int var10 = class41.archive12.method4265(var14);
            if(var10 == -1) {
               var13 = null;
            } else {
               byte[] var11 = class41.archive12.method4256(var10);
               if(var11 != null) {
                  if(var11.length <= 1) {
                     var13 = null;
                  ...
                  if(var12 != null) {
                     Script.Script_cached.method3438(var12, (long)(var4 << 16));
                     var13 = var12;
                     return var13 != null?var13:null;
                  }
               }
   ...
   static int method3376(int var0, Script var1, boolean var2) {
      if(var0 == 5000) {
         ...
         UserComparator3.privateChatMode = class219.method4053(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
         ...
         PacketBufferNode var18 = FaceNormal.method3377(ClientPacket.field2212, Client.packetWriter.isaacCipher);
         var18.packetBuffer.method5559(Client.publicChatMode);
         var18.packetBuffer.method5559(UserComparator3.privateChatMode.field3804);
         var18.packetBuffer.method5559(Client.tradeChatMode);
         Client.packetWriter.method2375(var18);
         return 1;
      } else {
         String var3;
         int var4;
         if(var0 == 5002) {
            ...
            PacketBufferNode var6 = FaceNormal.method3377(ClientPacket.field2289, Client.packetWriter.isaacCipher);
            var6.packetBuffer.method5559(class234.method4223(var3) + 2);
            var6.packetBuffer.method5655(var3);
            var6.packetBuffer.method5559(var4 - 1);
            var6.packetBuffer.method5559(var5);
            ...
            if(var0 == 5003) {
               ...
               var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
               Message var16 = PendingSpawn.method1839(var10);
               if(var16 != null) {
               ...
               PacketBufferNode var8 = FaceNormal.method3377(ClientPacket.field2229, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5559(0);
               int var9 = var8.packetBuffer.offset;
               var8.packetBuffer.method5559(var4);
               var8.packetBuffer.method5559(var17);
               var8.packetBuffer.method5559(var7);
               GraphicsDefaults.method5967(var8.packetBuffer, var3);
               var8.packetBuffer.method5684(var8.packetBuffer.offset - var9);
               Client.packetWriter.method2375(var8);
               return 1;
            } else if(var0 == 5009) {
               Interpreter.Interpreter_stringStackSize -= 2;
               var3 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize];
               String var12 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1];
               PacketBufferNode var11 = FaceNormal.method3377(ClientPacket.field2283, Client.packetWriter.isaacCipher);
               var11.packetBuffer.method5560(0);
               int var13 = var11.packetBuffer.offset;
               var11.packetBuffer.method5655(var3);
               GraphicsDefaults.method5967(var11.packetBuffer, var12);
               var11.packetBuffer.method5754(var11.packetBuffer.offset - var13);
               ...
               if(var0 == 5016) {
                  ...
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = PacketWriter.method2381(var10);
                  return 1;
               } else if(var0 == 5018) {
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ObjectSound.method2016(var10);
                  return 1;
               } else if(var0 == 5019) {
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
               ...
               if(ByteArrayPool.localPlayer != null && ByteArrayPool.localPlayer.username != null) {
                  var3 = ByteArrayPool.localPlayer.username.method5263();
               } else {
                  var3 = "";
               }
