...
public class Huffman implements RSHuffman {
   ...
   int method4040(byte[] var1, int var2, int var3, byte[] var4, int var5) {
      int var6 = 0;
      int var7 = var5 << 3;
   ...
   int method4039(byte[] var1, int var2, byte[] var3, int var4, int var5) {
      if(var5 == 0) {
         return 0;
      } else {
         int var6 = 0;
   ...
   public static int method4047(CharSequence var0, CharSequence var1, Language var2) {
      ...
      while(var5 - var7 < var3 || var6 - var8 < var4) {
         ...
         var8 = var12;
         var9 = FaceNormal.method3380(var9, var2);
         var10 = FaceNormal.method3380(var10, var2);
         if(var9 != var10 && Character.toUpperCase(var9) != Character.toUpperCase(var10)) {
            var9 = Character.toLowerCase(var9);
            var10 = Character.toLowerCase(var10);
            if(var9 != var10) {
               return method4048(var9, var2) - method4048(var10, var2);
            }
         }
      }
      ...
      for(var17 = 0; var17 < var16; ++var17) {
         ...
         if(var18 != var20 && Character.toUpperCase(var18) != Character.toUpperCase(var20)) {
            ...
            if(var18 != var20) {
               return method4048(var18, var2) - method4048(var20, var2);
            }
         }
      }
      ...
      if(var17 != 0) {
         ...
         for(int var19 = 0; var19 < var16; ++var19) {
            ...
            if(var20 != var13) {
               return method4048(var20, var2) - method4048(var13, var2);
            }
         }
   ...
   static int method4048(char var0, Language var1) {
      int var2 = var0 << 4;
   ...
   public static void method4049() {
      PlayerAppearance.PlayerAppearance_cachedModels.method3427();
   }
   ...
   static final void method4041() {
      Client.packetWriter.method2363();
      GrandExchangeEvents.method155();
      GrandExchangeOfferWorldComparator.scene.method3208();

      for(int var0 = 0; var0 < 4; ++var0) {
         Client.collisionMaps[var0].method3637();
      }
