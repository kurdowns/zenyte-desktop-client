...
public class MusicPatchNode2 implements RSMusicPatchNode2 {
   ...
   public static Sprite method3774(AbstractArchive var0, int var1, int var2, int var3) {
   ...
   static final void method3775(Buffer var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      int var7;
         ...
         while(true) {
            ...
            if(var7 == 0) {
               if(var1 == 0) {
                  ...
                  int var13 = Canvas.method957(var11 + '\ub135', 91923 + var12, 4) - 128 + (Canvas.method957(10294 + var11, '\u93bd' + var12, 2) - 128 >> 1) + (Canvas.method957(var11, var12, 1) - 128 >> 2);
            ...
            if(var7 <= 49) {
               class348.field4061[var1][var2][var3] = var0.method5576();
