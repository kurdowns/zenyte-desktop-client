...
import net.runelite.rs.api.RSVorbisResidue;

@ObfuscatedName("dr")
public class VorbisResidue implements RSVorbisResidue {

   @ObfuscatedName("x")
   int residueType = VorbisSample.method2476(16);
   @ObfuscatedName("m")
   int begin = VorbisSample.method2476(24);
   @ObfuscatedName("k")
   int end = VorbisSample.method2476(24);
   @ObfuscatedName("d")
   int partitionSize = VorbisSample.method2476(24) + 1;
   @ObfuscatedName("w")
   int classifications = VorbisSample.method2476(6) + 1;
   @ObfuscatedName("v")
   int classbook = VorbisSample.method2476(8);
   @ObfuscatedName("q")
   int[] cascade;
   ...
   VorbisResidue() {
      ...
      for(var2 = 0; var2 < this.classifications; ++var2) {
         int var3 = 0;
         int var4 = VorbisSample.method2476(3);
         boolean var5 = VorbisSample.method2500() != 0;
         if(var5) {
            var3 = VorbisSample.method2476(5);
         }
      ...
      for(var2 = 0; var2 < this.classifications * 8; ++var2) {
         this.cascade[var2] = (var1[var2 >> 3] & 1 << (var2 & 7)) != 0?VorbisSample.method2476(8):-1;
      }

   }

   @ObfuscatedName("x")
   void method2634(float[] var1, int var2, boolean var3) {
      int var4;
      ...
      if(!var3) {
         ...
         for(int var8 = 0; var8 < 8; ++var8) {
            ...
            while(var9 < var6) {
               ...
               int var11;
               if(var8 == 0) {
                  var10 = VorbisSample.VorbisSample_codebooks[this.classbook].method2452();
