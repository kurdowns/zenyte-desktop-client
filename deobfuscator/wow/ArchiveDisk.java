...
public final class ArchiveDisk implements RSArchiveDisk {
   ...
   public byte[] method5930(int var1) {
      BufferedFile var2 = this.datFile;
      synchronized(this.datFile) {
         try {
            Object var10000;
            if(this.idxFile.method6656() < (long)(var1 * 6 + 6)) {
               var10000 = null;
               return (byte[])var10000;
            } else {
               this.idxFile.method6655((long)(var1 * 6));
               this.idxFile.method6653(ArchiveDisk_buffer, 0, 6);
               ...
               if(var3 < 0 || var3 > this.maxEntrySize) {
                  var10000 = null;
                  return (byte[])var10000;
               } else if(var4 <= 0 || (long)var4 > this.datFile.method6656() / 520L) {
                  var10000 = null;
                  return (byte[])var10000;
               } else {
                  ...
                  while(var6 < var3) {
                     ...
                     this.datFile.method6655((long)var4 * 520L);
                     int var8 = var3 - var6;
                     int var9;
                     int var10;
                     int var11;
                     ...
                     if(var1 > '\uffff') {
                        ...
                        var13 = 10;
                        this.datFile.method6653(ArchiveDisk_buffer, 0, var13 + var8);
                     ...
                     if(var9 == var1 && var10 == var7 && var12 == this.archive) {
                        if(var11 >= 0 && (long)var11 <= this.datFile.method6656() / 520L) {
   ...
   public boolean method5929(int var1, byte[] var2, int var3) {
      BufferedFile var4 = this.datFile;
      synchronized(this.datFile) {
         if(var3 >= 0 && var3 <= this.maxEntrySize) {
            boolean var5 = this.method5932(var1, var2, var3, true);
            if(!var5) {
               var5 = this.method5932(var1, var2, var3, false);
            }
   ...
   boolean method5932(int var1, byte[] var2, int var3, boolean var4) {
      ...
      synchronized(this.datFile) {
         try {
            ...
            if(var4) {
               ...
               if(var6 <= 0 || (long)var6 > this.datFile.method6656() / 520L) {
                  var10000 = false;
                  return var10000;
               }
            } else {
               var6 = (int)((this.datFile.method6656() + 519L) / 520L);
               if(var6 == 0) {
                  var6 = 1;
               }
            }
            ...
            this.idxFile.method6655((long)(var1 * 6));
            this.idxFile.method6676(ArchiveDisk_buffer, 0, 6);
            int var7 = 0;
            int var8 = 0;
            ...
            while(true) {
               if(var7 < var3) {
                  label159: {
                     ...
                     int var10;
                     if(var4) {
                        this.datFile.method6655(520L * (long)var6);
                        int var11;
                        int var12;
                        if(var1 > '\uffff') {
                           try {
                              this.datFile.method6653(ArchiveDisk_buffer, 0, 10);
                           ...
                           try {
                              this.datFile.method6653(ArchiveDisk_buffer, 0, 8);
                        ...
                        if(var9 < 0 || (long)var9 > this.datFile.method6656() / 520L) {
                           var10000 = false;
                           return var10000;
                        }
                     }
                     ...
                     if(var9 == 0) {
                        var4 = false;
                        var9 = (int)((this.datFile.method6656() + 519L) / 520L);
                        if(var9 == 0) {
                           ++var9;
                        }
                     ...
                     if(var1 > '\uffff') {
                        ...
                        this.datFile.method6655((long)var6 * 520L);
                        this.datFile.method6676(ArchiveDisk_buffer, 0, 10);
                        var10 = var3 - var7;
                        if(var10 > 510) {
                           var10 = 510;
                        }

                        this.datFile.method6676(var2, var7, var10);
                        var7 += var10;
                     } else {
                        if(var3 - var7 <= 512) {
                           var9 = 0;
                        ...
                        this.datFile.method6655((long)var6 * 520L);
                        this.datFile.method6676(ArchiveDisk_buffer, 0, 8);
                        var10 = var3 - var7;
                        if(var10 > 512) {
                           var10 = 512;
                        }
