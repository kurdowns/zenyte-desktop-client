         ...
         if(ByteArrayPool.localPlayer != var0) {
            if(Client.menuOptionsCount < 400) {
               ...
               if(Client.isItemSelected == 1) {
                  IgnoreList.method5136("Use", Client.selectedItemName + " " + "->" + " " + class297.method5342(16777215) + var4, 14, var1, var2, var3);
               } else if(Client.isSpellSelected) {
                  if((AbstractWorldMapIcon.selectedSpellFlags & 8) == 8 && !Client.shouldHideAttackOptionFor(var0)) {
                     IgnoreList.method5136(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + class297.method5342(16777215) + var4, 15, var1, var2, var3);
                  }
               } else {
                  for(var10 = 7; var10 >= 0; --var10) {
                     if(Client.playerMenuActions[var10] != null) {
                        ...
                        IgnoreList.method5136(Client.playerMenuActions[var10], class297.method5342(16777215) + var4, var7, var1, var2, var3);
                     }
                  }
               }
               ...
               for(var10 = 0; var10 < Client.menuOptionsCount; ++var10) {
                  if(Client.menuOpcodes[var10] == 23) {
                     Client.menuTargets[var10] = class297.method5342(16777215) + var4;
                     break;
                  }
               }
