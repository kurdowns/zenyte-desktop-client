...
public class class22 {
   ...
   static boolean method257(PacketBuffer var0, int var1) {
      ...
      int var10;
      if(var2 == 0) {
         if(var0.method5523(1) != 0) {
            method257(var0, var1);
         }

         var3 = var0.method5523(13);
         var4 = var0.method5523(13);
         boolean var12 = var0.method5523(1) == 1;
         if(var12) {
         ...
         if(Client.players[var1] != null) {
            ...
            var6.method1379((var9 << 13) + var3 - class69.baseX * 64, (var10 << 13) + var4 - class89.baseY * 64);
            var6.field670 = false;
            return true;
         }
      } else if(var2 == 1) {
         var3 = var0.method5523(2);
   ...
   static final void method252() {
      for(int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
         ...
         if(Client.queuedSoundEffectDelays[var0] < -10) {
            ...
            if(var9 == null) {
               ...
               var9 = SoundEffect.method2469(FontName.archive4, Client.soundEffectIds[var0], 0);
               if(var9 == null) {
                  continue;
               }

               Client.queuedSoundEffectDelays[var0] += var9.method2471();
            ...
            if(Client.queuedSoundEffectDelays[var0] < 0) {
               ...
               if(var2 > 0) {
                  RawSound var10 = var9.method2466().method2508(class25.decimator);
                  RawPcmStream var11 = RawPcmStream.method2654(var10, 100, var2);
                  var11.method2689(Client.queuedSoundEffectLoops[var0] - 1);
                  Tiles.pcmStreamMixer.method2399(var11);
               }
      ...
      if(Client.field915) {
         ...
         if(class206.field2406 != 0) {
            ...
            var12 = class206.midiPcmStream.method3904();
         }
   ...
   static void method254(Player var0, boolean var1) {
      if(var0 != null && var0.vmethod2132() && !var0.isHidden) {
         ...
         if(var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
            long var4 = IsaacCipher.method6377(0, 0, 0, false, var0.index);
            if(var0.model0 != null && Client.cycle >= var0.animationCycleStart && Client.cycle < var0.animationCycleEnd) {
               var0.isUnanimated = false;
               var0.tileHeight = class277.method5038(var0.x, var0.y, ScriptEvent.Client_plane);
               var0.playerCycle = Client.cycle;
               GrandExchangeOfferWorldComparator.scene.method3189(ScriptEvent.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0, var0.rotation, var4, var0.field659, var0.field660, var0.field661, var0.field664);
            } else {
               ...
               var0.tileHeight = class277.method5038(var0.x, var0.y, ScriptEvent.Client_plane);
               var0.playerCycle = Client.cycle;
               GrandExchangeOfferWorldComparator.scene.method3188(ScriptEvent.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0, var0.rotation, var4, var0.isWalking);
            }
         }
      }
