...
public final class GameObject implements RSGameObject {
   ...
   public static void method3408(File var0, File var1) {
      try {
         ...
         var3.method5559(3);
         var3.method5559(var1 != null?1:0);
         var3.method5568(var0.getPath());
         if(var1 != null) {
            var3.method5568("");
         }

         var2.method6696(var3.array, 0, var3.offset);
         var2.method6691();
   ...
   public static void method3406(PacketBuffer var0) {
      ReflectionCheck var1 = (ReflectionCheck)class105.reflectionChecks.method4885();
      if(var1 != null) {
         int var2 = var0.offset;
         var0.method5717(var1.id);

         for(int var3 = 0; var3 < var1.size; ++var3) {
            if(var1.creationErrors[var3] != 0) {
               var0.method5559(var1.creationErrors[var3]);
            } else {
               try {
                  ...
                  if(var4 == 3) {
                     ...
                     if(var11 == null) {
                        ...
                        var0.method5559(1);
                        var0.method5557(((Number)var11).longValue());
                     } else if(var11 instanceof String) {
                        var0.method5559(2);
                        var0.method5655((String)var11);
                     } else {
                        var0.method5559(4);
                     }
                  } else if(var4 == 4) {
   ...
   static final void method3407(boolean var0, PacketBuffer var1) {
      ...
      if(!Client.isInInstance) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            for(var6 = 0; var6 < 4; ++var6) {
               UrlRequester.xteaKeys[var5][var6] = var1.method5580();
            }
         }
         ...
         for(var6 = (var3 - 6) / 8; var6 <= (var3 + 6) / 8; ++var6) {
            for(var7 = (var2 - 6) / 8; var7 <= (var2 + 6) / 8; ++var7) {
               ...
               if(!var16 || var7 != 49 && var7 != 149 && var7 != 147 && var6 != 50 && (var6 != 49 || var7 != 47)) {
                  ...
                  KeyHandler.regionMapArchiveIds[var4] = WorldMapIcon_0.archive5.method4265("m" + var6 + "_" + var7);
                  WorldMapArea.regionLandArchiveIds[var4] = WorldMapIcon_0.archive5.method4265("l" + var6 + "_" + var7);
                  ++var4;
               }
            }
         }
         ...
         boolean var15 = var1.method5575() == 1;
         var3 = var1.method5565();
         var4 = var1.method5615();
         ...
         for(var6 = 0; var6 < 4; ++var6) {
            for(var7 = 0; var7 < 13; ++var7) {
               for(var8 = 0; var8 < 13; ++var8) {
                  var9 = var1.method5523(1);
                  if(var9 == 1) {
                     Client.instanceChunkTemplates[var6][var7][var8] = var1.method5523(26);
                  } else {
         ...
         for(var6 = 0; var6 < var5; ++var6) {
            for(var7 = 0; var7 < 4; ++var7) {
               UrlRequester.xteaKeys[var6][var7] = var1.method5580();
            }
         }
               ...
               for(var8 = 0; var8 < 13; ++var8) {
                  ...
                  if(var9 != -1) {
                     ...
                     if(var12 != -1) {
                        ...
                        var13 = var12 >> 8 & 255;
                        int var14 = var12 & 255;
                        KeyHandler.regionMapArchiveIds[var5] = WorldMapIcon_0.archive5.method4265("m" + var13 + "_" + var14);
                        WorldMapArea.regionLandArchiveIds[var5] = WorldMapIcon_0.archive5.method4265("l" + var13 + "_" + var14);
                        ++var5;
                     }
                  }
               }
