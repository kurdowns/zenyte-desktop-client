...
public class WorldMapArea implements RSWorldMapArea {
   ...
   public void method471(Buffer var1, int var2) {
      this.id = var2;
      this.internalName = var1.method5695();
      this.externalName = var1.method5695();
      this.origin = new Coord(var1.method5580());
      this.backGroundColor = var1.method5580();
      var1.method5575();
      this.isMain = var1.method5575() == 1;
      this.zoom = var1.method5575();
   ...
   static void method509() {
      ...
      try {
         ...
         Buffer var1 = GrandExchangeOfferOwnWorldComparator.clientPreferences.method1943();
         var0.method6696(var1.array, 0, var1.offset);
   ...
   public static void method461(int var0, AbstractArchive var1, String var2, String var3, int var4, boolean var5) {
      int var6 = var1.method4265(var2);
      int var7 = var1.method4258(var6, var3);
      FaceNormal.method3378(var0, var1, var6, var7, var4, var5);
   }
   ...
   static void method508() {
      if(GrandExchangeOfferAgeComparator.worldMap != null) {
         GrandExchangeOfferAgeComparator.worldMap.method6527(ScriptEvent.Client_plane, class69.baseX * 64 + (ByteArrayPool.localPlayer.x >> 7), class89.baseY * 64 + (ByteArrayPool.localPlayer.y >> 7), false);
         GrandExchangeOfferAgeComparator.worldMap.method6446();
      }
